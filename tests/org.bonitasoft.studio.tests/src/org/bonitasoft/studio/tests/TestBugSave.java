...
public class TestBugSave extends TestCase {
    ...
    public void testCrashingSave() throws Exception {
        ...
        CreateFormCommand formCommand = new CreateFormCommand(mainProcess, ProcessPackage.Literals.PAGE_FLOW__FORM, "form", "",
                Collections.<WidgetMapping> emptyList(), processEditor.getEditingDomain());
        ...
        SetCommand touchProcessCommand = new SetCommand(processEditor.getEditingDomain(), mainProcess, ProcessPackage.Literals.ELEMENT__DOCUMENTATION,
                "descProc");
