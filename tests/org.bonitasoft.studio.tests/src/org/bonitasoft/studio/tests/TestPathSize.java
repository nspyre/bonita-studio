...
public class TestPathSize extends TestCase {
    ...
    public void testMaxItemSizeIsEclipse() {
        ...
        assertFalse("Longest path is [" + longestAbsolutePath + "]. The size of the path contains " + extraChars + "extra characters",
                longestAbsolutePath.contains("org.bonitasoft") && extraChars > 0);
    }
