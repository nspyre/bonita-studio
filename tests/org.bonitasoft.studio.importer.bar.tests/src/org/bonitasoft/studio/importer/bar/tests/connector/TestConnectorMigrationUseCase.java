    ...
    public void testSetBonitaVariableConnectorMigration() throws Exception {
        ...
        for (Operation operation : operations) {
            ...
            if ("varInt".equals(opeName)) {
                ...
                assertEquals("Return type of left operand created after connector migration must be " + intergerName, operation.getLeftOperand()
                        .getReturnType(), intergerName);
                assertEquals("Return type of right operand created after connector migration must be " + intergerName, operation.getRightOperand()
                        .getReturnType(), intergerName);
                ...
                assertEquals("Return type of right operand created after connector migration must be " + booleanName, operation.getRightOperand()
                        .getReturnType(), booleanName);
    ...
    public void testScriptOutputConnectorMigration() throws Exception {
        ...
        for (Operation operation : operations) {
            ...
            if ("migratedScript".equals(rightName)) {
                assertEquals("Return type of right operand created after connector migration must be " + objectClassName, objectClassName, operation
                        .getRightOperand().getReturnType());
            } else if ("p1".equals(rightName)) {
                assertEquals("Return type of right operand created after connector migration must be " + booleanClassName, booleanClassName, operation
                        .getRightOperand().getReturnType());
            ...
            for (ConnectorParameter connectorParameter : parameters) {
                if (currentParameterKey.equals(connectorParameter.getKey())) {
                    ...
                    if (expectedValueExpression instanceof Expression) {
                        assertEquals("Wrong name of expression for parameter " + currentParameterKey, ((Expression) expectedValueExpression).getName(),
                                ((Expression) actualValueExpression).getName());
                        assertEquals("Wrong type of expression for parameter " + currentParameterKey, ((Expression) expectedValueExpression).getType(),
                                ((Expression) actualValueExpression).getType());
                        assertEquals("Wrong content of expression for parameter " + currentParameterKey, ((Expression) expectedValueExpression).getContent(),
