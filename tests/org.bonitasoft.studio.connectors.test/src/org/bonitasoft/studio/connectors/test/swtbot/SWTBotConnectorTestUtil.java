...
public class SWTBotConnectorTestUtil {
     ...
     * @param version
     */
    public static void addConnectorToPool(final SWTBot bot, final String connectorDefinitionLabel, final String version, final String[] categoryPathLabels,
        ...
        for (int i = 0; i < categoryPathLabels.length; i++) {
            ...
            bot.waitUntil(new ICondition() {
                ...
                public String getFailureMessage() {
                    return "Category " + categoryLabel + " has no children\n" + "Current category item is " + categoryItem != null ? categoryItem.getText()
                            : "null";
                }
            }, 10000, 1000);
        }
        ...
        Assert.assertNotNull("Connector " + connectorDefinitionLabel + " (" + version + ") not found in category path " + categoryPathLabels.toString()
                + " containing children:\n" + nodes, cNode);
