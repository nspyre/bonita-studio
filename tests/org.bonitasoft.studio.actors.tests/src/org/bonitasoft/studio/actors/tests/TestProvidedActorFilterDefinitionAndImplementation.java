...
public class TestProvidedActorFilterDefinitionAndImplementation extends TestCase {
    ...
    private void parsePageWidget(final Component component, final List<String> bindInputs, final String resourceName, final ConnectorDefinition def,
            final StringBuilder testReport) {
    ...
    public void testProvidedActorFilterImplementationsSanity() throws Exception {
        ...
        for (final ConnectorImplementation implementation : connectorImplStore.getImplementations()) {
            ...
            if (connectorImplStore.getChild(resourceName).isReadOnly()) {
                ...
                if (!NamingUtils.toConnectorImplementationFilename(implementation.getImplementationId(), implementation.getImplementationVersion(), true)
                        .equals(resourceName)) {
                    testReport.append("\n");
                    testReport.append("Resource name doesn't match id and version for " + resourceName);
                }
