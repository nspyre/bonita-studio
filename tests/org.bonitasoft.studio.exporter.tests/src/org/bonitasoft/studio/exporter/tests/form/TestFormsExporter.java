...
public class TestFormsExporter extends TestCase {
    ...
    /**
     * Test method for {@link org.bonitasoft.studio.console.export.FormsExporter#createXmlForms(org.bonitasoft.studio.model.process.AbstractProcess)} .
     * 
     * @throws Exception
    ...
    public void testFormsXmlVariableBound() throws Exception {
        ...
        Object result = xpathEvaluator.evaluate("//pages/page[@id='Step1']/actions/action[variable-type='" + ExpressionConstants.LEFT_OPERAND_DOCUMENT
                + "']/variable", document, XPathConstants.STRING);
    ...
    public void testSkipForms() throws Exception {
        ...
        assertTrue("PageFlow for testSkipForms--1.0$entry has " + pageflow.getChildNodes().getLength() + "children but shouldn't", pageflow.getChildNodes()
                .getLength() == 5);//1 for permission + 1 for fomr-type + 3 for th return to line
