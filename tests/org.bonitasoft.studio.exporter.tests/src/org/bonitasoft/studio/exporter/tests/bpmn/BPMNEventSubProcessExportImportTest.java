...
public class BPMNEventSubProcessExportImportTest extends SWTBotGefTestCase {
    ...
    private void prepareTest() throws IOException {
        SWTBotTestUtil.importProcessWIthPathFromClass(bot, "diagramtoTestEventSubProcess-1.0.bos", "Bonita 6.x", "diagramWithEventSubProcess",
                BPMNEventSubProcessExportImportTest.class, false);
