...
public class SWTBotValidatorTestUtil {
     ...
     */
    public static void createValidatorOnField(SWTBot bot, String displayName, String className, String packageName) throws JavaModelException,
     ...
     * @throws InterruptedException
     */
    public static void createValidatorOnPage(SWTBot bot, String className, String packageName, String displayName) throws JavaModelException,
            OperationCanceledException, InterruptedException {
        openNewValidatorWizardDialog(bot);
        SWTBotShell newShell = bot.activeShell();
        SWTBot dialogBot = newShell.bot();
    ...
    private static void check(String packageName, String className, String displayName, String interfaceName) throws JavaModelException,
            OperationCanceledException, InterruptedException {
        ValidatorDescriptorRepositoryStore store = (ValidatorDescriptorRepositoryStore) RepositoryManager.getInstance().getRepositoryStore(
        ...
        ValidatorSourceRepositorySotre sourceStore = (ValidatorSourceRepositorySotre) RepositoryManager.getInstance().getRepositoryStore(
