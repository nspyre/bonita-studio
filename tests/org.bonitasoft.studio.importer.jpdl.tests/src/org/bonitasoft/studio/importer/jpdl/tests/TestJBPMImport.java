...
public class TestJBPMImport extends TestCase {
     ...
     * @param nbConditions
     */
    private void assertNbItems(MainProcess mainProcess, int nbStartEvent, int nbEndEvent, int nbTasks, int nbSubprocess, int nbAutomatedActivity,
            int nbAndGateways, int nbXorGateways, int nbFlows, int nbConditions) {
