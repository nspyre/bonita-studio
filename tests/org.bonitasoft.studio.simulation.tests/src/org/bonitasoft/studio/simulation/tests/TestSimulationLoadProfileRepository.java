...
public class TestSimulationLoadProfileRepository extends TestCase {
    ...
    public void testCreateArtifact() {
        SimulationLoadProfileRepositoryStore srrs = (SimulationLoadProfileRepositoryStore) RepositoryManager.getInstance().getRepositoryStore(
    ...
    public void testSaveArtifactWithSameName() throws Exception {
        ...
        SimulationLoadProfileFileStore artifact = srrs.createRepositoryFileStore("LoadProfile3."
    ...
    public void testSaveArtifactWithDifferentName() throws Exception {
        ...
        SimulationLoadProfileRepositoryStore srrs = (SimulationLoadProfileRepositoryStore) RepositoryManager.getInstance().getRepositoryStore(
                SimulationLoadProfileRepositoryStore.class);
        SimulationLoadProfileFileStore artifact = srrs.createRepositoryFileStore("LoadProfile4."
                + SimulationLoadProfileRepositoryStore.SIMULATION_LOADPROFILE_EXT);
        ...
        assertNull("Artifact has been renamed, we should not find it with its old name any more",
                srrs.getChild("LoadProfile4." + SimulationLoadProfileRepositoryStore.SIMULATION_LOADPROFILE_EXT));
        assertNotNull("Artifact has been renamed, the new artifact should exists",
                srrs.getChild("LoadProfile5." + SimulationLoadProfileRepositoryStore.SIMULATION_LOADPROFILE_EXT));
    }
