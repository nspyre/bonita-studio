...
public class TestSimulationResourceRepository extends TestCase {
    ...
    public void testCreateArtifact() {
        SimulationResourceRepositoryStore srrs = (SimulationResourceRepositoryStore) RepositoryManager.getInstance().getRepositoryStore(
    ...
    public void testSaveArtifactWithDifferentName() throws Exception {
        ...
        assertNull("Artifact has been renamed, we should not find it with its old name any more",
                srrs.getChild("Dolphin." + SimulationResourceRepositoryStore.SIMULATION_RESOURCE_EXT));
    }
