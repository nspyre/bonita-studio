...
public class MigrationValidator extends EObjectValidator {
                ...
                diagnostics.add
                        ...
                        (Diagnostic.ERROR,
                                ...
                                EcorePlugin.INSTANCE.getString("_UI_GenericConstraint_diagnostic",
                                        new Object[] { "validContainment", getObjectLabel((EObject) instance, context) }),
                                new Object[] { instance }));
            }
            return false;
        }
            ...
            if (diagnostics != null) {
                diagnostics.add
                        ...
                        (Diagnostic.ERROR,
                                ...
                                0,
                                EcorePlugin.INSTANCE.getString("_UI_GenericConstraint_diagnostic",
                                        new Object[] { "validType", getObjectLabel((EObject) instance, context) }),
                                new Object[] { instance }));
            }
            return false;
        }
            ...
            if (diagnostics != null) {
                diagnostics.add
                        ...
                        (Diagnostic.ERROR,
                                ...
                                0,
                                EcorePlugin.INSTANCE.getString("_UI_GenericConstraint_diagnostic",
                                        new Object[] { "validFeature", getObjectLabel((EObject) slot, context) }),
                                new Object[] { slot }));
            }
            return false;
        }
            ...
            if (diagnostics != null) {
                diagnostics.add
                        ...
                        (Diagnostic.ERROR,
                                ...
                                0,
                                EcorePlugin.INSTANCE.getString("_UI_GenericConstraint_diagnostic",
                                        new Object[] { "validMultiplicity", getObjectLabel((EObject) slot, context) }),
                                new Object[] { slot }));
            }
            return false;
        }
            ...
            if (diagnostics != null) {
                diagnostics.add
                        ...
                        (Diagnostic.ERROR,
                                ...
                                0,
                                EcorePlugin.INSTANCE.getString("_UI_GenericConstraint_diagnostic",
                                        new Object[] { "validType", getObjectLabel((EObject) referenceSlot, context) }),
    ...
    private boolean validate_validType(ReferenceSlot referenceSlot) {
        ...
        for (Instance instance : referenceSlot.getValues()) {
            ...
            boolean validType = instanceType == referenceType || instanceType.getEAllSuperTypes().contains(referenceType)
            ...
            if (diagnostics != null) {
                diagnostics.add
                        ...
                        (Diagnostic.ERROR,
                                ...
                                0,
                                EcorePlugin.INSTANCE.getString("_UI_GenericConstraint_diagnostic",
                                        new Object[] { "noDanglingReference", getObjectLabel((EObject) referenceSlot, context) }),
                                new Object[] { referenceSlot }));
            }
            return false;
        }
            ...
            if (diagnostics != null) {
                diagnostics.add
                        ...
                        (Diagnostic.ERROR,
                                ...
                                0,
                                EcorePlugin.INSTANCE.getString("_UI_GenericConstraint_diagnostic",
                                        new Object[] { "validOpposite", getObjectLabel((EObject) referenceSlot, context) }),
                                new Object[] { referenceSlot }));
            }
            return false;
        }
