...
public class MetamodelImpl extends EObjectImpl implements Metamodel {
    ...
    public EList<MetamodelResource> getResources() {
        if (resources == null) {
            resources = new EObjectContainmentWithInverseEList<MetamodelResource>(MetamodelResource.class, this, MigrationPackage.METAMODEL__RESOURCES,
                    MigrationPackage.METAMODEL_RESOURCE__METAMODEL);
        }
        return resources;
    }
