...
public class ModelImpl extends EObjectImpl implements Model {
    ...
    public EList<ModelResource> getResources() {
        if (resources == null) {
            resources = new EObjectContainmentWithInverseEList<ModelResource>(ModelResource.class, this, MigrationPackage.MODEL__RESOURCES,
                    MigrationPackage.MODEL_RESOURCE__MODEL);
        }
        return resources;
    }
