    ...
    public boolean validatePriorityType_MemberTypes(Object priorityType, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (diagnostics != null) {
            ...
            if (jpdl32Package.Literals.PRIORITY_TYPE_MEMBER0.isInstance(priorityType)) {
                if (validatePriorityTypeMember0((PriorityTypeMember0) priorityType, tempDiagnostics, context))
                    return true;
            }
            if (jpdl32Package.Literals.PRIORITY_TYPE_MEMBER1.isInstance(priorityType)) {
                if (validatePriorityTypeMember1((Integer) priorityType, tempDiagnostics, context))
                    return true;
            }
            ...
            if (jpdl32Package.Literals.PRIORITY_TYPE_MEMBER0.isInstance(priorityType)) {
                if (validatePriorityTypeMember0((PriorityTypeMember0) priorityType, null, context))
                    return true;
            }
            if (jpdl32Package.Literals.PRIORITY_TYPE_MEMBER1.isInstance(priorityType)) {
                if (validatePriorityTypeMember1((Integer) priorityType, null, context))
                    return true;
            }
        }
        return false;
    ...
    public boolean validateTypeType_MemberTypes(Object typeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (diagnostics != null) {
            ...
            if (jpdl32Package.Literals.TYPE_TYPE_MEMBER0.isInstance(typeType)) {
                if (validateTypeTypeMember0((String) typeType, tempDiagnostics, context))
                    return true;
            }
            if (jpdl32Package.Literals.TYPE_TYPE_MEMBER1.isInstance(typeType)) {
                if (validateTypeTypeMember1((TypeTypeMember1) typeType, tempDiagnostics, context))
                    return true;
            }
            for (Diagnostic diagnostic : tempDiagnostics.getChildren()) {
                diagnostics.add(diagnostic);
            ...
            if (jpdl32Package.Literals.TYPE_TYPE_MEMBER0.isInstance(typeType)) {
                if (validateTypeTypeMember0((String) typeType, null, context))
                    return true;
            }
            if (jpdl32Package.Literals.TYPE_TYPE_MEMBER1.isInstance(typeType)) {
                if (validateTypeTypeMember1((TypeTypeMember1) typeType, null, context))
                    return true;
            }
        }
        return false;
