...
public class ActionTypeImpl extends EObjectImpl implements ActionType {
    ...
    public void setAcceptPropagatedEvents(BooleanType newAcceptPropagatedEvents) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, jpdl32Package.ACTION_TYPE__ACCEPT_PROPAGATED_EVENTS, oldAcceptPropagatedEvents,
                    acceptPropagatedEvents, !oldAcceptPropagatedEventsESet));
    }
    ...
    public void unsetAcceptPropagatedEvents() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, jpdl32Package.ACTION_TYPE__ACCEPT_PROPAGATED_EVENTS, oldAcceptPropagatedEvents,
                    ACCEPT_PROPAGATED_EVENTS_EDEFAULT, oldAcceptPropagatedEventsESet));
    }
    ...
    public void unsetConfigType() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, jpdl32Package.ACTION_TYPE__CONFIG_TYPE, oldConfigType, CONFIG_TYPE_EDEFAULT,
                    oldConfigTypeESet));
    }
