...
public class TimerTypeImpl extends EObjectImpl implements TimerType {
    ...
    public NotificationChain basicSetCreateTimer(CreateTimerType newCreateTimer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, jpdl32Package.TIMER_TYPE__CREATE_TIMER, oldCreateTimer,
                    newCreateTimer);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetCancelTimer(CancelTimerType newCancelTimer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, jpdl32Package.TIMER_TYPE__CANCEL_TIMER, oldCancelTimer,
                    newCancelTimer);
            if (msgs == null)
                msgs = notification;
            else
