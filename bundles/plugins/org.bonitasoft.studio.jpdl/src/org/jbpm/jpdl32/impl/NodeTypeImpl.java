...
public class NodeTypeImpl extends EObjectImpl implements NodeType {
    ...
    public NotificationChain basicSetCreateTimer(CreateTimerType newCreateTimer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, jpdl32Package.NODE_TYPE__CREATE_TIMER, oldCreateTimer,
                    newCreateTimer);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetCancelTimer(CancelTimerType newCancelTimer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, jpdl32Package.NODE_TYPE__CANCEL_TIMER, oldCancelTimer,
                    newCancelTimer);
            if (msgs == null)
                msgs = notification;
            else
