...
public class EndStateTypeImpl extends EObjectImpl implements EndStateType {
    ...
    public void setEndCompleteProcess(BooleanType newEndCompleteProcess) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, jpdl32Package.END_STATE_TYPE__END_COMPLETE_PROCESS, oldEndCompleteProcess,
                    endCompleteProcess, !oldEndCompleteProcessESet));
    }
    ...
    public void unsetEndCompleteProcess() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, jpdl32Package.END_STATE_TYPE__END_COMPLETE_PROCESS, oldEndCompleteProcess,
                    END_COMPLETE_PROCESS_EDEFAULT, oldEndCompleteProcessESet));
    }
