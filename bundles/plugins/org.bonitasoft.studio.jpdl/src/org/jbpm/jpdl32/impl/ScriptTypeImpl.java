...
public class ScriptTypeImpl extends EObjectImpl implements ScriptType {
    ...
    public void setAcceptPropagatedEvents(BooleanType newAcceptPropagatedEvents) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, jpdl32Package.SCRIPT_TYPE__ACCEPT_PROPAGATED_EVENTS, oldAcceptPropagatedEvents,
    ...
    public void unsetAcceptPropagatedEvents() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, jpdl32Package.SCRIPT_TYPE__ACCEPT_PROPAGATED_EVENTS, oldAcceptPropagatedEvents,
