...
public class CSSUtil implements CSSPropertyConstants {
    ...
    public static Map<String, Object> getPropertyMap(String rule, CSSProperties cssPropertyFile) {
        ...
        try {
            ...
            borderValue = new BorderCSSValue((String) result.get(ATTR_BORDER_BOTTOM_WIDTH), (String) result.get(ATTR_BORDER_BOTTOM_COLOR),
                    (String) result.get(ATTR_BORDER_BOTTOM_STYLE));
            ...
            borderValue = new BorderCSSValue((String) result.get(ATTR_BORDER_LEFT_WIDTH), (String) result.get(ATTR_BORDER_LEFT_COLOR),
                    (String) result.get(ATTR_BORDER_LEFT_STYLE));
            if (!borderValue.toString().isEmpty()) {
            ...
            borderValue = new BorderCSSValue((String) result.get(ATTR_BORDER_RIGHT_WIDTH), (String) result.get(ATTR_BORDER_RIGHT_COLOR),
                    (String) result.get(ATTR_BORDER_RIGHT_STYLE));
            if (!borderValue.toString().isEmpty()) {
            ...
            borderValue = new BorderCSSValue((String) result.get(ATTR_BORDER_TOP_WIDTH), (String) result.get(ATTR_BORDER_TOP_COLOR),
                    (String) result.get(ATTR_BORDER_TOP_STYLE));
            if (!borderValue.toString().isEmpty()) {
            ...
            borderValue = new BorderCSSValue((String) result.get(ATTR_BORDER_WIDTH), (String) result.get(ATTR_BORDER_COLOR),
                    (String) result.get(ATTR_BORDER_STYLE));
            if (!borderValue.toString().isEmpty()) {
