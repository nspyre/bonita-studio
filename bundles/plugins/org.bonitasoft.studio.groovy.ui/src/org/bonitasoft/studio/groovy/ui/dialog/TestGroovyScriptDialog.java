...
public class TestGroovyScriptDialog extends Dialog {
    ...
    public TestGroovyScriptDialog(Shell parentShell, List<ScriptVariable> nodes, GroovyCompilationUnit unit, String returnType,
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        for (Entry<Label, Control> entry : widgetMap.entrySet()) {
            ...
            dbc.bindValue(SWTObservables.observeEnabled(testButton), SWTObservables.observeText(entry.getValue(), SWT.Modify), new UpdateValueStrategy(
