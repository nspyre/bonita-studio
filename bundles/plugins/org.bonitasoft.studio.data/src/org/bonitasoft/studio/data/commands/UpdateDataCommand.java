...
public class UpdateDataCommand extends AbstractTransactionalCommand {
    ...
    public UpdateDataCommand(TransactionalEditingDomain editingDomain, Data data, String name, String description, String datatype, boolean dataMultiplicity,
            Expression defaultValue, String barPath, String javaTypeClass, String xmlNamespace, String xmlElement, boolean dataIsTransient) {
    ...
    public UpdateDataCommand(TransactionalEditingDomain editingDomain, Data data, String name, String description, String datatype, boolean dataMultiplicity,
            Expression defaultValue, String barPath, String javaTypeClass, String xmlNamespace, String xmlElement, boolean generateData, boolean dataIsTransient) {
        this(editingDomain, data, name, description, datatype, dataMultiplicity, defaultValue, barPath, javaTypeClass, xmlNamespace, xmlElement,
                dataIsTransient);
