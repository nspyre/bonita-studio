...
public class MoveDataWizardPage extends WizardPage implements
    ...
    public void createControl(Composite parent) {
        ...
        context.bindValue(ViewersObservables.observeSingleSelection(modelTree.getViewer()),
                PojoProperties.value(MoveDataWizardPage.class, "selectedDataAwareElement").observe(this), selectionStrategy, null);
