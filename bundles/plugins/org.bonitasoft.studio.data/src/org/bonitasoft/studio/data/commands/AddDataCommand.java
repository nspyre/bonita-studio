...
public class AddDataCommand extends AbstractTransactionalCommand {
    ...
    public AddDataCommand(TransactionalEditingDomain editingDomain, Element element, EStructuralFeature feature, String name, String label, String description,
            String datatype, boolean dataMultiplicity, Expression defaultValue, String barPath, String javaClassName, String xmlNamespace, String xmlElement,
            boolean isTransient) {
    ...
    public AddDataCommand(TransactionalEditingDomain editingDomain, Element element, EStructuralFeature feature, String name, String label, String description,
            String datatype, boolean dataMultiplicity, Expression defaultValue, String barPath, String javaClassName, String xmlNamespace, String xmlElement,
            boolean generateData, boolean isTransient) {
        this(editingDomain, element, feature, name, label, description, datatype, dataMultiplicity, defaultValue, barPath, javaClassName, xmlNamespace,
                xmlElement, isTransient);
