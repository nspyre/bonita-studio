...
// return false ;
// // return DeploymentConfigurationRepository.getInstance().getProject().getFolder(RemoteDeployConstants.DEFAULT_CONFIG+".conf") == null ||
// !DeploymentConfigurationRepository.getInstance().getProject().getFolder(RemoteDeployConstants.DEFAULT_CONFIG+".conf").exists();
// }
//
