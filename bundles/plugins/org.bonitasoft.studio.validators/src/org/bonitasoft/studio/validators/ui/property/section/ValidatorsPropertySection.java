            ...
            public void selectionChanged(final SelectionChangedEvent event) {
                ...
                if (currentValidator != null) {
                    ...
                    if (selection == null) {
                        ...
                        getEditingDomain().getCommandStack().execute(
                                SetCommand.create(getEditingDomain(), currentValidator, FormPackage.Literals.VALIDATOR__PARAMETER, selection));
                ...
                if (currentValidator != null) {
                    ...
                    if (selection == null) {
                        selection = ExpressionFactory.eINSTANCE.createExpression();
                        getEditingDomain().getCommandStack().execute(
                                SetCommand.create(getEditingDomain(), currentValidator, FormPackage.Literals.VALIDATOR__DISPLAY_NAME, selection));
                    }
                    if (currentValidator != null) {
            ...
            if (lastEObject == null || !lastEObject.equals(getEObject())) {
                ...
                if (lastEObject != null) {
                    ...
                    defaultValidatorContext.bindValue(SWTObservables.observeSelection(defaultValidator),
                            EMFObservables.observeValue(getEObject(), FormPackage.Literals.VALIDABLE__USE_DEFAULT_VALIDATOR));
                    ...
                    final IObservableValue nameDetailValue = EMFObservables.observeDetailValue(Realm.getDefault(), treeViewerObservaleValue,
                    ...
                    final IObservableValue emfValidatorClassObservableDetailValue = EMFObservables.observeDetailValue(Realm.getDefault(),
                            treeViewerObservaleValue, FormPackage.Literals.VALIDATOR__VALIDATOR_CLASS);
                    ...
                    final IObservableValue htmlDetailValue = EMFObservables.observeDetailValue(Realm.getDefault(), treeViewerObservaleValue,
                    ...
                    final IObservableValue isBelowValue = EMFObservables.observeDetailValue(Realm.getDefault(), treeViewerObservaleValue,
            ...
            if (validatorId != null) {
                ...
                if (descriptior != null) {
                    ...
                    if (descriptior.getName().equals(GROOVY_TYPE) && !currentValidator.getParameter().getReturnType().equals(Boolean.class.getName())) {
                        getEditingDomain().getCommandStack().execute(
                                SetCommand.create(getEditingDomain(), currentValidator.getParameter(), ExpressionPackage.Literals.EXPRESSION__RETURN_TYPE,
                                        Boolean.class.getName()));
                        getEditingDomain().getCommandStack().execute(
                                SetCommand.create(getEditingDomain(), currentValidator.getParameter(),
        ...
        removeButton.addListener(SWT.Selection, new Listener() {
            ...
            public void handleEvent(final Event event) {
                ...
                if (tableViewer != null && ((IStructuredSelection) tableViewer.getSelection()).size() > 0) {
                    ...
                    final IUndoableOperation operation = new RemoveValidatorCommand(getEditingDomain(), getValidable(), selection,
                            ValidatorsPropertySection.this);
                    try {
