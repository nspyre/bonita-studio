...
public class ExportValidatorAction extends Action implements IConfigurationExportAction {
    ...
    private void exportValidatorJar(String filePath) {
        ...
        final ValidatorDescriptorRepositoryStore defStore = (ValidatorDescriptorRepositoryStore) RepositoryManager.getInstance().getRepositoryStore(
                ValidatorDescriptorRepositoryStore.class);
        final ValidatorSourceRepositorySotre sourceStore = (ValidatorSourceRepositorySotre) RepositoryManager.getInstance().getRepositoryStore(
