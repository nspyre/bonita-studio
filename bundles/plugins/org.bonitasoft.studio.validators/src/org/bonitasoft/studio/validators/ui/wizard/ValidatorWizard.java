    ...
    public boolean performFinish() {
        ...
        IRunnableWithProgress runnable = new IRunnableWithProgress() {
            ...
            public void run(IProgressMonitor monitor) {
                ...
                if (orginalValidator != null && orginalValidator.getClassName() != null && validator != null
                        && !orginalValidator.getClassName().equals(validator.getClassName())) {
                        ...
                        for (Validator v : validators) {
                            if (v.getValidatorClass().equals(orginalValidator.getClassName())) {
                                ...
                                domain.getCommandStack().execute(
                                        SetCommand.create(domain, v, FormPackage.Literals.VALIDATOR__VALIDATOR_CLASS, validator.getClassName()));
                                try {
