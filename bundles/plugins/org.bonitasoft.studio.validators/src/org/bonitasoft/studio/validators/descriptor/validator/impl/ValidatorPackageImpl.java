...
public class ValidatorPackageImpl extends EPackageImpl implements ValidatorPackage {
    ...
    public static ValidatorPackage init() {
        if (isInited)
            return (ValidatorPackage) EPackage.Registry.INSTANCE.getEPackage(ValidatorPackage.eNS_URI);

        // Obtain or create and register package
        ValidatorPackageImpl theValidatorPackage = (ValidatorPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ValidatorPackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ValidatorPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getValidatorDescriptor_Name(), ecorePackage.getEString(), "name", null, 0, 1, ValidatorDescriptor.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidatorDescriptor_Description(), ecorePackage.getEString(), "description", null, 0, 1, ValidatorDescriptor.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidatorDescriptor_ClassName(), ecorePackage.getEString(), "className", null, 0, 1, ValidatorDescriptor.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidatorDescriptor_HasParameter(), ecorePackage.getEBooleanObject(), "hasParameter", "false", 0, 1, ValidatorDescriptor.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidatorDescriptor_Type(), this.getValidatorType(), "type", "0", 0, 1, ValidatorDescriptor.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidatorDescriptor_Dependencies(), ecorePackage.getEString(), "dependencies", null, 0, -1, ValidatorDescriptor.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
