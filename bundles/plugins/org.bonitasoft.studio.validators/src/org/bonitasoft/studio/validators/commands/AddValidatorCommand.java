...
public class AddValidatorCommand extends AbstractTransactionalCommand {
    ...
    public AddValidatorCommand(TransactionalEditingDomain domain, Validable validable, String name, String validatorClass,
            ValidatorsPropertySection callingSection) {
        super(domain, "Add validator", getWorkspaceFiles(validable));
        this.name = name;
        this.validable = validable;
        this.callingSection = callingSection;
