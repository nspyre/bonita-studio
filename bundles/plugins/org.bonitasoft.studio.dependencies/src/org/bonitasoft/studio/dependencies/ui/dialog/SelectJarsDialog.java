...
public class SelectJarsDialog extends ManageJarDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        context.bindValue(ViewersObservables.observeSingleSelection(tableViewer), PojoProperties.value(SelectJarsDialog.class, "selectedJar").observe(this),
                selectionStartegy, null);
