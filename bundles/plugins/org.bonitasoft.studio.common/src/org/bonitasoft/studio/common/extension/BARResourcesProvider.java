...
public interface BARResourcesProvider {
     ...
     * @throws Exception
     */
    List<BarResource> addResourcesForConfiguration(BusinessArchiveBuilder builder, AbstractProcess process, Configuration configuration,
            Set<EObject> excludedObject) throws Exception;
