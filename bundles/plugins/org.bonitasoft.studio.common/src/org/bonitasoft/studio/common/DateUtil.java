...
public class DateUtil {
    ...
    public static String getWidgetMillisecond(Spinner yearSpinner, Spinner monthSpinner, Spinner daySpinner, Spinner hourSpinner, Spinner minutesSpinner,
    ...
    public static Long getWidgetMillisecondAsLong(Spinner yearSpinner, Spinner monthSpinner, Spinner daySpinner, Spinner hourSpinner, Spinner minutesSpinner,
            Spinner secondsSpinner) {
    ...
    public static void setWidgetDisplayDuration(Spinner year, Spinner month, Spinner daySpinner, Spinner hourSpinner, Spinner minutesSpinner,
            Spinner secondsSpinner, long parseLong) {
        long rest;
