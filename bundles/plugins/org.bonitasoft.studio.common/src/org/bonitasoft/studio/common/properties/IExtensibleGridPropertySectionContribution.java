...
public interface IExtensibleGridPropertySectionContribution {
     ...
     * 
     * @param object set the eObject currently selected. This is called by {@link ExtensibleGridPropertySection#setEObject(EObject)} This method must not
     *        perform UI refresh, which must be done in {@link #refresh()}.
     */
