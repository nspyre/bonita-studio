    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case XhtmlPackage.ABBR_TYPE: {
                ...
                if (result == null)
                    result = caseInline(abbrType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(abbrType);
                if (result == null)
            ...
            case XhtmlPackage.ACRONYM_TYPE: {
                ...
                if (result == null)
                    result = caseInline(acronymType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(acronymType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.ADDRESS_TYPE: {
                ...
                if (result == null)
                    result = caseInline(addressType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(addressType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.BDO_TYPE: {
                ...
                if (result == null)
                    result = caseInline(bdoType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(bdoType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.BIG_TYPE: {
                ...
                if (result == null)
                    result = caseInline(bigType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(bigType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.BLOCKQUOTE_TYPE: {
                ...
                if (result == null)
                    result = caseBlock(blockquoteType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.BTYPE: {
                ...
                if (result == null)
                    result = caseInline(bType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(bType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.BUTTON_TYPE: {
                ...
                if (result == null)
                    result = caseButtonContent(buttonType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.CAPTION_TYPE: {
                ...
                if (result == null)
                    result = caseInline(captionType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(captionType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.CITE_TYPE: {
                ...
                if (result == null)
                    result = caseInline(citeType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(citeType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.CODE_TYPE: {
                ...
                if (result == null)
                    result = caseInline(codeType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(codeType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.DD_TYPE: {
                ...
                if (result == null)
                    result = caseFlow(ddType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(ddType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.DEL_TYPE: {
                ...
                if (result == null)
                    result = caseFlow(delType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(delType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.DFN_TYPE: {
                ...
                if (result == null)
                    result = caseInline(dfnType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(dfnType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.DIV_TYPE: {
                ...
                if (result == null)
                    result = caseFlow(divType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(divType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.DT_TYPE: {
                ...
                if (result == null)
                    result = caseInline(dtType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(dtType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.EM_TYPE: {
                ...
                if (result == null)
                    result = caseInline(emType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(emType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.FLOW: {
                ...
                if (result == null)
                    result = caseXMLTypeDocumentRoot(flow);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.FORM_TYPE: {
                ...
                if (result == null)
                    result = caseFormContent(formType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.H1_TYPE: {
                ...
                if (result == null)
                    result = caseInline(h1Type);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(h1Type);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.H2_TYPE: {
                ...
                if (result == null)
                    result = caseInline(h2Type);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(h2Type);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.H3_TYPE: {
                ...
                if (result == null)
                    result = caseInline(h3Type);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(h3Type);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.H4_TYPE: {
                ...
                if (result == null)
                    result = caseInline(h4Type);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(h4Type);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.H5_TYPE: {
                ...
                if (result == null)
                    result = caseInline(h5Type);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(h5Type);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.H6_TYPE: {
                ...
                if (result == null)
                    result = caseInline(h6Type);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(h6Type);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.INLINE: {
                ...
                if (result == null)
                    result = caseXMLTypeDocumentRoot(inline);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.INS_TYPE: {
                ...
                if (result == null)
                    result = caseFlow(insType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(insType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.ITYPE: {
                ...
                if (result == null)
                    result = caseInline(iType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(iType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.KBD_TYPE: {
                ...
                if (result == null)
                    result = caseInline(kbdType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(kbdType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.LABEL_TYPE: {
                ...
                if (result == null)
                    result = caseInline(labelType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(labelType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.LEGEND_TYPE: {
                ...
                if (result == null)
                    result = caseInline(legendType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(legendType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.LI_TYPE: {
                ...
                if (result == null)
                    result = caseFlow(liType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(liType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.OPTION_TYPE: {
                ...
                if (result == null)
                    result = caseXMLTypeDocumentRoot(optionType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.PTYPE: {
                ...
                if (result == null)
                    result = caseInline(pType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(pType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.QTYPE: {
                ...
                if (result == null)
                    result = caseInline(qType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(qType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.SAMP_TYPE: {
                ...
                if (result == null)
                    result = caseInline(sampType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(sampType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.SMALL_TYPE: {
                ...
                if (result == null)
                    result = caseInline(smallType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(smallType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.SPAN_TYPE: {
                ...
                if (result == null)
                    result = caseInline(spanType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(spanType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.STRONG_TYPE: {
                ...
                if (result == null)
                    result = caseInline(strongType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(strongType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.SUB_TYPE: {
                ...
                if (result == null)
                    result = caseInline(subType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(subType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.SUP_TYPE: {
                ...
                if (result == null)
                    result = caseInline(supType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(supType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.TD_TYPE: {
                ...
                if (result == null)
                    result = caseFlow(tdType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(tdType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.TEXTAREA_TYPE: {
                ...
                if (result == null)
                    result = caseXMLTypeDocumentRoot(textareaType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.TH_TYPE: {
                ...
                if (result == null)
                    result = caseFlow(thType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(thType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case XhtmlPackage.TITLE_TYPE: {
                ...
                if (result == null)
                    result = caseXMLTypeDocumentRoot(titleType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.TT_TYPE: {
                ...
                if (result == null)
                    result = caseInline(ttType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(ttType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case XhtmlPackage.VAR_TYPE: {
                ...
                if (result == null)
                    result = caseInline(varType);
                if (result == null)
                    result = caseXMLTypeDocumentRoot(varType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
