...
public class ExporterService {
    ...
    public enum SERVICE_TYPE {
        HtmlTemplateGenerator, FormPreview
    };
    ...
    public Object getExporterService(SERVICE_TYPE type) {
        ...
        if (map == null) {
            ...
            IConfigurationElement[] cfgElts = BonitaStudioExtensionRegistryManager.getInstance().getConfigurationElements(
                    "org.bonitasoft.studio.exporter.exporterExtension");
