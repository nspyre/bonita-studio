...
public class ConditionModelAdapterFactory extends AdapterFactoryImpl
{
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.condition.conditionModel.Expression_ProcessRef <em>Expression Process
     * Ref</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.bonitasoft.studio.condition.conditionModel.Operation_Greater_Equals <em>Operation Greater
     * Equals</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
