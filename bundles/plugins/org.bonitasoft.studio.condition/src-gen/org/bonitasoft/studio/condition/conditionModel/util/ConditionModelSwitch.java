    ...
    protected T doSwitch(int classifierID, EObject theEObject)
    {
        switch (classifierID)
        {
            ...
            case ConditionModelPackage.EXPRESSION_DOUBLE: {
                ...
                if (result == null)
                    result = caseExpression(expression_Double);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.EXPRESSION_INTEGER: {
                ...
                if (result == null)
                    result = caseExpression(expression_Integer);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.EXPRESSION_STRING: {
                ...
                if (result == null)
                    result = caseExpression(expression_String);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.EXPRESSION_PROCESS_REF: {
                ...
                if (result == null)
                    result = caseExpression(expression_ProcessRef);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.EXPRESSION_BOOLEAN: {
                ...
                if (result == null)
                    result = caseExpression(expression_Boolean);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.OPERATION_LESS_EQUALS: {
                ...
                if (result == null)
                    result = caseOperation(operation_Less_Equals);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.OPERATION_LESS: {
                ...
                if (result == null)
                    result = caseOperation(operation_Less);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.OPERATION_GREATER_EQUALS: {
                ...
                if (result == null)
                    result = caseOperation(operation_Greater_Equals);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.OPERATION_GREATER: {
                ...
                if (result == null)
                    result = caseOperation(operation_Greater);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.OPERATION_NOT_EQUALS: {
                ...
                if (result == null)
                    result = caseOperation(operation_Not_Equals);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.OPERATION_EQUALS: {
                ...
                if (result == null)
                    result = caseOperation(operation_Equals);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.OPERATION_UNARY: {
                ...
                if (result == null)
                    result = caseUnary_Operation(operation_Unary);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConditionModelPackage.OPERATION_NOT_UNARY: {
                ...
                if (result == null)
                    result = caseUnary_Operation(operation_NotUnary);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
