...
public abstract class AbstractImplementationWizardPage extends NewTypeWizardPage implements ISelectionChangedListener {
    ...
    public AbstractImplementationWizardPage(final ConnectorImplementation implementation, final List<ConnectorImplementation> existingImpl,
            final List<ConnectorDefinition> definitions, final SourceRepositoryStore<AbstractFileStore> sourceStore, final String pageTitle,
            final String pageDescription, final DefinitionResourceProvider messageProvider) {
    ...
    public void createControl(final Composite parent) {
        ...
        final MultiValidator definitionValidator = new MultiValidator() {
            ...
            protected IStatus validate() {
                ...
                final String implID = NamingUtils.toConnectorImplementationFilename(observableIdText.getValue().toString(), observableVersionText.getValue()
                        .toString(), false);
        ...
        context.bindValue(observableIdText,
                EMFObservables.observeValue(implementation, ConnectorImplementationPackage.Literals.CONNECTOR_IMPLEMENTATION__IMPLEMENTATION_ID), idStrategy,
                null);
        context.bindValue(observableVersionText,
                EMFObservables.observeValue(implementation, ConnectorImplementationPackage.Literals.CONNECTOR_IMPLEMENTATION__IMPLEMENTATION_VERSION),
        ...
        context.bindValue(SWTObservables.observeText(descriptionText, SWT.Modify),
                EMFObservables.observeValue(implementation, ConnectorImplementationPackage.Literals.CONNECTOR_IMPLEMENTATION__DESCRIPTION), descStrategy, null);
                        ...
                        if (qualifiedClassName.equals(impl.getImplementationClassname())) {
                            return ValidationStatus.error(qualifiedClassName
                                    ...
                                    + Messages.bind(Messages.alreadyExistsForAnotherImplementation,
                                            NamingUtils.toConnectorImplementationFilename(impl.getImplementationId(), impl.getImplementationVersion(), false)));
                        }
                    }
                }
                return ValidationStatus.ok();
    ...
    protected void createClassAndPackageName(final Composite mainComposite) {
        ...
        context.bindValue(observeClassText,
                EMFObservables.observeValue(implementation, ConnectorImplementationPackage.Literals.CONNECTOR_IMPLEMENTATION__IMPLEMENTATION_CLASSNAME),
    ...
    protected void createDependenciesViewer(final Composite mainComposite) {
        ...
        context.bindValue(ViewersObservables.observeInput(viewer),
                EMFObservables.observeValue(implementation.getJarDependencies(), ConnectorImplementationPackage.Literals.JAR_DEPENDENCIES__JAR_DEPENDENCY));
