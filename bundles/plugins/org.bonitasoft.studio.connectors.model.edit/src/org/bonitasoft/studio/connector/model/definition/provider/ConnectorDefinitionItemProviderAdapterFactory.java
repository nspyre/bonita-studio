 ...
 * @generated
 */
public class ConnectorDefinitionItemProviderAdapterFactory extends ConnectorDefinitionAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier,
        IDisposable {
    ...
    public void dispose() {
        ...
        if (connectorDefinitionItemProvider != null)
            connectorDefinitionItemProvider.dispose();
        if (documentRootItemProvider != null)
        ...
        if (textAreaItemProvider != null)
            textAreaItemProvider.dispose();
        if (widgetComponentItemProvider != null)
            widgetComponentItemProvider.dispose();
        if (unloadableConnectorDefinitionItemProvider != null)
            unloadableConnectorDefinitionItemProvider.dispose();
        if (scriptEditorItemProvider != null)
            scriptEditorItemProvider.dispose();
    }
