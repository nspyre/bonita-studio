...
public class OutputsWizardPage extends WizardPage implements ISelectionChangedListener {
    ...
    public void createControl(Composite parent) {
        ...
        context.bindValue(ViewersObservables.observeInput(outputsViewer),
                EMFObservables.observeValue(definition, ConnectorDefinitionPackage.Literals.CONNECTOR_DEFINITION__OUTPUT));
