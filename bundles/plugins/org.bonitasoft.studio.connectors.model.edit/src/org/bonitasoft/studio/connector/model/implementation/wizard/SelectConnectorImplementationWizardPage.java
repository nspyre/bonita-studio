...
public class SelectConnectorImplementationWizardPage extends WizardPage implements ISelectionChangedListener, IDoubleClickListener {
    ...
    public SelectConnectorImplementationWizardPage(String pageTitle, String pageDescription, IContentProvider contentProvider, LabelProvider labelProvider,
            IRepositoryStore<? extends IRepositoryFileStore> iRepositoryStore, SourceRepositoryStore<? extends AbstractFileStore> sourceRepositoryStore) {
    ...
    public void createControl(Composite parent) {
        ...
        context.bindValue(ViewersObservables.observeSingleSelection(table),
                PojoProperties.value(SelectConnectorImplementationWizardPage.class, "selectedImplementation").observe(this), selectionStrategy, null);
