    ...
    protected Control createDialogArea(Composite parent) {
        ...
        ControlDecorationSupport.create(
                context.bindValue(SWTObservables.observeText(idText, SWT.Modify),
                        EMFObservables.observeValue(category, ConnectorDefinitionPackage.Literals.CATEGORY__ID), idStrategy, null), SWT.LEFT);
        ...
        context.bindValue(SWTObservables.observeText(parentCategoryCombo),
                EMFObservables.observeValue(category, ConnectorDefinitionPackage.Literals.CATEGORY__PARENT_CATEGORY_ID), str, null);
