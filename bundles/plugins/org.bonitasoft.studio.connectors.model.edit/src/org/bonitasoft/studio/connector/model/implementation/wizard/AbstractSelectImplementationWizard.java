...
public abstract class AbstractSelectImplementationWizard extends Wizard {
    ...
    public void addPages() {
        page = new SelectConnectorImplementationWizardPage(getPageTitle(), getPageDescripiton(), getContentProvider(), getLabelProvider(),
                getImplementationStore(), getSourceStore());
        addPage(page);
    }
