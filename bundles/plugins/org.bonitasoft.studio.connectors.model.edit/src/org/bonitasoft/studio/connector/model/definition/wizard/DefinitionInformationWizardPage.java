...
public class DefinitionInformationWizardPage extends WizardPage implements ISelectionChangedListener {
    ...
    public DefinitionInformationWizardPage(ConnectorDefinition definition, Properties messages, List<ConnectorDefinition> existingDefinitions,
            Image defaultImage, DefinitionResourceProvider messageProvider) {
    ...
    public void createControl(Composite parent) {
        ...
        final MultiValidator definitionValidator = new MultiValidator() {
            ...
            protected IStatus validate() {
                ...
                String defID = NamingUtils.toConnectorDefinitionFilename(observableIdText.getValue().toString(), observableVersionText.getValue().toString(),
                        false);
        ...
        context.bindValue(definitionValidator.observeValidatedValue(observableIdText),
                EMFObservables.observeValue(definition, ConnectorDefinitionPackage.Literals.CONNECTOR_DEFINITION__ID), idStrategy, null);
        context.bindValue(definitionValidator.observeValidatedValue(observableVersionText),
                EMFObservables.observeValue(definition, ConnectorDefinitionPackage.Literals.CONNECTOR_DEFINITION__VERSION), versionStrategy, null);
        ...
        context.bindValue(SWTObservables.observeText(displayNameText, SWT.Modify), PojoProperties.value(DefinitionInformationWizardPage.class, "displayName")
                .observe(this));
        ...
        context.bindValue(SWTObservables.observeText(descriptionText, SWT.Modify),
                PojoProperties.value(DefinitionInformationWizardPage.class, "definitionDescription").observe(this), descStrategy, null);
    ...
    protected void createDependenciesViewer(Composite mainComposite) {
        ...
        context.bindValue(ViewersObservables.observeInput(viewer),
                EMFObservables.observeValue(definition, ConnectorDefinitionPackage.Literals.CONNECTOR_DEFINITION__JAR_DEPENDENCY));
