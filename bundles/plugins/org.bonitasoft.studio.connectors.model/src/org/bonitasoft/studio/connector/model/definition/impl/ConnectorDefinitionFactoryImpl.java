...
public class ConnectorDefinitionFactoryImpl extends EFactoryImpl implements ConnectorDefinitionFactory {
    ...
    public static ConnectorDefinitionFactory init() {
        try {
            ConnectorDefinitionFactory theConnectorDefinitionFactory = (ConnectorDefinitionFactory) EPackage.Registry.INSTANCE
                    .getEFactory(ConnectorDefinitionPackage.eNS_URI);
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            ...
            case ConnectorDefinitionPackage.UNLOADABLE_CONNECTOR_DEFINITION:
                return createUnloadableConnectorDefinition();
