...
public class ArrayImpl extends WidgetImpl implements Array {
    ...
    public void unsetFixedCols() {
        ...
        fixedColsESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ConnectorDefinitionPackage.ARRAY__FIXED_COLS, oldFixedCols, FIXED_COLS_EDEFAULT,
                    oldFixedColsESet));
    }
    ...
    public void unsetFixedRows() {
        ...
        fixedRowsESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ConnectorDefinitionPackage.ARRAY__FIXED_ROWS, oldFixedRows, FIXED_ROWS_EDEFAULT,
                    oldFixedRowsESet));
    }
