    ...
    public EMap<String, String> getXMLNSPrefixMap() {
        if (xMLNSPrefixMap == null) {
            xMLNSPrefixMap = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this,
                    ConnectorImplementationPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
        }
    ...
    public EMap<String, String> getXSISchemaLocation() {
        if (xSISchemaLocation == null) {
            xSISchemaLocation = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this,
                    ConnectorImplementationPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
        }
    ...
    public NotificationChain basicSetConnectorImplementation(ConnectorImplementation newConnectorImplementation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ConnectorImplementationPackage.DOCUMENT_ROOT__CONNECTOR_IMPLEMENTATION, oldConnectorImplementation, newConnectorImplementation);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setConnectorImplementation(ConnectorImplementation newConnectorImplementation) {
        if (newConnectorImplementation != connectorImplementation) {
            ...
            if (connectorImplementation != null)
                msgs = ((InternalEObject) connectorImplementation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ConnectorImplementationPackage.DOCUMENT_ROOT__CONNECTOR_IMPLEMENTATION, null, msgs);
            if (newConnectorImplementation != null)
                msgs = ((InternalEObject) newConnectorImplementation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - ConnectorImplementationPackage.DOCUMENT_ROOT__CONNECTOR_IMPLEMENTATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorImplementationPackage.DOCUMENT_ROOT__CONNECTOR_IMPLEMENTATION,
                    newConnectorImplementation, newConnectorImplementation));
    }
