    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case ConnectorDefinitionPackage.ARRAY: {
                ...
                if (result == null)
                    result = caseWidget(array);
                if (result == null)
                    result = caseWidgetComponent(array);
                if (result == null)
                    result = caseComponent(array);
                if (result == null)
            ...
            case ConnectorDefinitionPackage.CHECKBOX: {
                ...
                if (result == null)
                    result = caseWidget(checkbox);
                if (result == null)
                    result = caseWidgetComponent(checkbox);
                if (result == null)
                    result = caseComponent(checkbox);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ConnectorDefinitionPackage.LIST: {
                ...
                if (result == null)
                    result = caseWidget(list);
                if (result == null)
                    result = caseWidgetComponent(list);
                if (result == null)
                    result = caseComponent(list);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ConnectorDefinitionPackage.PASSWORD: {
                ...
                if (result == null)
                    result = caseText(password);
                if (result == null)
                    result = caseWidget(password);
                if (result == null)
                    result = caseWidgetComponent(password);
                if (result == null)
                    result = caseComponent(password);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConnectorDefinitionPackage.RADIO_GROUP: {
                ...
                if (result == null)
                    result = caseWidget(radioGroup);
                if (result == null)
                    result = caseWidgetComponent(radioGroup);
                if (result == null)
                    result = caseComponent(radioGroup);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConnectorDefinitionPackage.SELECT: {
                ...
                if (result == null)
                    result = caseWidget(select);
                if (result == null)
                    result = caseWidgetComponent(select);
                if (result == null)
                    result = caseComponent(select);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConnectorDefinitionPackage.TEXT: {
                ...
                if (result == null)
                    result = caseWidgetComponent(text);
                if (result == null)
                    result = caseComponent(text);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConnectorDefinitionPackage.TEXT_AREA: {
                ...
                if (result == null)
                    result = caseWidget(textArea);
                if (result == null)
                    result = caseWidgetComponent(textArea);
                if (result == null)
                    result = caseComponent(textArea);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConnectorDefinitionPackage.WIDGET: {
                ...
                if (result == null)
                    result = caseWidgetComponent(widget);
                if (result == null)
                    result = caseComponent(widget);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConnectorDefinitionPackage.WIDGET_COMPONENT: {
                ...
                if (result == null)
                    result = caseComponent(widgetComponent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConnectorDefinitionPackage.UNLOADABLE_CONNECTOR_DEFINITION: {
                ...
                if (result == null)
                    result = caseConnectorDefinition(unloadableConnectorDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ConnectorDefinitionPackage.SCRIPT_EDITOR: {
                ...
                if (result == null)
                    result = caseWidget(scriptEditor);
                if (result == null)
                    result = caseWidgetComponent(scriptEditor);
                if (result == null)
                    result = caseComponent(scriptEditor);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
