 ...
 * <li>{@link org.bonitasoft.studio.connector.model.implementation.impl.ConnectorImplementationImpl#getImplementationVersion <em>Implementation Version</em>}
 * </li>
 ...
 * <li>{@link org.bonitasoft.studio.connector.model.implementation.impl.ConnectorImplementationImpl#getImplementationClassname <em>Implementation
 * Classname</em>}</li>
...
public class ConnectorImplementationImpl extends EObjectImpl implements ConnectorImplementation {
    ...
    public NotificationChain basicSetJarDependencies(JarDependencies newJarDependencies, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__JAR_DEPENDENCIES, oldJarDependencies, newJarDependencies);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setJarDependencies(JarDependencies newJarDependencies) {
        if (newJarDependencies != jarDependencies) {
            ...
            if (jarDependencies != null)
                msgs = ((InternalEObject) jarDependencies).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__JAR_DEPENDENCIES, null, msgs);
            if (newJarDependencies != null)
                msgs = ((InternalEObject) newJarDependencies).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__JAR_DEPENDENCIES, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__JAR_DEPENDENCIES,
                    newJarDependencies, newJarDependencies));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__DESCRIPTION, oldDescription,
                    description));
    }
    ...
    public void setDefinitionId(String newDefinitionId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__DEFINITION_ID, oldDefinitionId,
                    definitionId));
    }
    ...
    public void setDefinitionVersion(String newDefinitionVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__DEFINITION_VERSION,
    ...
    public void setHasSources(boolean newHasSources) {
        ...
        hasSourcesESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__HAS_SOURCES, oldHasSources,
                    hasSources, !oldHasSourcesESet));
    }
    ...
    public void unsetHasSources() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__HAS_SOURCES, oldHasSources,
                    HAS_SOURCES_EDEFAULT, oldHasSourcesESet));
    }
    ...
    public void setImplementationClassname(String newImplementationClassname) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__IMPLEMENTATION_CLASSNAME,
                    oldImplementationClassname, implementationClassname));
    }
    ...
    public void setImplementationId(String newImplementationId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__IMPLEMENTATION_ID,
    ...
    public void setImplementationVersion(String newImplementationVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__IMPLEMENTATION_VERSION,
                    oldImplementationVersion, implementationVersion));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__IMPLEMENTATION_CLASSNAME:
                return IMPLEMENTATION_CLASSNAME_EDEFAULT == null ? implementationClassname != null : !IMPLEMENTATION_CLASSNAME_EDEFAULT
                        .equals(implementationClassname);
            case ConnectorImplementationPackage.CONNECTOR_IMPLEMENTATION__HAS_SOURCES:
