...
public class ConnectorDefinitionPackageImpl extends EPackageImpl implements ConnectorDefinitionPackage {
    ...
    public static ConnectorDefinitionPackage init() {
        if (isInited)
            return (ConnectorDefinitionPackage) EPackage.Registry.INSTANCE.getEPackage(ConnectorDefinitionPackage.eNS_URI);

        // Obtain or create and register package
        ConnectorDefinitionPackageImpl theConnectorDefinitionPackage = (ConnectorDefinitionPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ConnectorDefinitionPackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ConnectorDefinitionPackageImpl());
        ...
        ConnectorImplementationPackageImpl theConnectorImplementationPackage = (ConnectorImplementationPackageImpl) (EPackage.Registry.INSTANCE
                .getEPackage(ConnectorImplementationPackage.eNS_URI) instanceof ConnectorImplementationPackageImpl ? EPackage.Registry.INSTANCE
                .getEPackage(ConnectorImplementationPackage.eNS_URI) : ConnectorImplementationPackage.eINSTANCE);
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getArray_ColsCaption(), theXMLTypePackage.getString(), "colsCaption", null, 0, -1, Array.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getArray_Cols(), theXMLTypePackage.getInteger(), "cols", null, 0, 1, Array.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getArray_FixedCols(), theXMLTypePackage.getBoolean(), "fixedCols", "true", 0, 1, Array.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getArray_FixedRows(), theXMLTypePackage.getBoolean(), "fixedRows", null, 0, 1, Array.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getArray_Rows(), theXMLTypePackage.getInteger(), "rows", null, 0, 1, Array.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(categoryEClass, Category.class, "Category", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getCategory_Icon(), theXMLTypePackage.getString(), "icon", null, 0, 1, Category.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCategory_Id(), theXMLTypePackage.getString(), "id", null, 1, 1, Category.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCategory_ParentCategoryId(), theXMLTypePackage.getString(), "parentCategoryId", null, 0, 1, Category.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(checkboxEClass, Checkbox.class, "Checkbox", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(componentEClass, Component.class, "Component", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getComponent_Id(), theXMLTypePackage.getString(), "id", null, 1, 1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getConnectorDefinition_Id(), theXMLTypePackage.getString(), "id", null, 1, 1, ConnectorDefinition.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getConnectorDefinition_Version(), theXMLTypePackage.getString(), "version", null, 1, 1, ConnectorDefinition.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getConnectorDefinition_Icon(), theXMLTypePackage.getString(), "icon", null, 1, 1, ConnectorDefinition.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConnectorDefinition_Category(), this.getCategory(), null, "category", null, 0, -1, ConnectorDefinition.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConnectorDefinition_Input(), this.getInput(), null, "input", null, 0, -1, ConnectorDefinition.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConnectorDefinition_Output(), this.getOutput(), null, "output", null, 0, -1, ConnectorDefinition.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConnectorDefinition_Page(), this.getPage(), null, "page", null, 0, -1, ConnectorDefinition.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getConnectorDefinition_JarDependency(), theXMLTypePackage.getString(), "jarDependency", null, 0, -1, ConnectorDefinition.class,
        ...
        initEReference(getDocumentRoot_ConnectorDefinition(), this.getConnectorDefinition(), null, "connectorDefinition", null, 0, 1, null, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(groupEClass, Group.class, "Group", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getGroup_Widget(), this.getComponent(), null, "widget", null, 0, -1, Group.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGroup_Optional(), theXMLTypePackage.getBoolean(), "optional", null, 0, 1, Group.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(inputEClass, Input.class, "Input", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getInput_DefaultValue(), theXMLTypePackage.getString(), "defaultValue", null, 0, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInput_Mandatory(), theXMLTypePackage.getBoolean(), "mandatory", "false", 0, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInput_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInput_Type(), theXMLTypePackage.getString(), "type", null, 1, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(listEClass, List.class, "List", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getList_ShowDocuments(), ecorePackage.getEBoolean(), "showDocuments", "false", 0, 1, List.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(outputEClass, Output.class, "Output", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getOutput_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, Output.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getOutput_Type(), theXMLTypePackage.getString(), "type", null, 1, 1, Output.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(pageEClass, Page.class, "Page", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getPage_Widget(), this.getComponent(), null, "widget", null, 0, -1, Page.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getPage_Id(), theXMLTypePackage.getString(), "id", null, 1, 1, Page.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
        ...
        initEAttribute(getRadioGroup_Choices(), theXMLTypePackage.getString(), "choices", null, 0, -1, RadioGroup.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getRadioGroup_Orientation(), this.getOrientation(), "orientation", "HORIZONTAL", 0, 1, RadioGroup.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(selectEClass, Select.class, "Select", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSelect_Items(), theXMLTypePackage.getString(), "items", null, 0, -1, Select.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSelect_ReadOnly(), theXMLTypePackage.getBoolean(), "readOnly", null, 1, 1, Select.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(textEClass, Text.class, "Text", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getText_ShowDocuments(), ecorePackage.getEBoolean(), "showDocuments", "false", 0, 1, Text.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getWidgetComponent_InputName(), theXMLTypePackage.getString(), "inputName", null, 1, 1, WidgetComponent.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(unloadableConnectorDefinitionEClass, UnloadableConnectorDefinition.class, "UnloadableConnectorDefinition", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(scriptEditorEClass, ScriptEditor.class, "ScriptEditor", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getScriptEditor_Interpreter(), theXMLTypePackage.getString(), "interpreter", "GROOVY", 1, 1, ScriptEditor.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    protected void createExtendedMetaDataAnnotations() {
        ...
        addAnnotation(arrayEClass,
                source,
                new String[] {
                        "name", "Array",
                        "kind", "elementOnly"
                });
        addAnnotation(getArray_ColsCaption(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "colsCaption"
                });
        addAnnotation(getArray_Cols(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "cols"
                });
        addAnnotation(getArray_FixedCols(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "fixedCols"
                });
        addAnnotation(getArray_FixedRows(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "fixedRows"
                });
        addAnnotation(getArray_Rows(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "rows"
        ...
        addAnnotation(getCategory_Icon(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "icon"
                });
        addAnnotation(getCategory_Id(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "id"
                });
        addAnnotation(getCategory_ParentCategoryId(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "parentCategoryId"
                });
        addAnnotation(checkboxEClass,
                source,
                new String[] {
                        "name", "Checkbox",
                        "kind", "empty"
                });
        addAnnotation(componentEClass,
                source,
                new String[] {
                        "name", "Component",
                        "kind", "empty"
                });
        addAnnotation(getComponent_Id(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "id"
                });
        addAnnotation(connectorDefinitionEClass,
                source,
                new String[] {
                        "name", "ConnectorDefinition",
                        "kind", "elementOnly"
                });
        addAnnotation(getConnectorDefinition_Id(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "id"
                });
        addAnnotation(getConnectorDefinition_Version(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "version"
                });
        addAnnotation(getConnectorDefinition_Icon(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "icon"
                });
        addAnnotation(getConnectorDefinition_Category(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "category"
                });
        addAnnotation(getConnectorDefinition_Input(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "input"
                });
        addAnnotation(getConnectorDefinition_Output(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "output"
                });
        addAnnotation(getConnectorDefinition_Page(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "page"
                });
        addAnnotation(getConnectorDefinition_JarDependency(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "jarDependency"
        ...
        addAnnotation(getDocumentRoot_ConnectorDefinition(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "ConnectorDefinition",
        ...
        addAnnotation(getGroup_Widget(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "widget"
                });
        addAnnotation(getGroup_Optional(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "optional"
                });
        addAnnotation(inputEClass,
                source,
                new String[] {
                        "name", "Input",
                        "kind", "empty"
                });
        addAnnotation(getInput_DefaultValue(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "defaultValue"
                });
        addAnnotation(getInput_Mandatory(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "mandatory"
                });
        addAnnotation(getInput_Name(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "name"
                });
        addAnnotation(getInput_Type(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "type"
        ...
        addAnnotation(getList_ShowDocuments(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "showDocuments"
                });
        addAnnotation(orientationEEnum,
                source,
                new String[] {
                        "name", "Orientation"
                });
        addAnnotation(orientationObjectEDataType,
                source,
                new String[] {
                        "name", "Orientation:Object",
                        "baseType", "Orientation"
                });
        addAnnotation(outputEClass,
                source,
                new String[] {
                        "name", "Output",
                        "kind", "empty"
                });
        addAnnotation(getOutput_Name(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "name"
                });
        addAnnotation(getOutput_Type(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "type"
                });
        addAnnotation(pageEClass,
                source,
                new String[] {
                        "name", "Page",
                        "kind", "elementOnly"
                });
        addAnnotation(getPage_Widget(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "widget"
                });
        addAnnotation(getPage_Id(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "id"
                });
        addAnnotation(passwordEClass,
                source,
                new String[] {
                        "name", "Password",
                        "kind", "empty"
                });
        addAnnotation(radioGroupEClass,
                source,
                new String[] {
                        "name", "RadioGroup",
                        "kind", "elementOnly"
                });
        addAnnotation(getRadioGroup_Choices(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "choices"
                });
        addAnnotation(getRadioGroup_Orientation(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "orientation"
                });
        addAnnotation(selectEClass,
                source,
                new String[] {
                        "name", "Select",
                        "kind", "elementOnly"
                });
        addAnnotation(getSelect_Items(),
                source,
                new String[] {
                        "kind", "element",
                        "name", "items"
                });
        addAnnotation(getSelect_ReadOnly(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "readOnly"
                });
        addAnnotation(textEClass,
                source,
                new String[] {
                        "name", "Text",
                        "kind", "empty"
                });
        addAnnotation(getText_ShowDocuments(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "showDocuments"
                });
        addAnnotation(textAreaEClass,
                source,
                new String[] {
                        "name", "TextArea",
                        "kind", "empty"
                });
        addAnnotation(widgetEClass,
                source,
                new String[] {
                        "name", "Widget",
                        "kind", "empty"
                });
        addAnnotation(widgetComponentEClass,
                source,
                new String[] {
                        "name", "WidgetComponent",
                        "kind", "empty"
                });
        addAnnotation(getWidgetComponent_InputName(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "inputName"
                });
        addAnnotation(scriptEditorEClass,
                source,
                new String[] {
                        "name", "ScriptEditor",
                        "kind", "elementOnly"
                });
        addAnnotation(getScriptEditor_Interpreter(),
                source,
                new String[] {
                        "kind", "attribute",
                        "name", "interpreter"
