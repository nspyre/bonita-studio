...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
    ...
    public EMap<String, String> getXMLNSPrefixMap() {
        if (xMLNSPrefixMap == null) {
            xMLNSPrefixMap = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this,
                    ConnectorDefinitionPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
        }
    ...
    public EMap<String, String> getXSISchemaLocation() {
        if (xSISchemaLocation == null) {
            xSISchemaLocation = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this,
                    ConnectorDefinitionPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
        }
    ...
    public NotificationChain basicSetConnectorDefinition(ConnectorDefinition newConnectorDefinition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ConnectorDefinitionPackage.DOCUMENT_ROOT__CONNECTOR_DEFINITION,
                    oldConnectorDefinition, newConnectorDefinition);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setConnectorDefinition(ConnectorDefinition newConnectorDefinition) {
        if (newConnectorDefinition != connectorDefinition) {
            ...
            if (connectorDefinition != null)
                msgs = ((InternalEObject) connectorDefinition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ConnectorDefinitionPackage.DOCUMENT_ROOT__CONNECTOR_DEFINITION, null, msgs);
            if (newConnectorDefinition != null)
                msgs = ((InternalEObject) newConnectorDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - ConnectorDefinitionPackage.DOCUMENT_ROOT__CONNECTOR_DEFINITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorDefinitionPackage.DOCUMENT_ROOT__CONNECTOR_DEFINITION, newConnectorDefinition,
