...
public class RadioGroupImpl extends WidgetImpl implements RadioGroup {
    ...
    public void setOrientation(Orientation newOrientation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorDefinitionPackage.RADIO_GROUP__ORIENTATION, oldOrientation, orientation,
                    !oldOrientationESet));
    }
    ...
    public void unsetOrientation() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ConnectorDefinitionPackage.RADIO_GROUP__ORIENTATION, oldOrientation, ORIENTATION_EDEFAULT,
                    oldOrientationESet));
    }
