...
public class ScriptEditorImpl extends WidgetImpl implements ScriptEditor {
    ...
    public void setInterpreter(String newInterpreter) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectorDefinitionPackage.SCRIPT_EDITOR__INTERPRETER, oldInterpreter, interpreter,
                    !oldInterpreterESet));
    }
    ...
    public void unsetInterpreter() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ConnectorDefinitionPackage.SCRIPT_EDITOR__INTERPRETER, oldInterpreter,
                    INTERPRETER_EDEFAULT, oldInterpreterESet));
    }
