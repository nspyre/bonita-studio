...
public class FontSectionFilter implements IFilter {
    ...
    public boolean select(Object object) {
        if (object instanceof IGraphicalEditPart) {
            ...
            return model instanceof BoundaryEvent || model instanceof Gateway || model instanceof Event || model instanceof Activity || model instanceof Lane
                    || model instanceof Pool || model instanceof Connection || model instanceof MessageFlow;
        }
        return false;
    }
