...
public class ActivityTypeSelectionGridPropertySectionContribution implements IExtensibleGridPropertySectionContribution {
    ...
    private void createActivitySelectionCombo(Composite parent, TabbedPropertySheetWidgetFactory widgetFactory) {
        ...
        combo.setInput(new String[] { ACTIVITY_TYPE__TASK, ACTIVITY_TYPE__SYSTEM, ACTIVITY_TYPE__CALL_ACTVITY, ACTIVITY_TYPE__RECEIVE_TASK,
                ACTIVITY_TYPE__SEND_TASK, ACTIVITY_TYPE__SERVICE_TASK, ACTIVITY_TYPE__SCRIPT_TASK });
            ...
            public void selectionChanged(SelectionChangedEvent arg0) {
                if (toBeConverted()) {
                    ...
                    if (editor instanceof ProcessDiagramEditor) {
                        node = (GraphicalEditPart) ((IStructuredSelection) ((ProcessDiagramEditor) editor).getDiagramGraphicalViewer().getSelection())
                                .getFirstElement();
