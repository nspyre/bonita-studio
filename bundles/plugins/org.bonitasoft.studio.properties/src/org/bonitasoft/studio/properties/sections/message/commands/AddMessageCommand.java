...
public class AddMessageCommand extends AbstractTransactionalCommand {
    ...
    public AddMessageCommand(TransactionalEditingDomain domain, ThrowMessageEvent element, Message eventObject, String name, String label, String description,
            String throwEvent, String ttl, Expression targetElementName, Expression targetProcessName, ISection callingSection) {
