...
public class FillColorSectionFilter implements IFilter {
    ...
    public boolean select(Object object) {
        if (object instanceof IGraphicalEditPart) {
            ...
            return model instanceof Activity || model instanceof Lane || model instanceof Pool || model instanceof SubProcessEvent
                    || model instanceof Connection || model instanceof MessageFlow;
        }
        return false;
    }
