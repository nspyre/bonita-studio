...
public class CronEditor extends Composite {
    ...
    protected void createWeeklyTab(TabFolder tablFolder) {
        ...
        createStartTimeComposite(weeklyContent, hourObservable, minuteObservable, secondObservable).setLayoutData(
                GridDataFactory.fillDefaults().grab(true, true).span(4, 1).create());
