...
public class TransitionOrderingPropertySection extends AbstractBonitaDescriptionSection {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                for (Object selectedConnection : selectedConnections) {
                    ...
                    if (oldIndex != -1) {//should never happened
                        ...
                        command.append(MoveCommand.create(getEditingDomain(), getSourceElement(), ProcessPackage.Literals.SOURCE_ELEMENT__OUTGOING,
                                selectedConnection, newIndex));
                    }
                }
    ...
    protected void bindList() {
        ...
        final IObservableList outgoingListObserved = EMFEditProperties.list(getEditingDomain(), ProcessPackage.Literals.SOURCE_ELEMENT__OUTGOING).observe(
                sourceElement);
