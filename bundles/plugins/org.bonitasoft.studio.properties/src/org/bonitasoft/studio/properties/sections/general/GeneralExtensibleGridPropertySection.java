...
public class GeneralExtensibleGridPropertySection extends ExtensibleGridPropertySection {
    ...
    protected void addContributions() {
        ...
        ActivityTypeSelectionGridPropertySectionContribution activityTypeContrib = new ActivityTypeSelectionGridPropertySectionContribution(
                getTabbedPropertySheetPage());
        addContribution(activityTypeContrib);
        MessageEventTypeSelectionGridPropertySectionContribution messageEventContrib = new MessageEventTypeSelectionGridPropertySectionContribution(
                getTabbedPropertySheetPage());
        ...
        GatewayTypeSelectionGridPropertySectionContribution gatewayTypeContrib = new GatewayTypeSelectionGridPropertySectionContribution(
                getTabbedPropertySheetPage());
