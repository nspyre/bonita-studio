...
public class SingleValuatedFormFieldFilter implements IFilter {
    ...
    public boolean select(Object object) {
        if (object instanceof IGraphicalEditPart) {
            ...
            return (model instanceof SingleValuatedFormField || model instanceof HiddenWidget) && !(model instanceof DateFormField)
                    && !(model instanceof DurationFormField) && !(model instanceof FileWidget);
        }
        return false;
    }
