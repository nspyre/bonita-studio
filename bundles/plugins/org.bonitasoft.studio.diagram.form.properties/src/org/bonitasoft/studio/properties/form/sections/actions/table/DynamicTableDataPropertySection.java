...
public class DynamicTableDataPropertySection extends AbstractTableDataPropertySection {
    ...
    protected void createAddRemoveColumn(final Composite composite,
        ...
        textOrDataMinColumn = new ExpressionViewer(compoForNumberLimitation, SWT.BORDER, widgetFactory, getEditingDomain(),
        ...
        textOrDataMaxColumn = new ExpressionViewer(compoForNumberLimitation, SWT.BORDER, widgetFactory, getEditingDomain(),
    ...
    protected Composite createAddRemoveRow(final Composite composite,
        ...
        textOrDataMinRow = new ExpressionViewer(compoForNumberLimitation, SWT.BORDER, widgetFactory, getEditingDomain(),
        ...
        textOrDataMaxRow = new ExpressionViewer(compoForNumberLimitation, SWT.BORDER, widgetFactory, getEditingDomain(),
    ...
    protected void bindColumn(final DynamicTable dynamicTable) {
        dataBindingContext.bindValue(SWTObservables.observeSelection(allowAddRemoveColumnButton),
                EMFEditObservables.observeValue(getEditingDomain(), dynamicTable, FormPackage.Literals.DYNAMIC_TABLE__ALLOW_ADD_REMOVE_COLUMN));
        ...
        if (dynamicTable != null) {
            ...
            if (minNumberOfColumn == null) {
                ...
                getEditingDomain().getCommandStack().execute(
                        SetCommand.create(getEditingDomain(), dynamicTable, FormPackage.Literals.DYNAMIC_TABLE__MIN_NUMBER_OF_COLUMN, minNumberOfColumn));
            }
        }
        if (dynamicTable != null) {
            ...
            if (maxNumberOfColumn == null) {
                ...
                getEditingDomain().getCommandStack().execute(
                        SetCommand.create(getEditingDomain(), dynamicTable, FormPackage.Literals.DYNAMIC_TABLE__MAX_NUMBER_OF_COLUMN, maxNumberOfColumn));
            }
        }
        ...
        dataBindingContext.bindValue(SWTObservables.observeSelection(limitMinColumnButton),
                EMFEditObservables.observeValue(getEditingDomain(), dynamicTable, FormPackage.Literals.DYNAMIC_TABLE__LIMIT_MIN_NUMBER_OF_COLUMN));
        dataBindingContext.bindValue(SWTObservables.observeSelection(limitMaxColumnButton),
                EMFEditObservables.observeValue(getEditingDomain(), dynamicTable, FormPackage.Literals.DYNAMIC_TABLE__LIMIT_MAX_NUMBER_OF_COLUMN));
        ...
        dataBindingContext.bindValue(SWTObservables.observeVisible(limitMinColumnButton), SWTObservables.observeSelection(allowAddRemoveColumnButton),
                new UpdateValueStrategy(UpdateValueStrategy.POLICY_NEVER), null);
        dataBindingContext.bindValue(SWTObservables.observeVisible(limitMaxColumnButton), SWTObservables.observeSelection(allowAddRemoveColumnButton),
                new UpdateValueStrategy(UpdateValueStrategy.POLICY_NEVER), null);
        dataBindingContext.bindValue(SWTObservables.observeVisible(textOrDataMinColumn.getControl()),
                SWTObservables.observeSelection(allowAddRemoveColumnButton), new UpdateValueStrategy(UpdateValueStrategy.POLICY_NEVER), null);
    ...
    protected void bindRow(final DynamicTable dynamicTable) {
        dataBindingContext.bindValue(SWTObservables.observeSelection(allowAddRemoveRowButton),
                EMFEditObservables.observeValue(getEditingDomain(), dynamicTable, FormPackage.Literals.DYNAMIC_TABLE__ALLOW_ADD_REMOVE_ROW));
        ...
        if (dynamicTable != null) {
            ...
            if (minNumberOfRow == null) {
                ...
                getEditingDomain().getCommandStack().execute(
                        SetCommand.create(getEditingDomain(), dynamicTable, FormPackage.Literals.DYNAMIC_TABLE__MIN_NUMBER_OF_ROW, minNumberOfRow));
            }
        }
        ...
        if (dynamicTable != null) {
            ...
            if (maxNumberOfRow == null) {
                ...
                getEditingDomain().getCommandStack().execute(
                        SetCommand.create(getEditingDomain(), dynamicTable, FormPackage.Literals.DYNAMIC_TABLE__MAX_NUMBER_OF_ROW, maxNumberOfRow));
            }
        }
        ...
        dataBindingContext.bindValue(SWTObservables.observeSelection(limitMinRowButton),
                EMFEditObservables.observeValue(getEditingDomain(), dynamicTable, FormPackage.Literals.DYNAMIC_TABLE__LIMIT_MIN_NUMBER_OF_ROW));
        dataBindingContext.bindValue(SWTObservables.observeSelection(limitMaxRowButton),
                EMFEditObservables.observeValue(getEditingDomain(), dynamicTable, FormPackage.Literals.DYNAMIC_TABLE__LIMIT_MAX_NUMBER_OF_ROW));
