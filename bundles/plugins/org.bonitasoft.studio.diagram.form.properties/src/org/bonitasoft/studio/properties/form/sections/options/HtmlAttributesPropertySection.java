...
public class HtmlAttributesPropertySection implements IExtensibleGridPropertySectionContribution {
    ...
    public void createControl(Composite composite,
        ...
        dataBinding.bindValue(SWTObservables.observeText(text, SWT.Modify),
                EMFEditObservables.observeValue(editingDomain, widget, FormPackage.Literals.WIDGET__REAL_HTML_ATTRIBUTES));
