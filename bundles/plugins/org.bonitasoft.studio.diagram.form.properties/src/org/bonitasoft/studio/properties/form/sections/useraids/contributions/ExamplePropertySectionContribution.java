...
public class ExamplePropertySectionContribution implements
    ...
    public void createControl(Composite composite,
        ...
        ExpressionViewer exampleMessageViewer = new ExpressionViewer(composite, SWT.BORDER, widgetFactory, editingDomain,
        ...
        if (exampleMessageExpression == null) {
            ...
            editingDomain.getCommandStack().execute(
                    SetCommand.create(editingDomain, element, FormPackage.Literals.FORM_FIELD__EXAMPLE_MESSAGE, exampleMessageExpression));
        }
        ...
        exampleMessageViewer.addFilter(new AvailableExpressionTypeFilter(new String[] { ExpressionConstants.CONSTANT_TYPE, ExpressionConstants.VARIABLE_TYPE,
