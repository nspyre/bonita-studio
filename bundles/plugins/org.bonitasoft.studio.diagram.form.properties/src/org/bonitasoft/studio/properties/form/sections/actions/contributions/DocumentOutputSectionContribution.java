...
// checkBoxdataBinding.bindValue(EMFObservables.observeValue(element, FormPackage.Literals.FILE_WIDGET__DOWNLOAD_ONLY),
// SWTObservables.observeEnabled(updateDocumentCheckbox),new UpdateValueStrategy(){
// @Override
...
// checkBoxdataBinding.bindValue(EMFObservables.observeValue(element, FormPackage.Literals.FILE_WIDGET__DOWNLOAD_ONLY),
// SWTObservables.observeEnabled(newDocumentRadio),new UpdateValueStrategy(){
// @Override
// public Object convert(Object value) {
// return !(Boolean)value;
// }
...
// dataBinding.bindValue(EMFObservables.observeValue(element, FormPackage.Literals.FILE_WIDGET__DOWNLOAD_ONLY),
// SWTObservables.observeEnabled(newDocumentExpressionViewer.getToolbar()),new UpdateValueStrategy(){
// @Override
// public Object convert(Object value) {
// return !(Boolean)value;
// }
// },new UpdateValueStrategy(UpdateValueStrategy.POLICY_NEVER));
// dataBinding.bindValue(EMFObservables.observeValue(element, FormPackage.Literals.FILE_WIDGET__DOWNLOAD_ONLY),
// SWTObservables.observeEnabled(newDocumentExpressionViewer.getEraseControl()),new UpdateValueStrategy(){
// @Override
// public Object convert(Object value) {
// return !(Boolean)value;
// }
// },new UpdateValueStrategy(UpdateValueStrategy.POLICY_NEVER));
// dataBinding.bindValue(EMFObservables.observeValue(element, FormPackage.Literals.FILE_WIDGET__DOWNLOAD_ONLY),
// SWTObservables.observeEnabled(newDocumentExpressionViewer.getTextControl()),new UpdateValueStrategy(){
// @Override
// public Object convert(Object value) {
// return !(Boolean)value;
// }
// },new UpdateValueStrategy(UpdateValueStrategy.POLICY_NEVER));
// dataBinding.bindValue(EMFObservables.observeValue(element, FormPackage.Literals.FILE_WIDGET__DOWNLOAD_ONLY),
// SWTObservables.observeEnabled(newDocumentExpressionViewer.getButtonControl()),new UpdateValueStrategy(){
// @Override
// public Object convert(Object value) {
// return !(Boolean)value;
// }
...
// dataBinding.bindValue(ViewersObservables.observeSingleSelection(newDocumentExpressionViewer),EMFEditObservables.observeValue(getEditingDomain(), action,
...
// }) ;
//
// documentListExpressionViewer = new ExpressionViewer(client, SWT.BORDER, widgetFactory, editingDomain,
...
// editingDomain.getCommandStack().execute(SetCommand.create(editingDomain, element, FormPackage.Literals.FILE_WIDGET__OUTPUT_DOCUMENT_LIST_EXPRESSION,
...
// dataBinding.bindValue(EMFObservables.observeValue(element, FormPackage.Literals.FILE_WIDGET__DOWNLOAD_ONLY),
// SWTObservables.observeEnabled(documentListExpressionViewer.getTextControl()),new UpdateValueStrategy(){
// @Override
// public Object convert(Object value) {
// return !(Boolean)value;
// }
// },new UpdateValueStrategy(UpdateValueStrategy.POLICY_NEVER));
// dataBinding.bindValue(EMFObservables.observeValue(element, FormPackage.Literals.FILE_WIDGET__DOWNLOAD_ONLY),
// SWTObservables.observeEnabled(documentListExpressionViewer.getButtonControl()),new UpdateValueStrategy(){
// @Override
// public Object convert(Object value) {
// return !(Boolean)value;
// }
...
//
// dataBinding.bindValue(EMFObservables.observeValue(element, FormPackage.Literals.FILE_WIDGET__DOWNLOAD_ONLY),
// SWTObservables.observeEnabled(documentViewer.getControl()),new UpdateValueStrategy(){
// @Override
// public Object convert(Object value) {
// return !(Boolean)value;
// }
