        ...
        if (allowHtmlButton != null && !allowHtmlButton.isDisposed()) {
            ...
            if (inputExpression == null) {
                ...
                editingDomain.getCommandStack().execute(
                        SetCommand.create(editingDomain, widget, FormPackage.Literals.WIDGET__INPUT_EXPRESSION, inputExpression));
            }
            dataBindingContext.bindValue(SWTObservables.observeSelection(allowHtmlButton),
                    EMFEditObservables.observeValue(editingDomain, inputExpression, ExpressionPackage.Literals.EXPRESSION__HTML_ALLOWED));
        }
        updateViewerInput();
    }
