...
// }
// if(domain != null){
// SetCommand cmd = new SetCommand(domain, textOrData.getElement(), ProcessPackage.Literals.SEQUENCE_FLOW__CONDITION_TYPE,
// SequenceFlowConditionType.GROOVY_EXPRESSION);
