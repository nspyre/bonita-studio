    ...
    public void migrateAfter(Model model, Metamodel metamodel)
        ...
        for (Instance form : model.getAllInstances("form.Form")) {
            if (formActions.containsKey(form.getUuid())) {
                ...
                addReportChange((String) form.get("name"), form.getEClass().getName(), form.getUuid(), Messages.formActionsMigrationDescription,
                        Messages.actionProperty, IStatus.WARNING);
            }
            ...
            if (formLabels.containsKey(form.getUuid())) {
                ...
                addReportChange((String) form.get("name"), form.getEClass().getName(), form.getUuid(), Messages.displayLabelMigrationDescription,
