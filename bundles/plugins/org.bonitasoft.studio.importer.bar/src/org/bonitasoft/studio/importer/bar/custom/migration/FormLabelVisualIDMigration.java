...
public class FormLabelVisualIDMigration extends ReportCustomMigration {
    ...
    public void migrateBefore(Model model, Metamodel metamodel) throws MigrationException {
        for (Instance decorator : model.getAllInstances(NotationPackage.Literals.DECORATION_NODE)) {
            ...
            switch (viewType) {
                case COMBO_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(ComboFormFieldNameEditPart.VISUAL_ID));
                    break;
                case COMBO_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(ComboFormFieldName2EditPart.VISUAL_ID));
                    break;
                case DATE_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(DateFormFieldNameEditPart.VISUAL_ID));
                    break;
                case DATE_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(DateFormFieldName2EditPart.VISUAL_ID));
                    break;
                case LIST_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(ListFormFieldNameEditPart.VISUAL_ID));
                    break;
                case LIST_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(ListFormFieldName2EditPart.VISUAL_ID));
                    break;
                case PASSWORD_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(PasswordFormFieldNameEditPart.VISUAL_ID));
                    break;
                case PASSWORD_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(PasswordFormFieldName2EditPart.VISUAL_ID));
                    break;
                case RADIO_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(RadioFormFieldNameEditPart.VISUAL_ID));
                    break;
                case RADIO_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(RadioFormFieldName2EditPart.VISUAL_ID));
                    break;
                case SELECT_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(SelectFormFieldNameEditPart.VISUAL_ID));
                    break;
                case SELECT_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(SelectFormFieldName2EditPart.VISUAL_ID));
                    break;
                case TEXTFIELD_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(TextFormFieldNameEditPart.VISUAL_ID));
                    break;
                case TEXTFIELD_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(TextFormFieldName2EditPart.VISUAL_ID));
                    break;
                case TEXTAREA_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(TextAreaFormFieldNameEditPart.VISUAL_ID));
                    break;
                case TEXTAREA_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(TextAreaFormFieldName2EditPart.VISUAL_ID));
                    break;
                case SUBMIT_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(SubmitFormButtonNameEditPart.VISUAL_ID));
                    break;
                case SUBMIT_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(SubmitFormButtonName2EditPart.VISUAL_ID));
                    break;
                case NEXT_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(NextFormButtonNameEditPart.VISUAL_ID));
                    break;
                case NEXT_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(NextFormButtonName2EditPart.VISUAL_ID));
                    break;
                case PREVIOUS_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(PreviousFormButtonNameEditPart.VISUAL_ID));
                    break;
                case PREVIOUS_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(PreviousFormButtonName2EditPart.VISUAL_ID));
                    break;
                case CHECKBOX_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(CheckBoxSingleFormFieldNameEditPart.VISUAL_ID));
                    break;
                case CHECKBOX_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(CheckBoxSingleFormFieldName2EditPart.VISUAL_ID));
                    break;
                case TEXT_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(TextInfoNameEditPart.VISUAL_ID));
                    break;
                case TEXT_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(TextInfoName2EditPart.VISUAL_ID));
                    break;
                case FILE_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(FileWidgetNameEditPart.VISUAL_ID));
                    break;
                case FILE_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(FileWidgetName2EditPart.VISUAL_ID));
                    break;
                case MULTIPLECHECKBOX_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(CheckBoxMultipleFormFieldNameEditPart.VISUAL_ID));
                    break;
                case MULTIPLECHECKBOX_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(CheckBoxMultipleFormFieldName2EditPart.VISUAL_ID));
                    break;
                case IMAGE_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(ImageWidgetNameEditPart.VISUAL_ID));
                    break;
                case IMAGE_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(ImageWidgetName2EditPart.VISUAL_ID));
                    break;
                case DURATION_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(DurationFormFieldNameEditPart.VISUAL_ID));
                    break;
                case DURATION_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(DurationFormFieldName2EditPart.VISUAL_ID));
                    break;
                case BUTTON_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(FormButtonNameEditPart.VISUAL_ID));
                    break;
                case BUTTON_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(FormButtonName2EditPart.VISUAL_ID));
                    break;
                case TABLE_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(TableNameEditPart.VISUAL_ID));
                    break;
                case TABLE_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(TableName2EditPart.VISUAL_ID));
                    break;
                case RICHTEXT_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(RichTextAreaFormFieldNameEditPart.VISUAL_ID));
                    break;
                case RICHTEXT_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(RichTextAreaFormFieldName2EditPart.VISUAL_ID));
                    break;
                case DYNAMIC_TABLE_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(DynamicTableNameEditPart.VISUAL_ID));
                    break;
                case DYNAMIC_TABLE_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(DynamicTableName2EditPart.VISUAL_ID));
                    break;
                case IFRAME_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(IFrameWidgetNameEditPart.VISUAL_ID));
                    break;
                case IFRAME_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(IFrameWidgetName2EditPart.VISUAL_ID));
                    break;
                case HTML_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(HtmlWidgetNameEditPart.VISUAL_ID));
                    break;
                case HTML_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(HtmlWidgetName2EditPart.VISUAL_ID));
                    break;
                case SUGGESTBOX_TYPE:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(SuggestBoxNameEditPart.VISUAL_ID));
                    break;
                case SUGGESTBOX_TYPE_2:
                    decorator.set(NotationPackage.Literals.VIEW__TYPE, String.valueOf(SuggestBoxName2EditPart.VISUAL_ID));
                    break;
                default:
                    break;
            }
