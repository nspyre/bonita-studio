...
public class ParallelGatewayMigration extends ReportCustomMigration {
            ...
            if (outgoingConnections != null && incomingConnections != null) {
                ...
                if (incomingConnections.size() == 1) {
                    ...
                    if (incomingConnectionHasAtLeastOneCondition) {
                        ...
                        CustomMigrationUtil.migrateToInclusiveGateway(andGateway, model, ParallelGatewayMigration.OLD_ANDGATEWAY_VIEW_TYPE,
                                CustomMigrationUtil.ACTUAL_INCLUSIVE_GATEWAY_VISUAL_ID);
                        addReportChange(andGatewayName, andGateway.getEClass().getName(), andGateway.getUuid(),
                                Messages.changeGatewayTypeToInclusiveGatewayMigrationDescription, Messages.generalProperty, IStatus.WARNING);
                    ...
                    if (incomingConnectionHasAtLeastOneCondition) {// ENTREE MULTIPLE AVEC CONDITION
                        ...
                        addInclusiveBeforeOriginalParallelGatewayAndExclusiveGatewayForEachIncomingSequenceFlow(
                                ...
                                diagramProcess);
                        addReportChange(andGatewayName, andGateway.getEClass().getName(), andGateway.getUuid(),
                                Messages.changeParallelGatewayWithIncomingConditionsMigrationDescription, Messages.generalProperty, IStatus.WARNING);
                        ...
                        if (outgoingConnectionHasAtLeastOneCondition) {
                            if (outgoingConnections.size() == 1) {// ENTREE MULTIPLE SANS CONDITION - SORTIE SIMPLE AVEC CONDITION
                                ...
                                addExclusiveGatewayAfterParallelGateway(model,
                                        ...
                                        diagramProcess);
                                addReportChange(andGatewayName, andGateway.getEClass().getName(), andGateway.getUuid(),
                                        Messages.changeParallelGatewayWithOutgoingConditionsMigrationDescription, Messages.generalProperty, IStatus.WARNING);
    ...
    private void addInclusiveBeforeOriginalParallelGatewayAndExclusiveGatewayForEachIncomingSequenceFlow(
        ...
        do {
            ...
            int previousX = ((Instance) ((Instance) (CustomMigrationUtil.getShapeInstance((Instance) (incoming.get("source")), model))
                    .get(NotationPackage.Literals.NODE__LAYOUT_CONSTRAINT))).get("x");
            int previousY = ((Instance) ((Instance) (CustomMigrationUtil.getShapeInstance((Instance) (incoming.get("source")), model))
                    .get(NotationPackage.Literals.NODE__LAYOUT_CONSTRAINT))).get("y");
            ...
            Instance newDecorationSequenceFlow = CustomMigrationUtil.createDecorationNode(model, newOutGoing, newLocationSequenceFlow, false,
                    SequenceFlowNameEditPart.VISUAL_ID);
        ...
        Instance newDecorationIncGateway = CustomMigrationUtil.createXORDecorationNode(model, newInclusiveGateway, newLocationIncGateway,
        ...
        Instance newLocationSequenceFlow = model.newInstance(NotationPackage.Literals.LOCATION);
        newLocationSequenceFlow.set(NotationPackage.Literals.LOCATION__Y, CustomMigrationUtil.DECORATION_NODE_LOCATION_Y);
        Instance newDecorationSequenceFlow = CustomMigrationUtil.createDecorationNode(model, sf, newLocationSequenceFlow,
                CustomMigrationUtil.SHOW_DECORATION_NODE, SequenceFlowNameEditPart.VISUAL_ID);
    ...
    private void addExclusiveGatewayAfterParallelGateway(Model model,
        ...
        Instance newLocationSequenceFlow = model.newInstance(NotationPackage.Literals.LOCATION);
        newLocationSequenceFlow.set(NotationPackage.Literals.LOCATION__Y, CustomMigrationUtil.DECORATION_NODE_LOCATION_Y);
        Instance newDecorationSequenceFlow = CustomMigrationUtil.createDecorationNode(model, newSequenceFlow, newLocationSequenceFlow,
                CustomMigrationUtil.SHOW_DECORATION_NODE, SequenceFlowNameEditPart.VISUAL_ID);
    ...
    private void addInclusiveGatewayAfterParallelGateway(Model model,
        ...
        Instance newDecorationIncGateway = CustomMigrationUtil.createINCDecorationNode(model, newIncGateway, newLocationIncGateway,
                CustomMigrationUtil.SHOW_DECORATION_NODE);
        newIncGatewayShape.add(NotationPackage.Literals.VIEW__PERSISTED_CHILDREN, newDecorationIncGateway);
