    ...
    protected String buildJdbcUrl(String hostName, String port, String dbName, Map<String, Object> otherInputs) {
        ...
        if (constantPort && constantDbName && constantHostName) {
            if (isOracleSID) {
                ...
                return getUrlPrefix() + "thin:@(description=(address=(protocol=tcp)(host=" + hostName + ")(port=" + port + "))(connect_data=(service_name="
                        + dbName + ")))";
            } else {
            ...
            if (isOracleSID) {
                ...
                return "${\"" + getUrlPrefix() + "thin:@(description=(address=(protocol=tcp)(host=" + hostName + ")(port=" + port
