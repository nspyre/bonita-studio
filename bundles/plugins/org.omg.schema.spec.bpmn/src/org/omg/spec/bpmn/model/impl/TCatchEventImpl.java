...
public abstract class TCatchEventImpl extends TEventImpl implements TCatchEvent {
    ...
    public EList<TDataOutputAssociation> getDataOutputAssociation() {
        if (dataOutputAssociation == null) {
            dataOutputAssociation = new EObjectContainmentEList<TDataOutputAssociation>(TDataOutputAssociation.class, this,
                    ModelPackage.TCATCH_EVENT__DATA_OUTPUT_ASSOCIATION);
        }
    ...
    public void setParallelMultiple(boolean newParallelMultiple) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCATCH_EVENT__PARALLEL_MULTIPLE, oldParallelMultiple, parallelMultiple,
    ...
    public void unsetParallelMultiple() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TCATCH_EVENT__PARALLEL_MULTIPLE, oldParallelMultiple,
                    PARALLEL_MULTIPLE_EDEFAULT, oldParallelMultipleESet));
    }
