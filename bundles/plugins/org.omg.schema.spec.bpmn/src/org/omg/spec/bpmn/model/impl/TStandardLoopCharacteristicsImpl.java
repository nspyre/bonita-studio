...
public class TStandardLoopCharacteristicsImpl extends TLoopCharacteristicsImpl implements TStandardLoopCharacteristics {
    ...
    public NotificationChain basicSetLoopCondition(TExpression newLoopCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TSTANDARD_LOOP_CHARACTERISTICS__LOOP_CONDITION,
        ...
        if (newLoopCondition != loopCondition) {
            ...
            if (loopCondition != null)
                msgs = ((InternalEObject) loopCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TSTANDARD_LOOP_CHARACTERISTICS__LOOP_CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TSTANDARD_LOOP_CHARACTERISTICS__LOOP_CONDITION, newLoopCondition,
                    newLoopCondition));
    }
    ...
    public void setTestBefore(boolean newTestBefore) {
        ...
        testBeforeESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TSTANDARD_LOOP_CHARACTERISTICS__TEST_BEFORE, oldTestBefore, testBefore,
                    !oldTestBeforeESet));
    }
    ...
    public void unsetTestBefore() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TSTANDARD_LOOP_CHARACTERISTICS__TEST_BEFORE, oldTestBefore,
                    TEST_BEFORE_EDEFAULT, oldTestBeforeESet));
    }
