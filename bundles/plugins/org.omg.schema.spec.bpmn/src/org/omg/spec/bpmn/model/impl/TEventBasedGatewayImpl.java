...
public class TEventBasedGatewayImpl extends TGatewayImpl implements TEventBasedGateway {
    ...
    public void setEventGatewayType(TEventBasedGatewayType newEventGatewayType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TEVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE, oldEventGatewayType, eventGatewayType,
    ...
    public void unsetEventGatewayType() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TEVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE, oldEventGatewayType,
    ...
    public void setInstantiate(boolean newInstantiate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TEVENT_BASED_GATEWAY__INSTANTIATE, oldInstantiate, instantiate,
                    !oldInstantiateESet));
    }
    ...
    public void unsetInstantiate() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TEVENT_BASED_GATEWAY__INSTANTIATE, oldInstantiate, INSTANTIATE_EDEFAULT,
                    oldInstantiateESet));
    }
