...
public class TCollaborationImpl extends TRootElementImpl implements TCollaboration {
    ...
    public EList<TConversationAssociation> getConversationAssociation() {
        if (conversationAssociation == null) {
            conversationAssociation = new EObjectContainmentEList<TConversationAssociation>(TConversationAssociation.class, this,
                    ModelPackage.TCOLLABORATION__CONVERSATION_ASSOCIATION);
        }
    ...
    public EList<TParticipantAssociation> getParticipantAssociation() {
        if (participantAssociation == null) {
            participantAssociation = new EObjectContainmentEList<TParticipantAssociation>(TParticipantAssociation.class, this,
                    ModelPackage.TCOLLABORATION__PARTICIPANT_ASSOCIATION);
        }
    ...
    public EList<TMessageFlowAssociation> getMessageFlowAssociation() {
        if (messageFlowAssociation == null) {
            messageFlowAssociation = new EObjectContainmentEList<TMessageFlowAssociation>(TMessageFlowAssociation.class, this,
                    ModelPackage.TCOLLABORATION__MESSAGE_FLOW_ASSOCIATION);
        }
