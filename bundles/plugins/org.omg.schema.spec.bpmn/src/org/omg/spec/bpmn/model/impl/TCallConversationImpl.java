...
public class TCallConversationImpl extends TConversationNodeImpl implements TCallConversation {
    ...
    public EList<TParticipantAssociation> getParticipantAssociation() {
        if (participantAssociation == null) {
            participantAssociation = new EObjectContainmentEList<TParticipantAssociation>(TParticipantAssociation.class, this,
                    ModelPackage.TCALL_CONVERSATION__PARTICIPANT_ASSOCIATION);
        }
    ...
    public void setCalledCollaborationRef(QName newCalledCollaborationRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCALL_CONVERSATION__CALLED_COLLABORATION_REF, oldCalledCollaborationRef,
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.TCALL_CONVERSATION__CALLED_COLLABORATION_REF:
                return CALLED_COLLABORATION_REF_EDEFAULT == null ? calledCollaborationRef != null : !CALLED_COLLABORATION_REF_EDEFAULT
                        .equals(calledCollaborationRef);
        }
