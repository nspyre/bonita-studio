    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case ModelPackage.TACTIVITY: {
                ...
                if (result == null)
                    result = caseTFlowNode(tActivity);
                if (result == null)
                    result = caseTFlowElement(tActivity);
                if (result == null)
                    result = caseTBaseElement(tActivity);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TAD_HOC_SUB_PROCESS: {
                ...
                if (result == null)
                    result = caseTSubProcess(tAdHocSubProcess);
                if (result == null)
                    result = caseTActivity(tAdHocSubProcess);
                if (result == null)
                    result = caseTFlowNode(tAdHocSubProcess);
                if (result == null)
                    result = caseTFlowElement(tAdHocSubProcess);
                if (result == null)
                    result = caseTBaseElement(tAdHocSubProcess);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TARTIFACT: {
                ...
                if (result == null)
                    result = caseTBaseElement(tArtifact);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TASSIGNMENT: {
                ...
                if (result == null)
                    result = caseTBaseElement(tAssignment);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TASSOCIATION: {
                ...
                if (result == null)
                    result = caseTArtifact(tAssociation);
                if (result == null)
                    result = caseTBaseElement(tAssociation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TAUDITING: {
                ...
                if (result == null)
                    result = caseTBaseElement(tAuditing);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ModelPackage.TBOUNDARY_EVENT: {
                ...
                if (result == null)
                    result = caseTCatchEvent(tBoundaryEvent);
                if (result == null)
                    result = caseTEvent(tBoundaryEvent);
                if (result == null)
                    result = caseTFlowNode(tBoundaryEvent);
                if (result == null)
                    result = caseTFlowElement(tBoundaryEvent);
                if (result == null)
                    result = caseTBaseElement(tBoundaryEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TBUSINESS_RULE_TASK: {
                ...
                if (result == null)
                    result = caseTTask(tBusinessRuleTask);
                if (result == null)
                    result = caseTActivity(tBusinessRuleTask);
                if (result == null)
                    result = caseTFlowNode(tBusinessRuleTask);
                if (result == null)
                    result = caseTFlowElement(tBusinessRuleTask);
                if (result == null)
                    result = caseTBaseElement(tBusinessRuleTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCALLABLE_ELEMENT: {
                ...
                if (result == null)
                    result = caseTRootElement(tCallableElement);
                if (result == null)
                    result = caseTBaseElement(tCallableElement);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCALL_ACTIVITY: {
                ...
                if (result == null)
                    result = caseTActivity(tCallActivity);
                if (result == null)
                    result = caseTFlowNode(tCallActivity);
                if (result == null)
                    result = caseTFlowElement(tCallActivity);
                if (result == null)
                    result = caseTBaseElement(tCallActivity);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCALL_CHOREOGRAPHY: {
                ...
                if (result == null)
                    result = caseTChoreographyActivity(tCallChoreography);
                if (result == null)
                    result = caseTFlowNode(tCallChoreography);
                if (result == null)
                    result = caseTFlowElement(tCallChoreography);
                if (result == null)
                    result = caseTBaseElement(tCallChoreography);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCALL_CONVERSATION: {
                ...
                if (result == null)
                    result = caseTConversationNode(tCallConversation);
                if (result == null)
                    result = caseTBaseElement(tCallConversation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCANCEL_EVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTEventDefinition(tCancelEventDefinition);
                if (result == null)
                    result = caseTRootElement(tCancelEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tCancelEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCATCH_EVENT: {
                ...
                if (result == null)
                    result = caseTEvent(tCatchEvent);
                if (result == null)
                    result = caseTFlowNode(tCatchEvent);
                if (result == null)
                    result = caseTFlowElement(tCatchEvent);
                if (result == null)
                    result = caseTBaseElement(tCatchEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCATEGORY: {
                ...
                if (result == null)
                    result = caseTRootElement(tCategory);
                if (result == null)
                    result = caseTBaseElement(tCategory);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCATEGORY_VALUE: {
                ...
                if (result == null)
                    result = caseTBaseElement(tCategoryValue);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCHOREOGRAPHY: {
                ...
                if (result == null)
                    result = caseTCollaboration(tChoreography);
                if (result == null)
                    result = caseTRootElement(tChoreography);
                if (result == null)
                    result = caseTBaseElement(tChoreography);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCHOREOGRAPHY_ACTIVITY: {
                ...
                if (result == null)
                    result = caseTFlowNode(tChoreographyActivity);
                if (result == null)
                    result = caseTFlowElement(tChoreographyActivity);
                if (result == null)
                    result = caseTBaseElement(tChoreographyActivity);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCHOREOGRAPHY_TASK: {
                ...
                if (result == null)
                    result = caseTChoreographyActivity(tChoreographyTask);
                if (result == null)
                    result = caseTFlowNode(tChoreographyTask);
                if (result == null)
                    result = caseTFlowElement(tChoreographyTask);
                if (result == null)
                    result = caseTBaseElement(tChoreographyTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCOLLABORATION: {
                ...
                if (result == null)
                    result = caseTRootElement(tCollaboration);
                if (result == null)
                    result = caseTBaseElement(tCollaboration);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCOMPENSATE_EVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTEventDefinition(tCompensateEventDefinition);
                if (result == null)
                    result = caseTRootElement(tCompensateEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tCompensateEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCOMPLEX_BEHAVIOR_DEFINITION: {
                ...
                if (result == null)
                    result = caseTBaseElement(tComplexBehaviorDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCOMPLEX_GATEWAY: {
                ...
                if (result == null)
                    result = caseTGateway(tComplexGateway);
                if (result == null)
                    result = caseTFlowNode(tComplexGateway);
                if (result == null)
                    result = caseTFlowElement(tComplexGateway);
                if (result == null)
                    result = caseTBaseElement(tComplexGateway);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCONDITIONAL_EVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTEventDefinition(tConditionalEventDefinition);
                if (result == null)
                    result = caseTRootElement(tConditionalEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tConditionalEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCONVERSATION: {
                ...
                if (result == null)
                    result = caseTConversationNode(tConversation);
                if (result == null)
                    result = caseTBaseElement(tConversation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCONVERSATION_ASSOCIATION: {
                ...
                if (result == null)
                    result = caseTBaseElement(tConversationAssociation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCONVERSATION_LINK: {
                ...
                if (result == null)
                    result = caseTBaseElement(tConversationLink);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCONVERSATION_NODE: {
                ...
                if (result == null)
                    result = caseTBaseElement(tConversationNode);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCORRELATION_KEY: {
                ...
                if (result == null)
                    result = caseTBaseElement(tCorrelationKey);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCORRELATION_PROPERTY: {
                ...
                if (result == null)
                    result = caseTRootElement(tCorrelationProperty);
                if (result == null)
                    result = caseTBaseElement(tCorrelationProperty);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCORRELATION_PROPERTY_BINDING: {
                ...
                if (result == null)
                    result = caseTBaseElement(tCorrelationPropertyBinding);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCORRELATION_PROPERTY_RETRIEVAL_EXPRESSION: {
                ...
                if (result == null)
                    result = caseTBaseElement(tCorrelationPropertyRetrievalExpression);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TCORRELATION_SUBSCRIPTION: {
                ...
                if (result == null)
                    result = caseTBaseElement(tCorrelationSubscription);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TDATA_ASSOCIATION: {
                ...
                if (result == null)
                    result = caseTBaseElement(tDataAssociation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TDATA_INPUT: {
                ...
                if (result == null)
                    result = caseTBaseElement(tDataInput);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TDATA_INPUT_ASSOCIATION: {
                ...
                if (result == null)
                    result = caseTDataAssociation(tDataInputAssociation);
                if (result == null)
                    result = caseTBaseElement(tDataInputAssociation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TDATA_OBJECT: {
                ...
                if (result == null)
                    result = caseTFlowElement(tDataObject);
                if (result == null)
                    result = caseTBaseElement(tDataObject);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TDATA_OBJECT_REFERENCE: {
                ...
                if (result == null)
                    result = caseTFlowElement(tDataObjectReference);
                if (result == null)
                    result = caseTBaseElement(tDataObjectReference);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TDATA_OUTPUT: {
                ...
                if (result == null)
                    result = caseTBaseElement(tDataOutput);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TDATA_OUTPUT_ASSOCIATION: {
                ...
                if (result == null)
                    result = caseTDataAssociation(tDataOutputAssociation);
                if (result == null)
                    result = caseTBaseElement(tDataOutputAssociation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TDATA_STATE: {
                ...
                if (result == null)
                    result = caseTBaseElement(tDataState);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TDATA_STORE: {
                ...
                if (result == null)
                    result = caseTRootElement(tDataStore);
                if (result == null)
                    result = caseTBaseElement(tDataStore);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TDATA_STORE_REFERENCE: {
                ...
                if (result == null)
                    result = caseTFlowElement(tDataStoreReference);
                if (result == null)
                    result = caseTBaseElement(tDataStoreReference);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ModelPackage.TEND_EVENT: {
                ...
                if (result == null)
                    result = caseTThrowEvent(tEndEvent);
                if (result == null)
                    result = caseTEvent(tEndEvent);
                if (result == null)
                    result = caseTFlowNode(tEndEvent);
                if (result == null)
                    result = caseTFlowElement(tEndEvent);
                if (result == null)
                    result = caseTBaseElement(tEndEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TEND_POINT: {
                ...
                if (result == null)
                    result = caseTRootElement(tEndPoint);
                if (result == null)
                    result = caseTBaseElement(tEndPoint);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TERROR: {
                ...
                if (result == null)
                    result = caseTRootElement(tError);
                if (result == null)
                    result = caseTBaseElement(tError);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TERROR_EVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTEventDefinition(tErrorEventDefinition);
                if (result == null)
                    result = caseTRootElement(tErrorEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tErrorEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TESCALATION: {
                ...
                if (result == null)
                    result = caseTRootElement(tEscalation);
                if (result == null)
                    result = caseTBaseElement(tEscalation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TESCALATION_EVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTEventDefinition(tEscalationEventDefinition);
                if (result == null)
                    result = caseTRootElement(tEscalationEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tEscalationEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TEVENT: {
                ...
                if (result == null)
                    result = caseTFlowNode(tEvent);
                if (result == null)
                    result = caseTFlowElement(tEvent);
                if (result == null)
                    result = caseTBaseElement(tEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TEVENT_BASED_GATEWAY: {
                ...
                if (result == null)
                    result = caseTGateway(tEventBasedGateway);
                if (result == null)
                    result = caseTFlowNode(tEventBasedGateway);
                if (result == null)
                    result = caseTFlowElement(tEventBasedGateway);
                if (result == null)
                    result = caseTBaseElement(tEventBasedGateway);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TEVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTRootElement(tEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TEXCLUSIVE_GATEWAY: {
                ...
                if (result == null)
                    result = caseTGateway(tExclusiveGateway);
                if (result == null)
                    result = caseTFlowNode(tExclusiveGateway);
                if (result == null)
                    result = caseTFlowElement(tExclusiveGateway);
                if (result == null)
                    result = caseTBaseElement(tExclusiveGateway);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TEXPRESSION: {
                ...
                if (result == null)
                    result = caseTBaseElementWithMixedContent(tExpression);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ModelPackage.TFLOW_ELEMENT: {
                ...
                if (result == null)
                    result = caseTBaseElement(tFlowElement);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TFLOW_NODE: {
                ...
                if (result == null)
                    result = caseTFlowElement(tFlowNode);
                if (result == null)
                    result = caseTBaseElement(tFlowNode);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TFORMAL_EXPRESSION: {
                ...
                if (result == null)
                    result = caseTExpression(tFormalExpression);
                if (result == null)
                    result = caseTBaseElementWithMixedContent(tFormalExpression);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TGATEWAY: {
                ...
                if (result == null)
                    result = caseTFlowNode(tGateway);
                if (result == null)
                    result = caseTFlowElement(tGateway);
                if (result == null)
                    result = caseTBaseElement(tGateway);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TGLOBAL_BUSINESS_RULE_TASK: {
                ...
                if (result == null)
                    result = caseTGlobalTask(tGlobalBusinessRuleTask);
                if (result == null)
                    result = caseTCallableElement(tGlobalBusinessRuleTask);
                if (result == null)
                    result = caseTRootElement(tGlobalBusinessRuleTask);
                if (result == null)
                    result = caseTBaseElement(tGlobalBusinessRuleTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TGLOBAL_CHOREOGRAPHY_TASK: {
                ...
                if (result == null)
                    result = caseTChoreography(tGlobalChoreographyTask);
                if (result == null)
                    result = caseTCollaboration(tGlobalChoreographyTask);
                if (result == null)
                    result = caseTRootElement(tGlobalChoreographyTask);
                if (result == null)
                    result = caseTBaseElement(tGlobalChoreographyTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TGLOBAL_CONVERSATION: {
                ...
                if (result == null)
                    result = caseTCollaboration(tGlobalConversation);
                if (result == null)
                    result = caseTRootElement(tGlobalConversation);
                if (result == null)
                    result = caseTBaseElement(tGlobalConversation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TGLOBAL_MANUAL_TASK: {
                ...
                if (result == null)
                    result = caseTGlobalTask(tGlobalManualTask);
                if (result == null)
                    result = caseTCallableElement(tGlobalManualTask);
                if (result == null)
                    result = caseTRootElement(tGlobalManualTask);
                if (result == null)
                    result = caseTBaseElement(tGlobalManualTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TGLOBAL_SCRIPT_TASK: {
                ...
                if (result == null)
                    result = caseTGlobalTask(tGlobalScriptTask);
                if (result == null)
                    result = caseTCallableElement(tGlobalScriptTask);
                if (result == null)
                    result = caseTRootElement(tGlobalScriptTask);
                if (result == null)
                    result = caseTBaseElement(tGlobalScriptTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TGLOBAL_TASK: {
                ...
                if (result == null)
                    result = caseTCallableElement(tGlobalTask);
                if (result == null)
                    result = caseTRootElement(tGlobalTask);
                if (result == null)
                    result = caseTBaseElement(tGlobalTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TGLOBAL_USER_TASK: {
                ...
                if (result == null)
                    result = caseTGlobalTask(tGlobalUserTask);
                if (result == null)
                    result = caseTCallableElement(tGlobalUserTask);
                if (result == null)
                    result = caseTRootElement(tGlobalUserTask);
                if (result == null)
                    result = caseTBaseElement(tGlobalUserTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TGROUP: {
                ...
                if (result == null)
                    result = caseTArtifact(tGroup);
                if (result == null)
                    result = caseTBaseElement(tGroup);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.THUMAN_PERFORMER: {
                ...
                if (result == null)
                    result = caseTPerformer(tHumanPerformer);
                if (result == null)
                    result = caseTResourceRole(tHumanPerformer);
                if (result == null)
                    result = caseTBaseElement(tHumanPerformer);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TIMPLICIT_THROW_EVENT: {
                ...
                if (result == null)
                    result = caseTThrowEvent(tImplicitThrowEvent);
                if (result == null)
                    result = caseTEvent(tImplicitThrowEvent);
                if (result == null)
                    result = caseTFlowNode(tImplicitThrowEvent);
                if (result == null)
                    result = caseTFlowElement(tImplicitThrowEvent);
                if (result == null)
                    result = caseTBaseElement(tImplicitThrowEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ModelPackage.TINCLUSIVE_GATEWAY: {
                ...
                if (result == null)
                    result = caseTGateway(tInclusiveGateway);
                if (result == null)
                    result = caseTFlowNode(tInclusiveGateway);
                if (result == null)
                    result = caseTFlowElement(tInclusiveGateway);
                if (result == null)
                    result = caseTBaseElement(tInclusiveGateway);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TINPUT_OUTPUT_BINDING: {
                ...
                if (result == null)
                    result = caseTBaseElement(tInputOutputBinding);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TINPUT_OUTPUT_SPECIFICATION: {
                ...
                if (result == null)
                    result = caseTBaseElement(tInputOutputSpecification);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TINPUT_SET: {
                ...
                if (result == null)
                    result = caseTBaseElement(tInputSet);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TINTERFACE: {
                ...
                if (result == null)
                    result = caseTRootElement(tInterface);
                if (result == null)
                    result = caseTBaseElement(tInterface);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TINTERMEDIATE_CATCH_EVENT: {
                ...
                if (result == null)
                    result = caseTCatchEvent(tIntermediateCatchEvent);
                if (result == null)
                    result = caseTEvent(tIntermediateCatchEvent);
                if (result == null)
                    result = caseTFlowNode(tIntermediateCatchEvent);
                if (result == null)
                    result = caseTFlowElement(tIntermediateCatchEvent);
                if (result == null)
                    result = caseTBaseElement(tIntermediateCatchEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TINTERMEDIATE_THROW_EVENT: {
                ...
                if (result == null)
                    result = caseTThrowEvent(tIntermediateThrowEvent);
                if (result == null)
                    result = caseTEvent(tIntermediateThrowEvent);
                if (result == null)
                    result = caseTFlowNode(tIntermediateThrowEvent);
                if (result == null)
                    result = caseTFlowElement(tIntermediateThrowEvent);
                if (result == null)
                    result = caseTBaseElement(tIntermediateThrowEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TITEM_DEFINITION: {
                ...
                if (result == null)
                    result = caseTRootElement(tItemDefinition);
                if (result == null)
                    result = caseTBaseElement(tItemDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ModelPackage.TLANE_SET: {
                ...
                if (result == null)
                    result = caseTBaseElement(tLaneSet);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TLINK_EVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTEventDefinition(tLinkEventDefinition);
                if (result == null)
                    result = caseTRootElement(tLinkEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tLinkEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TLOOP_CHARACTERISTICS: {
                ...
                if (result == null)
                    result = caseTBaseElement(tLoopCharacteristics);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TMANUAL_TASK: {
                ...
                if (result == null)
                    result = caseTTask(tManualTask);
                if (result == null)
                    result = caseTActivity(tManualTask);
                if (result == null)
                    result = caseTFlowNode(tManualTask);
                if (result == null)
                    result = caseTFlowElement(tManualTask);
                if (result == null)
                    result = caseTBaseElement(tManualTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TMESSAGE: {
                ...
                if (result == null)
                    result = caseTRootElement(tMessage);
                if (result == null)
                    result = caseTBaseElement(tMessage);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TMESSAGE_EVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTEventDefinition(tMessageEventDefinition);
                if (result == null)
                    result = caseTRootElement(tMessageEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tMessageEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TMESSAGE_FLOW: {
                ...
                if (result == null)
                    result = caseTBaseElement(tMessageFlow);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TMESSAGE_FLOW_ASSOCIATION: {
                ...
                if (result == null)
                    result = caseTBaseElement(tMessageFlowAssociation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TMONITORING: {
                ...
                if (result == null)
                    result = caseTBaseElement(tMonitoring);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS: {
                ...
                if (result == null)
                    result = caseTLoopCharacteristics(tMultiInstanceLoopCharacteristics);
                if (result == null)
                    result = caseTBaseElement(tMultiInstanceLoopCharacteristics);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TOPERATION: {
                ...
                if (result == null)
                    result = caseTBaseElement(tOperation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TOUTPUT_SET: {
                ...
                if (result == null)
                    result = caseTBaseElement(tOutputSet);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TPARALLEL_GATEWAY: {
                ...
                if (result == null)
                    result = caseTGateway(tParallelGateway);
                if (result == null)
                    result = caseTFlowNode(tParallelGateway);
                if (result == null)
                    result = caseTFlowElement(tParallelGateway);
                if (result == null)
                    result = caseTBaseElement(tParallelGateway);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TPARTICIPANT: {
                ...
                if (result == null)
                    result = caseTBaseElement(tParticipant);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TPARTICIPANT_ASSOCIATION: {
                ...
                if (result == null)
                    result = caseTBaseElement(tParticipantAssociation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TPARTICIPANT_MULTIPLICITY: {
                ...
                if (result == null)
                    result = caseTBaseElement(tParticipantMultiplicity);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TPARTNER_ENTITY: {
                ...
                if (result == null)
                    result = caseTRootElement(tPartnerEntity);
                if (result == null)
                    result = caseTBaseElement(tPartnerEntity);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TPARTNER_ROLE: {
                ...
                if (result == null)
                    result = caseTRootElement(tPartnerRole);
                if (result == null)
                    result = caseTBaseElement(tPartnerRole);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TPERFORMER: {
                ...
                if (result == null)
                    result = caseTResourceRole(tPerformer);
                if (result == null)
                    result = caseTBaseElement(tPerformer);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TPOTENTIAL_OWNER: {
                ...
                if (result == null)
                    result = caseTHumanPerformer(tPotentialOwner);
                if (result == null)
                    result = caseTPerformer(tPotentialOwner);
                if (result == null)
                    result = caseTResourceRole(tPotentialOwner);
                if (result == null)
                    result = caseTBaseElement(tPotentialOwner);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TPROCESS: {
                ...
                if (result == null)
                    result = caseTCallableElement(tProcess);
                if (result == null)
                    result = caseTRootElement(tProcess);
                if (result == null)
                    result = caseTBaseElement(tProcess);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TPROPERTY: {
                ...
                if (result == null)
                    result = caseTBaseElement(tProperty);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TRECEIVE_TASK: {
                ...
                if (result == null)
                    result = caseTTask(tReceiveTask);
                if (result == null)
                    result = caseTActivity(tReceiveTask);
                if (result == null)
                    result = caseTFlowNode(tReceiveTask);
                if (result == null)
                    result = caseTFlowElement(tReceiveTask);
                if (result == null)
                    result = caseTBaseElement(tReceiveTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TRELATIONSHIP: {
                ...
                if (result == null)
                    result = caseTBaseElement(tRelationship);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TRENDERING: {
                ...
                if (result == null)
                    result = caseTBaseElement(tRendering);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TRESOURCE: {
                ...
                if (result == null)
                    result = caseTRootElement(tResource);
                if (result == null)
                    result = caseTBaseElement(tResource);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TRESOURCE_ASSIGNMENT_EXPRESSION: {
                ...
                if (result == null)
                    result = caseTBaseElement(tResourceAssignmentExpression);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TRESOURCE_PARAMETER: {
                ...
                if (result == null)
                    result = caseTBaseElement(tResourceParameter);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TRESOURCE_PARAMETER_BINDING: {
                ...
                if (result == null)
                    result = caseTBaseElement(tResourceParameterBinding);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TRESOURCE_ROLE: {
                ...
                if (result == null)
                    result = caseTBaseElement(tResourceRole);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TROOT_ELEMENT: {
                ...
                if (result == null)
                    result = caseTBaseElement(tRootElement);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ModelPackage.TSCRIPT_TASK: {
                ...
                if (result == null)
                    result = caseTTask(tScriptTask);
                if (result == null)
                    result = caseTActivity(tScriptTask);
                if (result == null)
                    result = caseTFlowNode(tScriptTask);
                if (result == null)
                    result = caseTFlowElement(tScriptTask);
                if (result == null)
                    result = caseTBaseElement(tScriptTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TSEND_TASK: {
                ...
                if (result == null)
                    result = caseTTask(tSendTask);
                if (result == null)
                    result = caseTActivity(tSendTask);
                if (result == null)
                    result = caseTFlowNode(tSendTask);
                if (result == null)
                    result = caseTFlowElement(tSendTask);
                if (result == null)
                    result = caseTBaseElement(tSendTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TSEQUENCE_FLOW: {
                ...
                if (result == null)
                    result = caseTFlowElement(tSequenceFlow);
                if (result == null)
                    result = caseTBaseElement(tSequenceFlow);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TSERVICE_TASK: {
                ...
                if (result == null)
                    result = caseTTask(tServiceTask);
                if (result == null)
                    result = caseTActivity(tServiceTask);
                if (result == null)
                    result = caseTFlowNode(tServiceTask);
                if (result == null)
                    result = caseTFlowElement(tServiceTask);
                if (result == null)
                    result = caseTBaseElement(tServiceTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TSIGNAL: {
                ...
                if (result == null)
                    result = caseTRootElement(tSignal);
                if (result == null)
                    result = caseTBaseElement(tSignal);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TSIGNAL_EVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTEventDefinition(tSignalEventDefinition);
                if (result == null)
                    result = caseTRootElement(tSignalEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tSignalEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TSTANDARD_LOOP_CHARACTERISTICS: {
                ...
                if (result == null)
                    result = caseTLoopCharacteristics(tStandardLoopCharacteristics);
                if (result == null)
                    result = caseTBaseElement(tStandardLoopCharacteristics);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TSTART_EVENT: {
                ...
                if (result == null)
                    result = caseTCatchEvent(tStartEvent);
                if (result == null)
                    result = caseTEvent(tStartEvent);
                if (result == null)
                    result = caseTFlowNode(tStartEvent);
                if (result == null)
                    result = caseTFlowElement(tStartEvent);
                if (result == null)
                    result = caseTBaseElement(tStartEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TSUB_CHOREOGRAPHY: {
                ...
                if (result == null)
                    result = caseTChoreographyActivity(tSubChoreography);
                if (result == null)
                    result = caseTFlowNode(tSubChoreography);
                if (result == null)
                    result = caseTFlowElement(tSubChoreography);
                if (result == null)
                    result = caseTBaseElement(tSubChoreography);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TSUB_CONVERSATION: {
                ...
                if (result == null)
                    result = caseTConversationNode(tSubConversation);
                if (result == null)
                    result = caseTBaseElement(tSubConversation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TSUB_PROCESS: {
                ...
                if (result == null)
                    result = caseTActivity(tSubProcess);
                if (result == null)
                    result = caseTFlowNode(tSubProcess);
                if (result == null)
                    result = caseTFlowElement(tSubProcess);
                if (result == null)
                    result = caseTBaseElement(tSubProcess);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TTASK: {
                ...
                if (result == null)
                    result = caseTActivity(tTask);
                if (result == null)
                    result = caseTFlowNode(tTask);
                if (result == null)
                    result = caseTFlowElement(tTask);
                if (result == null)
                    result = caseTBaseElement(tTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TTERMINATE_EVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTEventDefinition(tTerminateEventDefinition);
                if (result == null)
                    result = caseTRootElement(tTerminateEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tTerminateEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            ...
            case ModelPackage.TTEXT_ANNOTATION: {
                ...
                if (result == null)
                    result = caseTArtifact(tTextAnnotation);
                if (result == null)
                    result = caseTBaseElement(tTextAnnotation);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TTHROW_EVENT: {
                ...
                if (result == null)
                    result = caseTEvent(tThrowEvent);
                if (result == null)
                    result = caseTFlowNode(tThrowEvent);
                if (result == null)
                    result = caseTFlowElement(tThrowEvent);
                if (result == null)
                    result = caseTBaseElement(tThrowEvent);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TTIMER_EVENT_DEFINITION: {
                ...
                if (result == null)
                    result = caseTEventDefinition(tTimerEventDefinition);
                if (result == null)
                    result = caseTRootElement(tTimerEventDefinition);
                if (result == null)
                    result = caseTBaseElement(tTimerEventDefinition);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TTRANSACTION: {
                ...
                if (result == null)
                    result = caseTSubProcess(tTransaction);
                if (result == null)
                    result = caseTActivity(tTransaction);
                if (result == null)
                    result = caseTFlowNode(tTransaction);
                if (result == null)
                    result = caseTFlowElement(tTransaction);
                if (result == null)
                    result = caseTBaseElement(tTransaction);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case ModelPackage.TUSER_TASK: {
                ...
                if (result == null)
                    result = caseTTask(tUserTask);
                if (result == null)
                    result = caseTActivity(tUserTask);
                if (result == null)
                    result = caseTFlowNode(tUserTask);
                if (result == null)
                    result = caseTFlowElement(tUserTask);
                if (result == null)
                    result = caseTBaseElement(tUserTask);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
