...
public class TReceiveTaskImpl extends TTaskImpl implements TReceiveTask {
    ...
    protected static final Object IMPLEMENTATION_EDEFAULT = ModelFactory.eINSTANCE
            .createFromString(ModelPackage.eINSTANCE.getTImplementation(), "##WebService");
    ...
    public void setImplementation(Object newImplementation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TRECEIVE_TASK__IMPLEMENTATION, oldImplementation, implementation,
    ...
    public void unsetImplementation() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TRECEIVE_TASK__IMPLEMENTATION, oldImplementation, IMPLEMENTATION_EDEFAULT,
                    oldImplementationESet));
    }
    ...
    public void unsetInstantiate() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TRECEIVE_TASK__INSTANTIATE, oldInstantiate, INSTANTIATE_EDEFAULT,
                    oldInstantiateESet));
    }
