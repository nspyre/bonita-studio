...
public class TDataAssociationImpl extends TBaseElementImpl implements TDataAssociation {
    ...
    public NotificationChain basicSetTransformation(TFormalExpression newTransformation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_ASSOCIATION__TRANSFORMATION, oldTransformation,
                    newTransformation);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setTransformation(TFormalExpression newTransformation) {
        if (newTransformation != transformation) {
            ...
            if (transformation != null)
                msgs = ((InternalEObject) transformation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TDATA_ASSOCIATION__TRANSFORMATION, null,
                        msgs);
            if (newTransformation != null)
                msgs = ((InternalEObject) newTransformation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TDATA_ASSOCIATION__TRANSFORMATION, null,
                        msgs);
