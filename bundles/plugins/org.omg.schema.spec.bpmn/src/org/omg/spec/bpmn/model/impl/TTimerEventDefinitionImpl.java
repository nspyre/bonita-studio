...
public class TTimerEventDefinitionImpl extends TEventDefinitionImpl implements TTimerEventDefinition {
    ...
    public NotificationChain basicSetTimeDate(TExpression newTimeDate, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TTIMER_EVENT_DEFINITION__TIME_DATE, oldTimeDate,
                    newTimeDate);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetTimeDuration(TExpression newTimeDuration, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TTIMER_EVENT_DEFINITION__TIME_DURATION,
    ...
    public void setTimeDuration(TExpression newTimeDuration) {
        if (newTimeDuration != timeDuration) {
            ...
            if (timeDuration != null)
                msgs = ((InternalEObject) timeDuration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TTIMER_EVENT_DEFINITION__TIME_DURATION,
                        null, msgs);
            if (newTimeDuration != null)
                msgs = ((InternalEObject) newTimeDuration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TTIMER_EVENT_DEFINITION__TIME_DURATION,
                        null, msgs);
    ...
    public NotificationChain basicSetTimeCycle(TExpression newTimeCycle, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TTIMER_EVENT_DEFINITION__TIME_CYCLE, oldTimeCycle,
                    newTimeCycle);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newTimeCycle != timeCycle) {
            ...
            if (timeCycle != null)
                msgs = ((InternalEObject) timeCycle)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TTIMER_EVENT_DEFINITION__TIME_CYCLE, null, msgs);
            if (newTimeCycle != null)
                msgs = ((InternalEObject) newTimeCycle)
                        .eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TTIMER_EVENT_DEFINITION__TIME_CYCLE, null, msgs);
