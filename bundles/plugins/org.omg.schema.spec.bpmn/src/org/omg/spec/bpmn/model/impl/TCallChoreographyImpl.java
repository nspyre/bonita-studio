...
public class TCallChoreographyImpl extends TChoreographyActivityImpl implements TCallChoreography {
    ...
    public EList<TParticipantAssociation> getParticipantAssociation() {
        if (participantAssociation == null) {
            participantAssociation = new EObjectContainmentEList<TParticipantAssociation>(TParticipantAssociation.class, this,
                    ModelPackage.TCALL_CHOREOGRAPHY__PARTICIPANT_ASSOCIATION);
        }
    ...
    public void setCalledChoreographyRef(QName newCalledChoreographyRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCALL_CHOREOGRAPHY__CALLED_CHOREOGRAPHY_REF, oldCalledChoreographyRef,
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.TCALL_CHOREOGRAPHY__CALLED_CHOREOGRAPHY_REF:
                return CALLED_CHOREOGRAPHY_REF_EDEFAULT == null ? calledChoreographyRef != null : !CALLED_CHOREOGRAPHY_REF_EDEFAULT
                        .equals(calledChoreographyRef);
        }
