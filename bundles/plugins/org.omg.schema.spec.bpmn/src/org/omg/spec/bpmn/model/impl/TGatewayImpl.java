...
public class TGatewayImpl extends TFlowNodeImpl implements TGateway {
    ...
    public void setGatewayDirection(TGatewayDirection newGatewayDirection) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TGATEWAY__GATEWAY_DIRECTION, oldGatewayDirection, gatewayDirection,
    ...
    public void unsetGatewayDirection() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TGATEWAY__GATEWAY_DIRECTION, oldGatewayDirection, GATEWAY_DIRECTION_EDEFAULT,
                    oldGatewayDirectionESet));
    }
