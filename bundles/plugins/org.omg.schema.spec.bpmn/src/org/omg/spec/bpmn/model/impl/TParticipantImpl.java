...
public class TParticipantImpl extends TBaseElementImpl implements TParticipant {
    ...
    public NotificationChain basicSetParticipantMultiplicity(TParticipantMultiplicity newParticipantMultiplicity, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TPARTICIPANT__PARTICIPANT_MULTIPLICITY,
    ...
    public void setParticipantMultiplicity(TParticipantMultiplicity newParticipantMultiplicity) {
        if (newParticipantMultiplicity != participantMultiplicity) {
            ...
            if (participantMultiplicity != null)
                msgs = ((InternalEObject) participantMultiplicity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TPARTICIPANT__PARTICIPANT_MULTIPLICITY, null, msgs);
            if (newParticipantMultiplicity != null)
                msgs = ((InternalEObject) newParticipantMultiplicity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TPARTICIPANT__PARTICIPANT_MULTIPLICITY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TPARTICIPANT__PARTICIPANT_MULTIPLICITY, newParticipantMultiplicity,
