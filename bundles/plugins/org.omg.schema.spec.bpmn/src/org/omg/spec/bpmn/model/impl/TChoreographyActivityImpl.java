...
public abstract class TChoreographyActivityImpl extends TFlowNodeImpl implements TChoreographyActivity {
    ...
    public void setInitiatingParticipantRef(QName newInitiatingParticipantRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCHOREOGRAPHY_ACTIVITY__INITIATING_PARTICIPANT_REF, oldInitiatingParticipantRef,
    ...
    public void unsetLoopType() {
        ...
        loopTypeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TCHOREOGRAPHY_ACTIVITY__LOOP_TYPE, oldLoopType, LOOP_TYPE_EDEFAULT,
                    oldLoopTypeESet));
    }
