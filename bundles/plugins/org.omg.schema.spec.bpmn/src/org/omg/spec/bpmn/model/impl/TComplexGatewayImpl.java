...
public class TComplexGatewayImpl extends TGatewayImpl implements TComplexGateway {
    ...
    public NotificationChain basicSetActivationCondition(TExpression newActivationCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TCOMPLEX_GATEWAY__ACTIVATION_CONDITION,
        ...
        if (newActivationCondition != activationCondition) {
            ...
            if (activationCondition != null)
                msgs = ((InternalEObject) activationCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TCOMPLEX_GATEWAY__ACTIVATION_CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCOMPLEX_GATEWAY__ACTIVATION_CONDITION, newActivationCondition,
