 ...
 * <ul>
 * <li>{@link org.omg.spec.bpmn.model.impl.TCorrelationPropertyImpl#getCorrelationPropertyRetrievalExpression <em>Correlation Property Retrieval
 * Expression</em>}</li>
...
public class TCorrelationPropertyImpl extends TRootElementImpl implements TCorrelationProperty {
    ...
    public EList<TCorrelationPropertyRetrievalExpression> getCorrelationPropertyRetrievalExpression() {
        if (correlationPropertyRetrievalExpression == null) {
            correlationPropertyRetrievalExpression = new EObjectContainmentEList<TCorrelationPropertyRetrievalExpression>(
                    TCorrelationPropertyRetrievalExpression.class, this, ModelPackage.TCORRELATION_PROPERTY__CORRELATION_PROPERTY_RETRIEVAL_EXPRESSION);
        }
