...
public class TSubProcessImpl extends TActivityImpl implements TSubProcess {
    ...
    public void setTriggeredByEvent(boolean newTriggeredByEvent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TSUB_PROCESS__TRIGGERED_BY_EVENT, oldTriggeredByEvent, triggeredByEvent,
    ...
    public void unsetTriggeredByEvent() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TSUB_PROCESS__TRIGGERED_BY_EVENT, oldTriggeredByEvent,
