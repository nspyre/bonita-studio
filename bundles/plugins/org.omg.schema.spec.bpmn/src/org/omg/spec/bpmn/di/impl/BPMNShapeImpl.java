...
public class BPMNShapeImpl extends LabeledShapeImpl implements BPMNShape {
    ...
    public void setChoreographyActivityShape(QName newChoreographyActivityShape) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DiPackage.BPMN_SHAPE__CHOREOGRAPHY_ACTIVITY_SHAPE, oldChoreographyActivityShape,
    ...
    public void unsetIsHorizontal() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, DiPackage.BPMN_SHAPE__IS_HORIZONTAL, oldIsHorizontal, IS_HORIZONTAL_EDEFAULT,
                    oldIsHorizontalESet));
    }
    ...
    public void unsetIsMarkerVisible() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, DiPackage.BPMN_SHAPE__IS_MARKER_VISIBLE, oldIsMarkerVisible, IS_MARKER_VISIBLE_EDEFAULT,
                    oldIsMarkerVisibleESet));
    }
    ...
    public void unsetIsMessageVisible() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, DiPackage.BPMN_SHAPE__IS_MESSAGE_VISIBLE, oldIsMessageVisible, IS_MESSAGE_VISIBLE_EDEFAULT,
                    oldIsMessageVisibleESet));
    }
    ...
    public void unsetParticipantBandKind() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, DiPackage.BPMN_SHAPE__PARTICIPANT_BAND_KIND, oldParticipantBandKind,
                    PARTICIPANT_BAND_KIND_EDEFAULT, oldParticipantBandKindESet));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case DiPackage.BPMN_SHAPE__CHOREOGRAPHY_ACTIVITY_SHAPE:
                return CHOREOGRAPHY_ACTIVITY_SHAPE_EDEFAULT == null ? choreographyActivityShape != null : !CHOREOGRAPHY_ACTIVITY_SHAPE_EDEFAULT
                        .equals(choreographyActivityShape);
            case DiPackage.BPMN_SHAPE__IS_EXPANDED:
    ...
    public String toString() {
        ...
        if (isMarkerVisibleESet)
            result.append(isMarkerVisible);
        else
            result.append("<unset>");
        result.append(", isMessageVisible: ");
        if (isMessageVisibleESet)
            result.append(isMessageVisible);
        else
            result.append("<unset>");
        result.append(", participantBandKind: ");
        if (participantBandKindESet)
            result.append(participantBandKind);
        else
            result.append("<unset>");
        result.append(')');
