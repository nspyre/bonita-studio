...
public class TGlobalBusinessRuleTaskImpl extends TGlobalTaskImpl implements TGlobalBusinessRuleTask {
    ...
    public void setImplementation(Object newImplementation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TGLOBAL_BUSINESS_RULE_TASK__IMPLEMENTATION, oldImplementation, implementation,
    ...
    public void unsetImplementation() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TGLOBAL_BUSINESS_RULE_TASK__IMPLEMENTATION, oldImplementation,
