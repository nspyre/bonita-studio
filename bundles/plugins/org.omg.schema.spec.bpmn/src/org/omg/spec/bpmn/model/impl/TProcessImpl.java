...
public class TProcessImpl extends TCallableElementImpl implements TProcess {
    ...
    public EList<TCorrelationSubscription> getCorrelationSubscription() {
        if (correlationSubscription == null) {
            correlationSubscription = new EObjectContainmentEList<TCorrelationSubscription>(TCorrelationSubscription.class, this,
                    ModelPackage.TPROCESS__CORRELATION_SUBSCRIPTION);
        }
    ...
    public void setDefinitionalCollaborationRef(QName newDefinitionalCollaborationRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TPROCESS__DEFINITIONAL_COLLABORATION_REF, oldDefinitionalCollaborationRef,
    ...
    public void unsetIsExecutable() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TPROCESS__IS_EXECUTABLE, oldIsExecutable, IS_EXECUTABLE_EDEFAULT,
                    oldIsExecutableESet));
    }
    ...
    public void unsetProcessType() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TPROCESS__PROCESS_TYPE, oldProcessType, PROCESS_TYPE_EDEFAULT,
                    oldProcessTypeESet));
    }
