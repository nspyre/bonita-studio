...
public class TCorrelationPropertyBindingImpl extends TBaseElementImpl implements TCorrelationPropertyBinding {
    ...
    public NotificationChain basicSetDataPath(TFormalExpression newDataPath, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TCORRELATION_PROPERTY_BINDING__DATA_PATH, oldDataPath,
                    newDataPath);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDataPath(TFormalExpression newDataPath) {
        if (newDataPath != dataPath) {
            ...
            if (dataPath != null)
                msgs = ((InternalEObject) dataPath).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TCORRELATION_PROPERTY_BINDING__DATA_PATH, null,
                        msgs);
            if (newDataPath != null)
                msgs = ((InternalEObject) newDataPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TCORRELATION_PROPERTY_BINDING__DATA_PATH, null,
                        msgs);
    ...
    public void setCorrelationPropertyRef(QName newCorrelationPropertyRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCORRELATION_PROPERTY_BINDING__CORRELATION_PROPERTY_REF,
