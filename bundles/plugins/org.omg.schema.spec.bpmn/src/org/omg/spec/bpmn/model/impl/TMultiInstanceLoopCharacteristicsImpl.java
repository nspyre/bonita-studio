...
public class TMultiInstanceLoopCharacteristicsImpl extends TLoopCharacteristicsImpl implements TMultiInstanceLoopCharacteristics {
    ...
    public NotificationChain basicSetLoopCardinality(TExpression newLoopCardinality, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__LOOP_CARDINALITY,
        ...
        if (newLoopCardinality != loopCardinality) {
            ...
            if (loopCardinality != null)
                msgs = ((InternalEObject) loopCardinality).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__LOOP_CARDINALITY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__LOOP_CARDINALITY, newLoopCardinality,
                    newLoopCardinality));
    }
    ...
    public void setLoopDataInputRef(QName newLoopDataInputRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__LOOP_DATA_INPUT_REF, oldLoopDataInputRef,
                    loopDataInputRef));
    }
    ...
    public void setLoopDataOutputRef(QName newLoopDataOutputRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__LOOP_DATA_OUTPUT_REF,
    ...
    public NotificationChain basicSetInputDataItem(TDataInput newInputDataItem, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__INPUT_DATA_ITEM,
        ...
        if (newInputDataItem != inputDataItem) {
            ...
            if (inputDataItem != null)
                msgs = ((InternalEObject) inputDataItem).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__INPUT_DATA_ITEM, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__INPUT_DATA_ITEM, newInputDataItem,
                    newInputDataItem));
    }
    ...
    public NotificationChain basicSetOutputDataItem(TDataOutput newOutputDataItem, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__OUTPUT_DATA_ITEM,
        ...
        if (newOutputDataItem != outputDataItem) {
            ...
            if (outputDataItem != null)
                msgs = ((InternalEObject) outputDataItem).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__OUTPUT_DATA_ITEM, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__OUTPUT_DATA_ITEM, newOutputDataItem,
                    newOutputDataItem));
    }
    ...
    public EList<TComplexBehaviorDefinition> getComplexBehaviorDefinition() {
        if (complexBehaviorDefinition == null) {
            complexBehaviorDefinition = new EObjectContainmentEList<TComplexBehaviorDefinition>(TComplexBehaviorDefinition.class, this,
                    ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__COMPLEX_BEHAVIOR_DEFINITION);
        }
    ...
    public NotificationChain basicSetCompletionCondition(TExpression newCompletionCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__COMPLETION_CONDITION, oldCompletionCondition, newCompletionCondition);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newCompletionCondition != completionCondition) {
            ...
            if (completionCondition != null)
                msgs = ((InternalEObject) completionCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__COMPLETION_CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__COMPLETION_CONDITION,
    ...
    public void setBehavior(TMultiInstanceFlowCondition newBehavior) {
        ...
        behaviorESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__BEHAVIOR, oldBehavior, behavior,
                    !oldBehaviorESet));
    }
    ...
    public void unsetBehavior() {
        ...
        behaviorESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__BEHAVIOR, oldBehavior,
                    BEHAVIOR_EDEFAULT, oldBehaviorESet));
    }
    ...
    public void setIsSequential(boolean newIsSequential) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__IS_SEQUENTIAL, oldIsSequential,
    ...
    public void unsetIsSequential() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__IS_SEQUENTIAL, oldIsSequential,
    ...
    public void setNoneBehaviorEventRef(QName newNoneBehaviorEventRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__NONE_BEHAVIOR_EVENT_REF,
    ...
    public void setOneBehaviorEventRef(QName newOneBehaviorEventRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMULTI_INSTANCE_LOOP_CHARACTERISTICS__ONE_BEHAVIOR_EVENT_REF,
