...
public class TCorrelationPropertyRetrievalExpressionImpl extends TBaseElementImpl implements TCorrelationPropertyRetrievalExpression {
    ...
    public NotificationChain basicSetMessagePath(TFormalExpression newMessagePath, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.TCORRELATION_PROPERTY_RETRIEVAL_EXPRESSION__MESSAGE_PATH, oldMessagePath, newMessagePath);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newMessagePath != messagePath) {
            ...
            if (messagePath != null)
                msgs = ((InternalEObject) messagePath).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TCORRELATION_PROPERTY_RETRIEVAL_EXPRESSION__MESSAGE_PATH, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCORRELATION_PROPERTY_RETRIEVAL_EXPRESSION__MESSAGE_PATH, newMessagePath,
                    newMessagePath));
    }
    ...
    public void setMessageRef(QName newMessageRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCORRELATION_PROPERTY_RETRIEVAL_EXPRESSION__MESSAGE_REF, oldMessageRef,
                    messageRef));
    }
