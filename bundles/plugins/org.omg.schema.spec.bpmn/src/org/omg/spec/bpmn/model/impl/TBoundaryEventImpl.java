...
public class TBoundaryEventImpl extends TCatchEventImpl implements TBoundaryEvent {
    ...
    public void setCancelActivity(boolean newCancelActivity) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TBOUNDARY_EVENT__CANCEL_ACTIVITY, oldCancelActivity, cancelActivity,
    ...
    public void unsetCancelActivity() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TBOUNDARY_EVENT__CANCEL_ACTIVITY, oldCancelActivity, CANCEL_ACTIVITY_EDEFAULT,
                    oldCancelActivityESet));
    }
