...
public class TCompensateEventDefinitionImpl extends TEventDefinitionImpl implements TCompensateEventDefinition {
    ...
    public void setWaitForCompletion(boolean newWaitForCompletion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCOMPENSATE_EVENT_DEFINITION__WAIT_FOR_COMPLETION, oldWaitForCompletion,
    ...
    public void unsetWaitForCompletion() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TCOMPENSATE_EVENT_DEFINITION__WAIT_FOR_COMPLETION, oldWaitForCompletion,
