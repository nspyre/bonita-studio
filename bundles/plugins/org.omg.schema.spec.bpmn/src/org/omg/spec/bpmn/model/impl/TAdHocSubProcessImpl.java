...
public class TAdHocSubProcessImpl extends TSubProcessImpl implements TAdHocSubProcess {
    ...
    public NotificationChain basicSetCompletionCondition(TExpression newCompletionCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TAD_HOC_SUB_PROCESS__COMPLETION_CONDITION,
        ...
        if (newCompletionCondition != completionCondition) {
            ...
            if (completionCondition != null)
                msgs = ((InternalEObject) completionCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TAD_HOC_SUB_PROCESS__COMPLETION_CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TAD_HOC_SUB_PROCESS__COMPLETION_CONDITION, newCompletionCondition,
    ...
    public void setCancelRemainingInstances(boolean newCancelRemainingInstances) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TAD_HOC_SUB_PROCESS__CANCEL_REMAINING_INSTANCES, oldCancelRemainingInstances,
    ...
    public void unsetCancelRemainingInstances() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TAD_HOC_SUB_PROCESS__CANCEL_REMAINING_INSTANCES, oldCancelRemainingInstances,
