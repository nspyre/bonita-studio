...
public class TCorrelationSubscriptionImpl extends TBaseElementImpl implements TCorrelationSubscription {
    ...
    public EList<TCorrelationPropertyBinding> getCorrelationPropertyBinding() {
        if (correlationPropertyBinding == null) {
            correlationPropertyBinding = new EObjectContainmentEList<TCorrelationPropertyBinding>(TCorrelationPropertyBinding.class, this,
    ...
    public void setCorrelationKeyRef(QName newCorrelationKeyRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCORRELATION_SUBSCRIPTION__CORRELATION_KEY_REF, oldCorrelationKeyRef,
                    correlationKeyRef));
    }
