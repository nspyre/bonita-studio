...
public class TParticipantMultiplicityImpl extends TBaseElementImpl implements TParticipantMultiplicity {
    ...
    public void unsetMaximum() {
        ...
        maximumESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TPARTICIPANT_MULTIPLICITY__MAXIMUM, oldMaximum, MAXIMUM_EDEFAULT,
                    oldMaximumESet));
    }
    ...
    public void unsetMinimum() {
        ...
        minimumESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TPARTICIPANT_MULTIPLICITY__MINIMUM, oldMinimum, MINIMUM_EDEFAULT,
                    oldMinimumESet));
    }
