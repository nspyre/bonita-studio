...
public class TConversationAssociationImpl extends TBaseElementImpl implements TConversationAssociation {
    ...
    public void setInnerConversationNodeRef(QName newInnerConversationNodeRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCONVERSATION_ASSOCIATION__INNER_CONVERSATION_NODE_REF,
    ...
    public void setOuterConversationNodeRef(QName newOuterConversationNodeRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCONVERSATION_ASSOCIATION__OUTER_CONVERSATION_NODE_REF,
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case ModelPackage.TCONVERSATION_ASSOCIATION__INNER_CONVERSATION_NODE_REF:
                return INNER_CONVERSATION_NODE_REF_EDEFAULT == null ? innerConversationNodeRef != null : !INNER_CONVERSATION_NODE_REF_EDEFAULT
                        .equals(innerConversationNodeRef);
            case ModelPackage.TCONVERSATION_ASSOCIATION__OUTER_CONVERSATION_NODE_REF:
                return OUTER_CONVERSATION_NODE_REF_EDEFAULT == null ? outerConversationNodeRef != null : !OUTER_CONVERSATION_NODE_REF_EDEFAULT
                        .equals(outerConversationNodeRef);
        }
