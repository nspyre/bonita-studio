...
public class TItemDefinitionImpl extends TRootElementImpl implements TItemDefinition {
    ...
    public void setIsCollection(boolean newIsCollection) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TITEM_DEFINITION__IS_COLLECTION, oldIsCollection, isCollection,
                    !oldIsCollectionESet));
    }
    ...
    public void unsetIsCollection() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TITEM_DEFINITION__IS_COLLECTION, oldIsCollection, IS_COLLECTION_EDEFAULT,
                    oldIsCollectionESet));
    }
