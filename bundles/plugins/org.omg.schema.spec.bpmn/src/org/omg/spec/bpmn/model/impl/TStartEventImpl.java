...
public class TStartEventImpl extends TCatchEventImpl implements TStartEvent {
    ...
    public void setIsInterrupting(boolean newIsInterrupting) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TSTART_EVENT__IS_INTERRUPTING, oldIsInterrupting, isInterrupting,
    ...
    public void unsetIsInterrupting() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TSTART_EVENT__IS_INTERRUPTING, oldIsInterrupting, IS_INTERRUPTING_EDEFAULT,
                    oldIsInterruptingESet));
    }
