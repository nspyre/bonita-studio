...
public class BPMNEdgeImpl extends LabeledEdgeImpl implements BPMNEdge {
    ...
    public void unsetMessageVisibleKind() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, DiPackage.BPMN_EDGE__MESSAGE_VISIBLE_KIND, oldMessageVisibleKind,
                    MESSAGE_VISIBLE_KIND_EDEFAULT, oldMessageVisibleKindESet));
    }
