...
public class TParticipantAssociationImpl extends TBaseElementImpl implements TParticipantAssociation {
    ...
    public void setInnerParticipantRef(QName newInnerParticipantRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TPARTICIPANT_ASSOCIATION__INNER_PARTICIPANT_REF, oldInnerParticipantRef,
                    innerParticipantRef));
    }
    ...
    public void setOuterParticipantRef(QName newOuterParticipantRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TPARTICIPANT_ASSOCIATION__OUTER_PARTICIPANT_REF, oldOuterParticipantRef,
                    outerParticipantRef));
    }
