...
public class TResourceRoleImpl extends TBaseElementImpl implements TResourceRole {
    ...
    public EList<TResourceParameterBinding> getResourceParameterBinding() {
        if (resourceParameterBinding == null) {
            resourceParameterBinding = new EObjectContainmentEList<TResourceParameterBinding>(TResourceParameterBinding.class, this,
                    ModelPackage.TRESOURCE_ROLE__RESOURCE_PARAMETER_BINDING);
        }
    ...
    public NotificationChain basicSetResourceAssignmentExpression(TResourceAssignmentExpression newResourceAssignmentExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TRESOURCE_ROLE__RESOURCE_ASSIGNMENT_EXPRESSION,
        ...
        if (newResourceAssignmentExpression != resourceAssignmentExpression) {
            ...
            if (resourceAssignmentExpression != null)
                msgs = ((InternalEObject) resourceAssignmentExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ModelPackage.TRESOURCE_ROLE__RESOURCE_ASSIGNMENT_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TRESOURCE_ROLE__RESOURCE_ASSIGNMENT_EXPRESSION, newResourceAssignmentExpression,
