...
public class TMessageFlowAssociationImpl extends TBaseElementImpl implements TMessageFlowAssociation {
    ...
    public void setInnerMessageFlowRef(QName newInnerMessageFlowRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMESSAGE_FLOW_ASSOCIATION__INNER_MESSAGE_FLOW_REF, oldInnerMessageFlowRef,
                    innerMessageFlowRef));
    }
    ...
    public void setOuterMessageFlowRef(QName newOuterMessageFlowRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TMESSAGE_FLOW_ASSOCIATION__OUTER_MESSAGE_FLOW_REF, oldOuterMessageFlowRef,
                    outerMessageFlowRef));
    }
