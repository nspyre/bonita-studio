...
public abstract class TActivityImpl extends TFlowNodeImpl implements TActivity {
    ...
    public NotificationChain basicSetIoSpecification(TInputOutputSpecification newIoSpecification, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TACTIVITY__IO_SPECIFICATION, oldIoSpecification,
                    newIoSpecification);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public EList<TDataInputAssociation> getDataInputAssociation() {
        if (dataInputAssociation == null) {
            dataInputAssociation = new EObjectContainmentEList<TDataInputAssociation>(TDataInputAssociation.class, this,
                    ModelPackage.TACTIVITY__DATA_INPUT_ASSOCIATION);
        }
    ...
    public EList<TDataOutputAssociation> getDataOutputAssociation() {
        if (dataOutputAssociation == null) {
            dataOutputAssociation = new EObjectContainmentEList<TDataOutputAssociation>(TDataOutputAssociation.class, this,
                    ModelPackage.TACTIVITY__DATA_OUTPUT_ASSOCIATION);
        }
    ...
    public NotificationChain basicSetLoopCharacteristics(TLoopCharacteristics newLoopCharacteristics, NotificationChain msgs) {
        return ((FeatureMap.Internal) getLoopCharacteristicsGroup()).basicAdd(ModelPackage.Literals.TACTIVITY__LOOP_CHARACTERISTICS, newLoopCharacteristics,
                msgs);
    }
    ...
    public void setCompletionQuantity(BigInteger newCompletionQuantity) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TACTIVITY__COMPLETION_QUANTITY, oldCompletionQuantity, completionQuantity,
    ...
    public void unsetCompletionQuantity() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TACTIVITY__COMPLETION_QUANTITY, oldCompletionQuantity,
    ...
    public void setIsForCompensation(boolean newIsForCompensation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TACTIVITY__IS_FOR_COMPENSATION, oldIsForCompensation, isForCompensation,
    ...
    public void unsetIsForCompensation() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TACTIVITY__IS_FOR_COMPENSATION, oldIsForCompensation,
    ...
    public void setStartQuantity(BigInteger newStartQuantity) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TACTIVITY__START_QUANTITY, oldStartQuantity, startQuantity,
    ...
    public void unsetStartQuantity() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TACTIVITY__START_QUANTITY, oldStartQuantity, START_QUANTITY_EDEFAULT,
                    oldStartQuantityESet));
    }
