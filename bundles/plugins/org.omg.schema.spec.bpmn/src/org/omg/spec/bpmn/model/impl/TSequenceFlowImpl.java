...
public class TSequenceFlowImpl extends TFlowElementImpl implements TSequenceFlow {
    ...
    public NotificationChain basicSetConditionExpression(TExpression newConditionExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TSEQUENCE_FLOW__CONDITION_EXPRESSION,
    ...
    public void setConditionExpression(TExpression newConditionExpression) {
        if (newConditionExpression != conditionExpression) {
            ...
            if (conditionExpression != null)
                msgs = ((InternalEObject) conditionExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TSEQUENCE_FLOW__CONDITION_EXPRESSION,
                        null, msgs);
            if (newConditionExpression != null)
                msgs = ((InternalEObject) newConditionExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TSEQUENCE_FLOW__CONDITION_EXPRESSION,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TSEQUENCE_FLOW__CONDITION_EXPRESSION, newConditionExpression,
    ...
    public void unsetIsImmediate() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TSEQUENCE_FLOW__IS_IMMEDIATE, oldIsImmediate, IS_IMMEDIATE_EDEFAULT,
                    oldIsImmediateESet));
    }
