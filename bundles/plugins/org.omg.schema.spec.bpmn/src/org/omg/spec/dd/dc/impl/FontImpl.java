...
public class FontImpl extends EObjectImpl implements Font {
    ...
    public void unsetIsStrikeThrough() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, DcPackage.FONT__IS_STRIKE_THROUGH, oldIsStrikeThrough, IS_STRIKE_THROUGH_EDEFAULT,
                    oldIsStrikeThroughESet));
    }
