                ...
                if (object instanceof DayPeriod) {
                    ...
                    for (Control button : daysComposite.getChildren()) {
                        if (button instanceof Button) {
                            ...
                            switch (i) {
                                case 1:
                                    check.setSelection(period.getDay().contains(Calendar.MONDAY));
                                    break;
                                case 2:
                                    check.setSelection(period.getDay().contains(Calendar.TUESDAY));
                                    break;
                                case 3:
                                    check.setSelection(period.getDay().contains(Calendar.WEDNESDAY));
                                    break;
                                case 4:
                                    check.setSelection(period.getDay().contains(Calendar.THURSDAY));
                                    break;
                                case 5:
                                    check.setSelection(period.getDay().contains(Calendar.FRIDAY));
                                    break;
                                case 6:
                                    check.setSelection(period.getDay().contains(Calendar.SATURDAY));
                                    break;
                                case 7:
                                    check.setSelection(period.getDay().contains(Calendar.SUNDAY));
                                    break;
                            }
