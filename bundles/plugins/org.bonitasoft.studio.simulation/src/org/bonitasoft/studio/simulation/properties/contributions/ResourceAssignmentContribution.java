        ...
        filteredTree.getViewer().setLabelProvider(new LabelProvider() {
            ...
            public String getText(Object element) {
                ...
                if (ru.isUseActivityDuration()) {
                    return NLS.bind(Messages.resourceAssignmentLabel, new Object[] { ru.getQuantity(), ru.getResourceID(),
                            Messages.AddResourceAssignmentWizardPage_useActivity });
                } else {
                    return NLS.bind(Messages.resourceAssignmentLabel,
                            new Object[] { ru.getQuantity(), ru.getResourceID(), DateUtil.getDisplayDuration(ru.getDuration()) });
                }
            }
        });
