...
public class XSDContentProvider implements ITreeContentProvider {
    ...
    public boolean hasChildren(Object element) {
        return !(element instanceof Append ||
                element instanceof XSDSimpleTypeDefinition ||
                element instanceof XSDAttributeUse ||
                element instanceof XSDAttributeDeclaration || (element instanceof XSDElementDeclaration && ((XSDElementDeclaration) element).getType() instanceof XSDSimpleTypeDefinition));
    }
