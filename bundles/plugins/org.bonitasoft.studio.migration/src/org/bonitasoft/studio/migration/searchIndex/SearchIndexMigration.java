...
public class SearchIndexMigration extends CustomMigration {
    ...
    private Instance createSearchIndex(Model model) {
        ...
        Instance nameExpression = StringToExpressionConverter.createExpressionInstance(model, "", "", String.class.getName(),
                ExpressionConstants.CONSTANT_TYPE, true);
        searchIndex.set("name", nameExpression);
        Instance valueExpression = StringToExpressionConverter.createExpressionInstance(model, "", "", String.class.getName(),
                ExpressionConstants.CONSTANT_TYPE, true);
