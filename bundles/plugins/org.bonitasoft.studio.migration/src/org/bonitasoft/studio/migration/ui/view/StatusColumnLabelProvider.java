...
public class StatusColumnLabelProvider extends StyledCellLabelProvider implements ILabelProvider {
    ...
    public String getToolTipText(Object element) {
        ...
        switch (status) {
            case IStatus.OK:
                return Messages.okStatusTooltip;
            case IStatus.WARNING:
                return Messages.warningStatusTooltip;
            case IStatus.ERROR:
                return Messages.errorStatusTooltip;
            default:
                break;
        }
    ...
    private Image getImageForStatus(int status) {
        switch (status) {
            case IStatus.OK:
                return Pics.getImage("valid.png", MigrationPlugin.getDefault());
            case IStatus.WARNING:
