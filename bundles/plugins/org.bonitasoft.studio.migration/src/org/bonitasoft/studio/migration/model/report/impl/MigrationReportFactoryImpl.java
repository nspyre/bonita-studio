...
public class MigrationReportFactoryImpl extends EFactoryImpl implements MigrationReportFactory {
    ...
    public static MigrationReportFactory init() {
        try {
            MigrationReportFactory theMigrationReportFactory = (MigrationReportFactory) EPackage.Registry.INSTANCE
                    .getEFactory("http://www.bonitasoft.org/ns/studio/migration/report");
