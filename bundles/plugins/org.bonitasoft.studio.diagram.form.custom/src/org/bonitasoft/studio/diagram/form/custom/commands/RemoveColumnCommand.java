...
public class RemoveColumnCommand extends AbstractTransactionalCommand/* AbstractRemoveColumnCommand */{
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        for (Widget widget : getChildren()) {
            ...
            if (oldColumn == column) {
                ...
                SetRequest setRequest = new SetRequest(getEditingDomain(), widget.getWidgetLayoutInfo(), FormPackage.eINSTANCE.getWidgetLayoutInfo_Column(),
                        oldColumn - 1);
    ...
    protected void decrementSpan(Widget widget) {
        SetRequest setRequest = new SetRequest(getEditingDomain(), widget.getWidgetLayoutInfo(), FormPackage.eINSTANCE.getWidgetLayoutInfo_HorizontalSpan(),
                widget.getWidgetLayoutInfo().getHorizontalSpan() - 1);
        cc.add(new SetValueCommand(setRequest));
    }
    ...
    protected void decrementColumnEditPart() {
        SetRequest setRequest = new SetRequest(getEditingDomain(), semanticElement, FormPackage.eINSTANCE.getForm_NColumn(),
                ((Form) semanticElement).getNColumn() - 1);
        cc.add(new SetValueCommand(setRequest));
    }
