...
public class PerspectiveFormsFactory extends AbstractPerspectiveFactory {
    ...
    public void createInitialLayout(IPageLayout layout) {
        ...
        // Bottom left.
        IFolderLayout bottomLeft = layout.createFolder("bottomLeft", IPageLayout.BOTTOM, (float) 0.650,//$NON-NLS-1$
        ...
        // Bottom right.
        IFolderLayout bottomRight = layout.createFolder("bottomRight", IPageLayout.RIGHT, (float) 0.3,//$NON-NLS-1$
                "bottomLeft");
