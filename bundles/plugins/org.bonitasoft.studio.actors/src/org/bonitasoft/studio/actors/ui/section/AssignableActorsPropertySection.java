...
public class AssignableActorsPropertySection extends AbstractActorsPropertySection implements ISelectionChangedListener {
    ...
    protected void updateDatabinding() {
        ...
        if (assignable != null) {
            ...
            emfDatabindingContext.bindValue(SWTObservables.observeEnabled(actorComboViewer.getControl()), SWTObservables.observeSelection(useLaneActorButton),
                    new UpdateValueStrategy(), updateValueStrategy);
