...
public class DefaultOrganizationContribution implements IFileStoreContribution {
    ...
    public void execute(IRepositoryStore<? extends IRepositoryFileStore> repository) {
        ...
        IRepositoryFileStore file = repository.createRepositoryFileStore(ActorsPreferenceConstants.DEFAULT_ORGANIZATION_NAME + "."
    ...
    protected Users createUsers() {
        ...
        userList.add(createUser(mr, "zachary.williamson", "Zachary", "Williamson", "bpm", "ZacharyWilliamson@acme.com", "william.jobs",
                "Chief Financial Officer"));
        userList.add(createUser(mr, "patrick.gardenier", "Patrick", "Gardenier", "bpm", "PatrickGardenier@acme.com", "zachary.williamson",
