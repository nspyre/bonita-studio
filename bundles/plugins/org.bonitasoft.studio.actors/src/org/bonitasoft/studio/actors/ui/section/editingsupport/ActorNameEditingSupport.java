...
public class ActorNameEditingSupport extends EditingSupport {
    ...
    public ActorNameEditingSupport(final ColumnViewer viewer, final TransactionalEditingDomain transactionalEditingDomain,
            final CellEditorValidationStatusListener listener) {
        super(viewer);
