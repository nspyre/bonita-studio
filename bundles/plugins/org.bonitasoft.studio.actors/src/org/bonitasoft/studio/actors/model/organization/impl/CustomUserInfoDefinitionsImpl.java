 ...
 * <ul>
 * <li>{@link org.bonitasoft.studio.actors.model.organization.impl.CustomUserInfoDefinitionsImpl#getCustomUserInfoDefinition <em>Custom User Info
 * Definition</em>}</li>
 * </ul>
 * </p>
 *
...
public class CustomUserInfoDefinitionsImpl extends EObjectImpl implements CustomUserInfoDefinitions {
    ...
    public EList<CustomUserInfoDefinition> getCustomUserInfoDefinition() {
        if (customUserInfoDefinition == null) {
            customUserInfoDefinition = new EObjectContainmentEList<CustomUserInfoDefinition>(CustomUserInfoDefinition.class, this,
                    OrganizationPackage.CUSTOM_USER_INFO_DEFINITIONS__CUSTOM_USER_INFO_DEFINITION);
        }
