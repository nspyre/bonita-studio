...
public class MembershipImpl extends EObjectImpl implements Membership {
    ...
    public void setAssignedDate(long newAssignedDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OrganizationPackage.MEMBERSHIP__ASSIGNED_DATE, oldAssignedDate, assignedDate,
                    !oldAssignedDateESet));
    }
    ...
    public void unsetAssignedDate() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, OrganizationPackage.MEMBERSHIP__ASSIGNED_DATE, oldAssignedDate, ASSIGNED_DATE_EDEFAULT,
                    oldAssignedDateESet));
    }
