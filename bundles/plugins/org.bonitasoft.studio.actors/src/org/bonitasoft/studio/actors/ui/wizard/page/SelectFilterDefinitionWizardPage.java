...
public class SelectFilterDefinitionWizardPage extends SelectConnectorDefinitionWizardPage implements ISelectionChangedListener, IDoubleClickListener {
    ...
    public void createControl(Composite parent) {
        ...
        context.bindValue(ViewersObservables.observeSingleSelection(filterTree.getViewer()),
        ...
        context.bindValue(ViewersObservables.observeSingleSelection(filterTree.getViewer()), EMFObservables.observeValue(
                connectorWorkingCopy.getConfiguration(), ConnectorConfigurationPackage.Literals.CONNECTOR_CONFIGURATION__DEFINITION_ID), idStrategy, null);
        context.bindValue(ViewersObservables.observeSingleSelection(filterTree.getViewer()),
