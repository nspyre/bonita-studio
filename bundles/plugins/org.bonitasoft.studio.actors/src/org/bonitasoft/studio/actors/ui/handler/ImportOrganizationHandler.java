                    ...
                    public void run(final IProgressMonitor monitor) throws InvocationTargetException,
                        ...
                        try {
                            ...
                            if (file != null && file.isCorrectlySyntaxed()) {
                                ...
                                MessageDialog.openError(Display.getDefault().getActiveShell(), Messages.importOrganizationFailedTitle,
                                        Messages.importOrganizationFailedMessage);
                            }
                            ...
                            final OrganizationFileStore file = organizationStore.getChild(new File(filePath).getName().replace(".xml",
                                    "." + OrganizationRepositoryStore.ORGANIZATION_EXT));
                            if (file != null) {
                                file.delete();
                            }
                            new BonitaErrorDialog(Display.getDefault().getActiveShell(), Messages.importOrganizationFailedTitle,
                                    Messages.importOrganizationFailedMessage, e).open();
                        } finally {
