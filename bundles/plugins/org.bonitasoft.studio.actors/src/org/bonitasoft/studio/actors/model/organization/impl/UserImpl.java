...
public class UserImpl extends EObjectImpl implements User {
    ...
    public NotificationChain basicSetPersonalData(ContactData newPersonalData, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrganizationPackage.USER__PERSONAL_DATA, oldPersonalData,
                    newPersonalData);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetProfessionalData(ContactData newProfessionalData, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrganizationPackage.USER__PROFESSIONAL_DATA, oldProfessionalData,
                    newProfessionalData);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setProfessionalData(ContactData newProfessionalData) {
        if (newProfessionalData != professionalData) {
            ...
            if (professionalData != null)
                msgs = ((InternalEObject) professionalData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrganizationPackage.USER__PROFESSIONAL_DATA, null,
                        msgs);
            if (newProfessionalData != null)
                msgs = ((InternalEObject) newProfessionalData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrganizationPackage.USER__PROFESSIONAL_DATA, null,
                        msgs);
    ...
    public NotificationChain basicSetCustomUserInfoValues(CustomUserInfoValuesType newCustomUserInfoValues, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrganizationPackage.USER__CUSTOM_USER_INFO_VALUES,
                    oldCustomUserInfoValues, newCustomUserInfoValues);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setCustomUserInfoValues(CustomUserInfoValuesType newCustomUserInfoValues) {
        if (newCustomUserInfoValues != customUserInfoValues) {
            ...
            if (customUserInfoValues != null)
                msgs = ((InternalEObject) customUserInfoValues).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - OrganizationPackage.USER__CUSTOM_USER_INFO_VALUES, null, msgs);
            if (newCustomUserInfoValues != null)
                msgs = ((InternalEObject) newCustomUserInfoValues).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - OrganizationPackage.USER__CUSTOM_USER_INFO_VALUES, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, OrganizationPackage.USER__CUSTOM_USER_INFO_VALUES, newCustomUserInfoValues,
                    newCustomUserInfoValues));
    }
