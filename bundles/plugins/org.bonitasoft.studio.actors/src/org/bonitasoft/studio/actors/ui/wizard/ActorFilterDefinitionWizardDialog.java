...
public class ActorFilterDefinitionWizardDialog extends AbstractDefinitionWizardDialog {
    ...
    public ActorFilterDefinitionWizardDialog(Shell parentShell, IWizard newWizard) {
        super(parentShell, newWizard, RepositoryManager.getInstance().getRepositoryStore(ActorFilterConfRepositoryStore.class), RepositoryManager.getInstance()
                .getRepositoryStore(ActorFilterDefRepositoryStore.class), null);
    }
