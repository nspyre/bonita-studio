...
public class ActorFilterResourceProvider implements IBOSArchiveFileStoreProvider {
    ...
    public Set<IRepositoryFileStore> getFileStoreForConfiguration(AbstractProcess process, Configuration configuration) {
        ...
        final ActorFilterDefRepositoryStore filterDefSotre = (ActorFilterDefRepositoryStore) RepositoryManager.getInstance().getRepositoryStore(
                ActorFilterDefRepositoryStore.class);
        final ActorFilterImplRepositoryStore filterImplStore = (ActorFilterImplRepositoryStore) RepositoryManager.getInstance().getRepositoryStore(
                ActorFilterImplRepositoryStore.class);
        final ActorFilterSourceRepositoryStore filterSourceStore = (ActorFilterSourceRepositoryStore) RepositoryManager.getInstance().getRepositoryStore(
                ActorFilterSourceRepositoryStore.class);
