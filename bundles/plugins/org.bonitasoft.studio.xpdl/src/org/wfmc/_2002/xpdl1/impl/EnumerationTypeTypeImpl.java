...
public class EnumerationTypeTypeImpl extends EObjectImpl implements EnumerationTypeType {
    ...
    public EList<EnumerationValueType> getEnumerationValue() {
        if (enumerationValue == null) {
            enumerationValue = new EObjectContainmentEList<EnumerationValueType>(EnumerationValueType.class, this,
                    Xpdl1Package.ENUMERATION_TYPE_TYPE__ENUMERATION_VALUE);
        }
