...
public class ExtendedAttributesTypeImpl extends EObjectImpl implements ExtendedAttributesType {
    ...
    public EList<ExtendedAttributeType> getExtendedAttribute() {
        if (extendedAttribute == null) {
            extendedAttribute = new EObjectContainmentEList<ExtendedAttributeType>(ExtendedAttributeType.class, this,
                    Xpdl1Package.EXTENDED_ATTRIBUTES_TYPE__EXTENDED_ATTRIBUTE);
        }
