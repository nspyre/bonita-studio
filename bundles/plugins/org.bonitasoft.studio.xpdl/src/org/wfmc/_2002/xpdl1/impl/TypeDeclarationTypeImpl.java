...
public class TypeDeclarationTypeImpl extends EObjectImpl implements TypeDeclarationType {
    ...
    public NotificationChain basicSetBasicType(BasicTypeType newBasicType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__BASIC_TYPE, oldBasicType,
                    newBasicType);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetDeclaredType(DeclaredTypeType newDeclaredType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__DECLARED_TYPE, oldDeclaredType,
                    newDeclaredType);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDeclaredType(DeclaredTypeType newDeclaredType) {
        if (newDeclaredType != declaredType) {
            ...
            if (declaredType != null)
                msgs = ((InternalEObject) declaredType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TYPE_DECLARATION_TYPE__DECLARED_TYPE, null,
                        msgs);
            if (newDeclaredType != null)
                msgs = ((InternalEObject) newDeclaredType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TYPE_DECLARATION_TYPE__DECLARED_TYPE, null,
                        msgs);
    ...
    public NotificationChain basicSetSchemaType(SchemaTypeType newSchemaType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__SCHEMA_TYPE, oldSchemaType,
                    newSchemaType);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newSchemaType != schemaType) {
            ...
            if (schemaType != null)
                msgs = ((InternalEObject) schemaType)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TYPE_DECLARATION_TYPE__SCHEMA_TYPE, null, msgs);
            if (newSchemaType != null)
                msgs = ((InternalEObject) newSchemaType)
                        .eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TYPE_DECLARATION_TYPE__SCHEMA_TYPE, null, msgs);
    ...
    public NotificationChain basicSetExternalReference(ExternalReferenceType newExternalReference, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__EXTERNAL_REFERENCE,
    ...
    public void setExternalReference(ExternalReferenceType newExternalReference) {
        if (newExternalReference != externalReference) {
            ...
            if (externalReference != null)
                msgs = ((InternalEObject) externalReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.TYPE_DECLARATION_TYPE__EXTERNAL_REFERENCE, null, msgs);
            if (newExternalReference != null)
                msgs = ((InternalEObject) newExternalReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.TYPE_DECLARATION_TYPE__EXTERNAL_REFERENCE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__EXTERNAL_REFERENCE, newExternalReference,
    ...
    public NotificationChain basicSetRecordType(RecordTypeType newRecordType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__RECORD_TYPE, oldRecordType,
                    newRecordType);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newRecordType != recordType) {
            ...
            if (recordType != null)
                msgs = ((InternalEObject) recordType)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TYPE_DECLARATION_TYPE__RECORD_TYPE, null, msgs);
            if (newRecordType != null)
                msgs = ((InternalEObject) newRecordType)
                        .eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TYPE_DECLARATION_TYPE__RECORD_TYPE, null, msgs);
    ...
    public NotificationChain basicSetUnionType(UnionTypeType newUnionType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__UNION_TYPE, oldUnionType,
                    newUnionType);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetEnumerationType(EnumerationTypeType newEnumerationType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__ENUMERATION_TYPE,
    ...
    public void setEnumerationType(EnumerationTypeType newEnumerationType) {
        if (newEnumerationType != enumerationType) {
            ...
            if (enumerationType != null)
                msgs = ((InternalEObject) enumerationType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TYPE_DECLARATION_TYPE__ENUMERATION_TYPE,
                        null, msgs);
            if (newEnumerationType != null)
                msgs = ((InternalEObject) newEnumerationType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TYPE_DECLARATION_TYPE__ENUMERATION_TYPE,
                        null, msgs);
    ...
    public NotificationChain basicSetArrayType(ArrayTypeType newArrayType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__ARRAY_TYPE, oldArrayType,
                    newArrayType);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetListType(ListTypeType newListType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__LIST_TYPE, oldListType,
                    newListType);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetExtendedAttributes(ExtendedAttributesType newExtendedAttributes, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__EXTENDED_ATTRIBUTES,
        ...
        if (newExtendedAttributes != extendedAttributes) {
            ...
            if (extendedAttributes != null)
                msgs = ((InternalEObject) extendedAttributes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.TYPE_DECLARATION_TYPE__EXTENDED_ATTRIBUTES, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.TYPE_DECLARATION_TYPE__EXTENDED_ATTRIBUTES, newExtendedAttributes,
