...
public class RedefinableHeaderTypeImpl extends EObjectImpl implements RedefinableHeaderType {
    ...
    public NotificationChain basicSetResponsibles(ResponsiblesType newResponsibles, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.REDEFINABLE_HEADER_TYPE__RESPONSIBLES, oldResponsibles,
                    newResponsibles);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setResponsibles(ResponsiblesType newResponsibles) {
        if (newResponsibles != responsibles) {
            ...
            if (responsibles != null)
                msgs = ((InternalEObject) responsibles).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.REDEFINABLE_HEADER_TYPE__RESPONSIBLES, null,
                        msgs);
            if (newResponsibles != null)
                msgs = ((InternalEObject) newResponsibles).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.REDEFINABLE_HEADER_TYPE__RESPONSIBLES, null,
                        msgs);
    ...
    public void setPublicationStatus(PublicationStatusType newPublicationStatus) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.REDEFINABLE_HEADER_TYPE__PUBLICATION_STATUS, oldPublicationStatus,
                    publicationStatus, !oldPublicationStatusESet));
    }
    ...
    public void unsetPublicationStatus() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, Xpdl1Package.REDEFINABLE_HEADER_TYPE__PUBLICATION_STATUS, oldPublicationStatus,
                    PUBLICATION_STATUS_EDEFAULT, oldPublicationStatusESet));
    }
