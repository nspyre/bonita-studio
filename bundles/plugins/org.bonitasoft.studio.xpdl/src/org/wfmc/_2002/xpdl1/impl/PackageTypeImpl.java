...
public class PackageTypeImpl extends EObjectImpl implements PackageType {
    ...
    public NotificationChain basicSetPackageHeader(PackageHeaderType newPackageHeader, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PACKAGE_TYPE__PACKAGE_HEADER, oldPackageHeader,
                    newPackageHeader);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetRedefinableHeader(RedefinableHeaderType newRedefinableHeader, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PACKAGE_TYPE__REDEFINABLE_HEADER, oldRedefinableHeader,
    ...
    public void setRedefinableHeader(RedefinableHeaderType newRedefinableHeader) {
        if (newRedefinableHeader != redefinableHeader) {
            ...
            if (redefinableHeader != null)
                msgs = ((InternalEObject) redefinableHeader).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__REDEFINABLE_HEADER, null,
                        msgs);
            if (newRedefinableHeader != null)
                msgs = ((InternalEObject) newRedefinableHeader).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__REDEFINABLE_HEADER, null,
                        msgs);
    ...
    public NotificationChain basicSetConformanceClass(ConformanceClassType newConformanceClass, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PACKAGE_TYPE__CONFORMANCE_CLASS, oldConformanceClass,
                    newConformanceClass);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setConformanceClass(ConformanceClassType newConformanceClass) {
        if (newConformanceClass != conformanceClass) {
            ...
            if (conformanceClass != null)
                msgs = ((InternalEObject) conformanceClass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__CONFORMANCE_CLASS, null,
                        msgs);
            if (newConformanceClass != null)
                msgs = ((InternalEObject) newConformanceClass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__CONFORMANCE_CLASS, null,
                        msgs);
    ...
    public NotificationChain basicSetExternalPackages(ExternalPackagesType newExternalPackages, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PACKAGE_TYPE__EXTERNAL_PACKAGES, oldExternalPackages,
                    newExternalPackages);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setExternalPackages(ExternalPackagesType newExternalPackages) {
        if (newExternalPackages != externalPackages) {
            ...
            if (externalPackages != null)
                msgs = ((InternalEObject) externalPackages).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__EXTERNAL_PACKAGES, null,
                        msgs);
            if (newExternalPackages != null)
                msgs = ((InternalEObject) newExternalPackages).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__EXTERNAL_PACKAGES, null,
                        msgs);
    ...
    public NotificationChain basicSetTypeDeclarations(TypeDeclarationsType newTypeDeclarations, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PACKAGE_TYPE__TYPE_DECLARATIONS, oldTypeDeclarations,
                    newTypeDeclarations);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setTypeDeclarations(TypeDeclarationsType newTypeDeclarations) {
        if (newTypeDeclarations != typeDeclarations) {
            ...
            if (typeDeclarations != null)
                msgs = ((InternalEObject) typeDeclarations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__TYPE_DECLARATIONS, null,
                        msgs);
            if (newTypeDeclarations != null)
                msgs = ((InternalEObject) newTypeDeclarations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__TYPE_DECLARATIONS, null,
                        msgs);
    ...
    public NotificationChain basicSetParticipants(ParticipantsType newParticipants, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PACKAGE_TYPE__PARTICIPANTS, oldParticipants,
                    newParticipants);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetApplications(ApplicationsType newApplications, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PACKAGE_TYPE__APPLICATIONS, oldApplications,
                    newApplications);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetWorkflowProcesses(WorkflowProcessesType newWorkflowProcesses, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PACKAGE_TYPE__WORKFLOW_PROCESSES, oldWorkflowProcesses,
                    newWorkflowProcesses);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setWorkflowProcesses(WorkflowProcessesType newWorkflowProcesses) {
        if (newWorkflowProcesses != workflowProcesses) {
            ...
            if (workflowProcesses != null)
                msgs = ((InternalEObject) workflowProcesses).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__WORKFLOW_PROCESSES, null,
                        msgs);
            if (newWorkflowProcesses != null)
                msgs = ((InternalEObject) newWorkflowProcesses).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__WORKFLOW_PROCESSES, null,
                        msgs);
    ...
    public NotificationChain basicSetExtendedAttributes(ExtendedAttributesType newExtendedAttributes, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PACKAGE_TYPE__EXTENDED_ATTRIBUTES,
    ...
    public void setExtendedAttributes(ExtendedAttributesType newExtendedAttributes) {
        if (newExtendedAttributes != extendedAttributes) {
            ...
            if (extendedAttributes != null)
                msgs = ((InternalEObject) extendedAttributes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__EXTENDED_ATTRIBUTES,
                        null, msgs);
            if (newExtendedAttributes != null)
                msgs = ((InternalEObject) newExtendedAttributes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PACKAGE_TYPE__EXTENDED_ATTRIBUTES,
                        null, msgs);
