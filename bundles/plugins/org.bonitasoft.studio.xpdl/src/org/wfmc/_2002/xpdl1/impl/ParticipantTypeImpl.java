...
public class ParticipantTypeImpl extends EObjectImpl implements ParticipantType {
    ...
    public NotificationChain basicSetParticipantType(ParticipantTypeType newParticipantType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PARTICIPANT_TYPE__PARTICIPANT_TYPE, oldParticipantType,
                    newParticipantType);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setParticipantType(ParticipantTypeType newParticipantType) {
        if (newParticipantType != participantType) {
            ...
            if (participantType != null)
                msgs = ((InternalEObject) participantType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PARTICIPANT_TYPE__PARTICIPANT_TYPE, null,
                        msgs);
            if (newParticipantType != null)
                msgs = ((InternalEObject) newParticipantType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PARTICIPANT_TYPE__PARTICIPANT_TYPE, null,
                        msgs);
    ...
    public NotificationChain basicSetExternalReference(ExternalReferenceType newExternalReference, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PARTICIPANT_TYPE__EXTERNAL_REFERENCE,
    ...
    public void setExternalReference(ExternalReferenceType newExternalReference) {
        if (newExternalReference != externalReference) {
            ...
            if (externalReference != null)
                msgs = ((InternalEObject) externalReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PARTICIPANT_TYPE__EXTERNAL_REFERENCE,
                        null, msgs);
            if (newExternalReference != null)
                msgs = ((InternalEObject) newExternalReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PARTICIPANT_TYPE__EXTERNAL_REFERENCE,
                        null, msgs);
    ...
    public NotificationChain basicSetExtendedAttributes(ExtendedAttributesType newExtendedAttributes, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PARTICIPANT_TYPE__EXTENDED_ATTRIBUTES,
    ...
    public void setExtendedAttributes(ExtendedAttributesType newExtendedAttributes) {
        if (newExtendedAttributes != extendedAttributes) {
            ...
            if (extendedAttributes != null)
                msgs = ((InternalEObject) extendedAttributes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PARTICIPANT_TYPE__EXTENDED_ATTRIBUTES,
                        null, msgs);
            if (newExtendedAttributes != null)
                msgs = ((InternalEObject) newExtendedAttributes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PARTICIPANT_TYPE__EXTENDED_ATTRIBUTES,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.PARTICIPANT_TYPE__EXTENDED_ATTRIBUTES, newExtendedAttributes,
