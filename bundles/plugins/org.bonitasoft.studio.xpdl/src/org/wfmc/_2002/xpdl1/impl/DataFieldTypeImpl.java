...
public class DataFieldTypeImpl extends EObjectImpl implements DataFieldType {
    ...
    public NotificationChain basicSetExtendedAttributes(ExtendedAttributesType newExtendedAttributes, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.DATA_FIELD_TYPE__EXTENDED_ATTRIBUTES,
    ...
    public void setExtendedAttributes(ExtendedAttributesType newExtendedAttributes) {
        if (newExtendedAttributes != extendedAttributes) {
            ...
            if (extendedAttributes != null)
                msgs = ((InternalEObject) extendedAttributes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.DATA_FIELD_TYPE__EXTENDED_ATTRIBUTES,
                        null, msgs);
            if (newExtendedAttributes != null)
                msgs = ((InternalEObject) newExtendedAttributes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.DATA_FIELD_TYPE__EXTENDED_ATTRIBUTES,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.DATA_FIELD_TYPE__EXTENDED_ATTRIBUTES, newExtendedAttributes,
