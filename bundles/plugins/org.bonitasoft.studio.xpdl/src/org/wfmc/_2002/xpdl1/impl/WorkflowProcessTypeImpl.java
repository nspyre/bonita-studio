...
public class WorkflowProcessTypeImpl extends EObjectImpl implements WorkflowProcessType {
    ...
    public NotificationChain basicSetProcessHeader(ProcessHeaderType newProcessHeader, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__PROCESS_HEADER,
    ...
    public void setProcessHeader(ProcessHeaderType newProcessHeader) {
        if (newProcessHeader != processHeader) {
            ...
            if (processHeader != null)
                msgs = ((InternalEObject) processHeader).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__PROCESS_HEADER,
                        null, msgs);
            if (newProcessHeader != null)
                msgs = ((InternalEObject) newProcessHeader).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__PROCESS_HEADER,
                        null, msgs);
    ...
    public NotificationChain basicSetRedefinableHeader(RedefinableHeaderType newRedefinableHeader, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__REDEFINABLE_HEADER,
    ...
    public void setRedefinableHeader(RedefinableHeaderType newRedefinableHeader) {
        if (newRedefinableHeader != redefinableHeader) {
            ...
            if (redefinableHeader != null)
                msgs = ((InternalEObject) redefinableHeader).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.WORKFLOW_PROCESS_TYPE__REDEFINABLE_HEADER, null, msgs);
            if (newRedefinableHeader != null)
                msgs = ((InternalEObject) newRedefinableHeader).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.WORKFLOW_PROCESS_TYPE__REDEFINABLE_HEADER, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__REDEFINABLE_HEADER, newRedefinableHeader,
                    newRedefinableHeader));
    }
    ...
    public NotificationChain basicSetFormalParameters(FormalParametersType newFormalParameters, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__FORMAL_PARAMETERS,
                    oldFormalParameters, newFormalParameters);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setFormalParameters(FormalParametersType newFormalParameters) {
        if (newFormalParameters != formalParameters) {
            ...
            if (formalParameters != null)
                msgs = ((InternalEObject) formalParameters).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__FORMAL_PARAMETERS, null, msgs);
            if (newFormalParameters != null)
                msgs = ((InternalEObject) newFormalParameters).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__FORMAL_PARAMETERS, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__FORMAL_PARAMETERS, newFormalParameters,
                    newFormalParameters));
    }
    ...
    public NotificationChain basicSetDataFields(DataFieldsType newDataFields, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__DATA_FIELDS, oldDataFields,
                    newDataFields);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDataFields(DataFieldsType newDataFields) {
        if (newDataFields != dataFields) {
            NotificationChain msgs = null;
            if (dataFields != null)
                msgs = ((InternalEObject) dataFields)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__DATA_FIELDS, null, msgs);
            if (newDataFields != null)
                msgs = ((InternalEObject) newDataFields)
                        .eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__DATA_FIELDS, null, msgs);
    ...
    public NotificationChain basicSetParticipants(ParticipantsType newParticipants, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__PARTICIPANTS, oldParticipants,
                    newParticipants);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setParticipants(ParticipantsType newParticipants) {
        if (newParticipants != participants) {
            ...
            if (participants != null)
                msgs = ((InternalEObject) participants).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__PARTICIPANTS, null,
                        msgs);
            if (newParticipants != null)
                msgs = ((InternalEObject) newParticipants).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__PARTICIPANTS, null,
                        msgs);
    ...
    public NotificationChain basicSetApplications(ApplicationsType newApplications, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__APPLICATIONS, oldApplications,
                    newApplications);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setApplications(ApplicationsType newApplications) {
        if (newApplications != applications) {
            ...
            if (applications != null)
                msgs = ((InternalEObject) applications).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__APPLICATIONS, null,
                        msgs);
            if (newApplications != null)
                msgs = ((InternalEObject) newApplications).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__APPLICATIONS, null,
                        msgs);
    ...
    public NotificationChain basicSetActivitySets(ActivitySetsType newActivitySets, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__ACTIVITY_SETS, oldActivitySets,
                    newActivitySets);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setActivitySets(ActivitySetsType newActivitySets) {
        if (newActivitySets != activitySets) {
            ...
            if (activitySets != null)
                msgs = ((InternalEObject) activitySets).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__ACTIVITY_SETS, null,
                        msgs);
            if (newActivitySets != null)
                msgs = ((InternalEObject) newActivitySets).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__ACTIVITY_SETS, null,
                        msgs);
    ...
    public NotificationChain basicSetActivities(ActivitiesType newActivities, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__ACTIVITIES, oldActivities,
                    newActivities);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetTransitions(TransitionsType newTransitions, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__TRANSITIONS, oldTransitions,
                    newTransitions);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setTransitions(TransitionsType newTransitions) {
        if (newTransitions != transitions) {
            NotificationChain msgs = null;
            if (transitions != null)
                msgs = ((InternalEObject) transitions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__TRANSITIONS, null,
                        msgs);
            if (newTransitions != null)
                msgs = ((InternalEObject) newTransitions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.WORKFLOW_PROCESS_TYPE__TRANSITIONS, null,
                        msgs);
    ...
    public NotificationChain basicSetExtendedAttributes(ExtendedAttributesType newExtendedAttributes, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__EXTENDED_ATTRIBUTES,
                    oldExtendedAttributes, newExtendedAttributes);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setExtendedAttributes(ExtendedAttributesType newExtendedAttributes) {
        if (newExtendedAttributes != extendedAttributes) {
            ...
            if (extendedAttributes != null)
                msgs = ((InternalEObject) extendedAttributes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.WORKFLOW_PROCESS_TYPE__EXTENDED_ATTRIBUTES, null, msgs);
            if (newExtendedAttributes != null)
                msgs = ((InternalEObject) newExtendedAttributes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.WORKFLOW_PROCESS_TYPE__EXTENDED_ATTRIBUTES, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__EXTENDED_ATTRIBUTES, newExtendedAttributes,
                    newExtendedAttributes));
    }
    ...
    public void setAccessLevel(AccessLevelType newAccessLevel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__ACCESS_LEVEL, oldAccessLevel, accessLevel,
                    !oldAccessLevelESet));
    }
    ...
    public void unsetAccessLevel() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, Xpdl1Package.WORKFLOW_PROCESS_TYPE__ACCESS_LEVEL, oldAccessLevel, ACCESS_LEVEL_EDEFAULT,
                    oldAccessLevelESet));
    }
