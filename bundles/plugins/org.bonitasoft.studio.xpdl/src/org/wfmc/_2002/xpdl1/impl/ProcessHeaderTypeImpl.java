...
public class ProcessHeaderTypeImpl extends EObjectImpl implements ProcessHeaderType {
    ...
    public NotificationChain basicSetTimeEstimation(TimeEstimationType newTimeEstimation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.PROCESS_HEADER_TYPE__TIME_ESTIMATION,
    ...
    public void setTimeEstimation(TimeEstimationType newTimeEstimation) {
        if (newTimeEstimation != timeEstimation) {
            ...
            if (timeEstimation != null)
                msgs = ((InternalEObject) timeEstimation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PROCESS_HEADER_TYPE__TIME_ESTIMATION,
                        null, msgs);
            if (newTimeEstimation != null)
                msgs = ((InternalEObject) newTimeEstimation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.PROCESS_HEADER_TYPE__TIME_ESTIMATION,
                        null, msgs);
    ...
    public void setDurationUnit(DurationUnitType newDurationUnit) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.PROCESS_HEADER_TYPE__DURATION_UNIT, oldDurationUnit, durationUnit,
                    !oldDurationUnitESet));
    }
    ...
    public void unsetDurationUnit() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, Xpdl1Package.PROCESS_HEADER_TYPE__DURATION_UNIT, oldDurationUnit, DURATION_UNIT_EDEFAULT,
                    oldDurationUnitESet));
    }
