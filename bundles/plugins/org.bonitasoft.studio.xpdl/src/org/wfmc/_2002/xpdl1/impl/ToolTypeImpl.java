...
public class ToolTypeImpl extends EObjectImpl implements ToolType {
    ...
    public NotificationChain basicSetActualParameters(ActualParametersType newActualParameters, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TOOL_TYPE__ACTUAL_PARAMETERS, oldActualParameters,
                    newActualParameters);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setActualParameters(ActualParametersType newActualParameters) {
        if (newActualParameters != actualParameters) {
            ...
            if (actualParameters != null)
                msgs = ((InternalEObject) actualParameters)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TOOL_TYPE__ACTUAL_PARAMETERS, null, msgs);
            if (newActualParameters != null)
                msgs = ((InternalEObject) newActualParameters)
                        .eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TOOL_TYPE__ACTUAL_PARAMETERS, null, msgs);
    ...
    public NotificationChain basicSetExtendedAttributes(ExtendedAttributesType newExtendedAttributes, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.TOOL_TYPE__EXTENDED_ATTRIBUTES, oldExtendedAttributes,
    ...
    public void setExtendedAttributes(ExtendedAttributesType newExtendedAttributes) {
        if (newExtendedAttributes != extendedAttributes) {
            ...
            if (extendedAttributes != null)
                msgs = ((InternalEObject) extendedAttributes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TOOL_TYPE__EXTENDED_ATTRIBUTES, null,
                        msgs);
            if (newExtendedAttributes != null)
                msgs = ((InternalEObject) newExtendedAttributes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.TOOL_TYPE__EXTENDED_ATTRIBUTES, null,
                        msgs);
