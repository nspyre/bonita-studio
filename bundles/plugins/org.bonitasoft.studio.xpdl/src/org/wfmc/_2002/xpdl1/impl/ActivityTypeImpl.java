...
public class ActivityTypeImpl extends EObjectImpl implements ActivityType {
    ...
    public NotificationChain basicSetImplementation(ImplementationType newImplementation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.ACTIVITY_TYPE__IMPLEMENTATION, oldImplementation,
                    newImplementation);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetBlockActivity(BlockActivityType newBlockActivity, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.ACTIVITY_TYPE__BLOCK_ACTIVITY, oldBlockActivity,
                    newBlockActivity);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetFinishMode(FinishModeType newFinishMode, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.ACTIVITY_TYPE__FINISH_MODE, oldFinishMode,
                    newFinishMode);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain basicSetSimulationInformation(SimulationInformationType newSimulationInformation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.ACTIVITY_TYPE__SIMULATION_INFORMATION,
    ...
    public void setSimulationInformation(SimulationInformationType newSimulationInformation) {
        if (newSimulationInformation != simulationInformation) {
            ...
            if (simulationInformation != null)
                msgs = ((InternalEObject) simulationInformation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.ACTIVITY_TYPE__SIMULATION_INFORMATION, null, msgs);
            if (newSimulationInformation != null)
                msgs = ((InternalEObject) newSimulationInformation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.ACTIVITY_TYPE__SIMULATION_INFORMATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.ACTIVITY_TYPE__SIMULATION_INFORMATION, newSimulationInformation,
                    newSimulationInformation));
    }
    ...
    public NotificationChain basicSetTransitionRestrictions(TransitionRestrictionsType newTransitionRestrictions, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.ACTIVITY_TYPE__TRANSITION_RESTRICTIONS,
                    oldTransitionRestrictions, newTransitionRestrictions);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setTransitionRestrictions(TransitionRestrictionsType newTransitionRestrictions) {
        if (newTransitionRestrictions != transitionRestrictions) {
            ...
            if (transitionRestrictions != null)
                msgs = ((InternalEObject) transitionRestrictions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.ACTIVITY_TYPE__TRANSITION_RESTRICTIONS, null, msgs);
            if (newTransitionRestrictions != null)
                msgs = ((InternalEObject) newTransitionRestrictions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.ACTIVITY_TYPE__TRANSITION_RESTRICTIONS, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.ACTIVITY_TYPE__TRANSITION_RESTRICTIONS, newTransitionRestrictions,
                    newTransitionRestrictions));
    }
    ...
    public NotificationChain basicSetExtendedAttributes(ExtendedAttributesType newExtendedAttributes, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.ACTIVITY_TYPE__EXTENDED_ATTRIBUTES,
    ...
    public void setExtendedAttributes(ExtendedAttributesType newExtendedAttributes) {
        if (newExtendedAttributes != extendedAttributes) {
            ...
            if (extendedAttributes != null)
                msgs = ((InternalEObject) extendedAttributes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.ACTIVITY_TYPE__EXTENDED_ATTRIBUTES,
                        null, msgs);
            if (newExtendedAttributes != null)
                msgs = ((InternalEObject) newExtendedAttributes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.ACTIVITY_TYPE__EXTENDED_ATTRIBUTES,
                        null, msgs);
