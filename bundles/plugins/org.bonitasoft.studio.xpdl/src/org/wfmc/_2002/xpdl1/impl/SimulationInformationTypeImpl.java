...
public class SimulationInformationTypeImpl extends EObjectImpl implements SimulationInformationType {
    ...
    public NotificationChain basicSetTimeEstimation(TimeEstimationType newTimeEstimation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.SIMULATION_INFORMATION_TYPE__TIME_ESTIMATION,
    ...
    public void setTimeEstimation(TimeEstimationType newTimeEstimation) {
        if (newTimeEstimation != timeEstimation) {
            ...
            if (timeEstimation != null)
                msgs = ((InternalEObject) timeEstimation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.SIMULATION_INFORMATION_TYPE__TIME_ESTIMATION, null, msgs);
            if (newTimeEstimation != null)
                msgs = ((InternalEObject) newTimeEstimation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - Xpdl1Package.SIMULATION_INFORMATION_TYPE__TIME_ESTIMATION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.SIMULATION_INFORMATION_TYPE__TIME_ESTIMATION, newTimeEstimation,
                    newTimeEstimation));
    }
    ...
    public void setInstantiation(InstantiationType newInstantiation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.SIMULATION_INFORMATION_TYPE__INSTANTIATION, oldInstantiation, instantiation,
    ...
    public void unsetInstantiation() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, Xpdl1Package.SIMULATION_INFORMATION_TYPE__INSTANTIATION, oldInstantiation,
                    INSTANTIATION_EDEFAULT, oldInstantiationESet));
    }
