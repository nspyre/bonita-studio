...
public class DeadlineTypeImpl extends EObjectImpl implements DeadlineType {
    ...
    public NotificationChain basicSetDeadlineCondition(EObject newDeadlineCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.DEADLINE_TYPE__DEADLINE_CONDITION,
                    oldDeadlineCondition, newDeadlineCondition);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDeadlineCondition(EObject newDeadlineCondition) {
        if (newDeadlineCondition != deadlineCondition) {
            ...
            if (deadlineCondition != null)
                msgs = ((InternalEObject) deadlineCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.DEADLINE_TYPE__DEADLINE_CONDITION,
                        null, msgs);
            if (newDeadlineCondition != null)
                msgs = ((InternalEObject) newDeadlineCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.DEADLINE_TYPE__DEADLINE_CONDITION,
                        null, msgs);
    ...
    public NotificationChain basicSetExceptionName(EObject newExceptionName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.DEADLINE_TYPE__EXCEPTION_NAME, oldExceptionName,
                    newExceptionName);
            if (msgs == null)
                msgs = notification;
            else
