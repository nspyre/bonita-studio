...
public class ConformanceClassTypeImpl extends EObjectImpl implements ConformanceClassType {
    ...
    public void setGraphConformance(GraphConformanceType newGraphConformance) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl1Package.CONFORMANCE_CLASS_TYPE__GRAPH_CONFORMANCE, oldGraphConformance,
                    graphConformance, !oldGraphConformanceESet));
    }
    ...
    public void unsetGraphConformance() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, Xpdl1Package.CONFORMANCE_CLASS_TYPE__GRAPH_CONFORMANCE, oldGraphConformance,
                    GRAPH_CONFORMANCE_EDEFAULT, oldGraphConformanceESet));
    }
