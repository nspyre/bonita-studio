...
public class SubFlowTypeImpl extends EObjectImpl implements SubFlowType {
    ...
    public NotificationChain basicSetActualParameters(ActualParametersType newActualParameters, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpdl1Package.SUB_FLOW_TYPE__ACTUAL_PARAMETERS, oldActualParameters,
                    newActualParameters);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setActualParameters(ActualParametersType newActualParameters) {
        if (newActualParameters != actualParameters) {
            ...
            if (actualParameters != null)
                msgs = ((InternalEObject) actualParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.SUB_FLOW_TYPE__ACTUAL_PARAMETERS, null,
                        msgs);
            if (newActualParameters != null)
                msgs = ((InternalEObject) newActualParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl1Package.SUB_FLOW_TYPE__ACTUAL_PARAMETERS, null,
                        msgs);
