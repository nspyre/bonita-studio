...
public class CustomLaneItemSemanticEditPolicy extends LaneItemSemanticEditPolicy {
     ...
     * (non-Javadoc)
     * @see
     * org.bonitasoft.studio.model.process.diagram.edit.policies.Lane2ItemSemanticEditPolicy#getDestroyElementCommand(org.eclipse.gmf.runtime.emf.type.core.
     * requests.DestroyElementRequest)
     */
    @Override
