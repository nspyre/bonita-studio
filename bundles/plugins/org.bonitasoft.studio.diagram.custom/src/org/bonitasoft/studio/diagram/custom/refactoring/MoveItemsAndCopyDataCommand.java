...
public class MoveItemsAndCopyDataCommand extends AbstractTransactionalCommand implements IUndoableOperation {
     ...
     * @param parts
     */
    public MoveItemsAndCopyDataCommand(TransactionalEditingDomain domain, CreateViewAndElementRequest req, ViewAndElementDescriptor subprocessDescriptor,
            List<IGraphicalEditPart> parts) {
