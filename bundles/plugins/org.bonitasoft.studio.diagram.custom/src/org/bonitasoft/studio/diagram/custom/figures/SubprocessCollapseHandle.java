...
public class SubprocessCollapseHandle extends AbstractHandle implements PropertyChangeListener, NotificationListener, ZoomListener {
            ...
            if (style != null) {
                ...
                for (Object child : getChildren()) {
                    if (child instanceof DecoratorSVGFigure) {
                        ...
                        ((DecoratorSVGFigure) child).setColor(
                                ColorRegistry.getInstance().getColor(
                                        (Integer) parentEditpart.getStructuralFeatureValue(NotationPackage.eINSTANCE.getLineStyle_LineColor()))
                                ,
                                ColorRegistry.getInstance().getColor(
                                        (Integer) parentEditpart.getStructuralFeatureValue(NotationPackage.eINSTANCE.getFillStyle_FillColor())));
                    }
                }
                return;
            }
        ...
        if (NotationPackage.eINSTANCE.getDrawerStyle_Collapsed() == notification.getFeature()) {
            ...
            for (Object child : getChildren()) {
                if (child instanceof DecoratorSVGFigure) {
                    ((DecoratorSVGFigure) child).setColor(
                            ColorRegistry.getInstance().getColor(
                                    (Integer) ((IGraphicalEditPart) getOwner().getParent()).getStructuralFeatureValue(NotationPackage.eINSTANCE
            ...
            for (Object child : getChildren()) {
                if (child instanceof DecoratorSVGFigure) {
                    ((DecoratorSVGFigure) child).setColor(
                            ColorRegistry.getInstance().getColor(notification.getNewIntValue()),
                            ColorRegistry.getInstance().getColor(
                                    (Integer) ((IGraphicalEditPart) getOwner().getParent()).getStructuralFeatureValue(NotationPackage.eINSTANCE
                                            .getFillStyle_FillColor())));
                }
    ...
    public void addNotify() {
        ...
        if (view != null) {
            ...
            getDiagramEventBroker().addNotificationListener(((IGraphicalEditPart) owner.getParent()).getNotationView(),
                    NotationPackage.eINSTANCE.getLineStyle_LineColor(), SubprocessCollapseHandle.this);
        }
    }
