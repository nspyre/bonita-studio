...
public abstract class AbstractBonitaDecorator implements IBonitaDecorator {
    ...
    public void activate() {
        ...
        if (node != null) {
            DiagramEventBroker.getInstance(gep.getEditingDomain()).addNotificationListener(gep.getNotationView(),
                    NotationPackage.eINSTANCE.getFillStyle_FillColor(), notificationListener);
            DiagramEventBroker.getInstance(gep.getEditingDomain()).addNotificationListener(gep.getNotationView(),
                    NotationPackage.eINSTANCE.getLineStyle_LineColor(), notificationListener);
            DiagramEventBroker.getInstance(gep.getEditingDomain()).addNotificationListener(gep.getNotationView(), NotationPackage.eINSTANCE.getSize_Width(),
    ...
    public void deactivate() {
        ...
        if (decoratorTarget != null) {
            ...
            DiagramEventBroker.getInstance(gep.getEditingDomain()).removeNotificationListener(gep.getNotationView(), NotationPackage.eINSTANCE.getSize_Width(),
                    notificationListener);
