...
public class NextElementPaletteProvider {
    ...
    public static List<ToolAndToolEntry> getAllowedNextTypes(final GraphicalEditPart host) {
        ...
        if (element instanceof EndEvent || element instanceof EndMessageEvent || element instanceof EndTerminatedEvent || element instanceof EndErrorEvent
                || element instanceof ThrowLinkEvent || element instanceof EndSignalEvent) {
