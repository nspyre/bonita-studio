        ...
        if (ep.resolveSemanticElement() instanceof MessageEvent && connEditPart != null && connEditPart instanceof MessageFlowEditPart) {
            ...
            switch (position) {
                case AnchorPosition.NORTH:
                    return computeGateAvailableAnchor(AnchorPosition.NORTH, freeAnchors);
                case AnchorPosition.SOUTH:
                    return computeGateAvailableAnchor(AnchorPosition.SOUTH, freeAnchors);
                default:
                    return computeGateAvailableAnchor(AnchorPosition.NORTH, freeAnchors);
            }
            ...
            switch (position) {
                case AnchorPosition.NORTH:
                    return computeAvailableAnchor(AnchorPosition.NORTH, freeAnchors);
                case AnchorPosition.SOUTH:
                    return computeAvailableAnchor(AnchorPosition.SOUTH, freeAnchors);
                case AnchorPosition.EAST:
                    return computeAvailableAnchor(AnchorPosition.EAST, freeAnchors);
                case AnchorPosition.WEST:
                    return computeAvailableAnchor(AnchorPosition.WEST, freeAnchors);
                default:
                    return computeAvailableAnchor(AnchorPosition.NORTH, freeAnchors);
            }
            ...
            switch (position) {
                ...
                case AnchorPosition.SOUTH:
                    return computeGateAvailableAnchor(AnchorPosition.SOUTH, freeAnchors);
                case AnchorPosition.EAST:
                    return computeGateAvailableAnchor(AnchorPosition.EAST, freeAnchors);
                case AnchorPosition.WEST:
                    return computeGateAvailableAnchor(AnchorPosition.WEST, freeAnchors);
                case AnchorPosition.SOUTH_WEST:
                    return computeGateAvailableAnchor(AnchorPosition.SOUTH_WEST, freeAnchors);
                case AnchorPosition.SOUTH_EAST:
                    return computeGateAvailableAnchor(AnchorPosition.SOUTH_EAST, freeAnchors);
                case AnchorPosition.NORTH_WEST:
                    return computeGateAvailableAnchor(AnchorPosition.NORTH_WEST, freeAnchors);
                case AnchorPosition.NORTH_EAST:
                    return computeGateAvailableAnchor(AnchorPosition.NORTH_EAST, freeAnchors);
                default:
                    return computeGateAvailableAnchor(AnchorPosition.NORTH, freeAnchors);
            }
        } else {
            ...
            switch (position) {
                ...
                case AnchorPosition.WEST:
                    return computeAvailableAnchor(AnchorPosition.WEST, freeAnchors);
                case AnchorPosition.SOUTH_WEST:
                    return computeAvailableAnchor(AnchorPosition.SOUTH_WEST, freeAnchors);
                case AnchorPosition.SOUTH_EAST:
                    return computeAvailableAnchor(AnchorPosition.SOUTH_EAST, freeAnchors);
                case AnchorPosition.NORTH_WEST:
                    return computeAvailableAnchor(AnchorPosition.NORTH_WEST, freeAnchors);
                case AnchorPosition.NORTH_EAST:
                    return computeAvailableAnchor(AnchorPosition.NORTH_EAST, freeAnchors);
                case AnchorPosition.WEST_SOUTH:
                    return computeAvailableAnchor(AnchorPosition.WEST_SOUTH, freeAnchors);
                case AnchorPosition.EAST_SOUTH:
                    return computeAvailableAnchor(AnchorPosition.EAST_SOUTH, freeAnchors);
                case AnchorPosition.WEST_NORTH:
                    return computeAvailableAnchor(AnchorPosition.WEST_NORTH, freeAnchors);
                case AnchorPosition.EAST_NORTH:
                    return computeAvailableAnchor(AnchorPosition.EAST_NORTH, freeAnchors);
                default:
                    return computeAvailableAnchor(AnchorPosition.NORTH_WEST, freeAnchors);
            }
        }
