        ...
        if (figureList != null) {
            for (final List<IFigure> eventLists : figureList) {
                for (final IFigure f : eventLists) {
                    ...
                    f.setLocation(new Point(parent.getBounds().getTopLeft().x + f.getSize().width * eventLists.indexOf(f), parent.getBounds().getTopLeft().y
                            + 20 * (figureList.indexOf(eventLists) + 2)));
                    f.setVisible(false);
                    background.add(f);
                ...
                if (figureList.indexOf(eventLists) != figureList.size() - 1) {
                    ...
                    lineSeparator.addPoint(new Point(parent.getBounds().getTopLeft().x, parent.getBounds().getTopLeft().y + 20 + 20
                            * (figureList.indexOf(eventLists) + 2)));
                    lineSeparator.addPoint(new Point(parent.getBounds().getTopLeft().x + 80, parent.getBounds().getTopLeft().y + 20 + 20
                            * (figureList.indexOf(eventLists) + 2)));
