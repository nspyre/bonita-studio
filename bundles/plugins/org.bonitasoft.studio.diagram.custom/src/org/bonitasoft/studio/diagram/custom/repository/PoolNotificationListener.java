    ...
    public void notifyChanged(final Notification notification) {
        ...
        switch (notification.getFeatureID(AbstractProcess.class)) {
            case ProcessPackage.ABSTRACT_PROCESS__NAME:
                updatePoolLabel(ModelHelper.getEObjectID((AbstractProcess) notification.getNotifier()), notification.getNewStringValue(),
                        ((AbstractProcess) notification.getNotifier()).getVersion());
                break;
            case ProcessPackage.ABSTRACT_PROCESS__VERSION:
                updatePoolLabel(ModelHelper.getEObjectID((AbstractProcess) notification.getNotifier()),
                        ((AbstractProcess) notification.getNotifier()).getName(), notification.getNewStringValue());
                break;
