...
public class ConnectorImplementationWizard extends ExtensibleWizard {
    ...
    public void addPages() {
        ...
        if (originalImpl != null) {
            ...
            for (ConnectorImplementation impl : ((IImplementationRepositoryStore) implStore).getImplementations()) {
                if (!(impl.getImplementationId().equals(originalImpl.getImplementationId()) && impl.getImplementationVersion().equals(
                        originalImpl.getImplementationVersion()))) {
    ...
    protected IWizardPage getDefinitionSelectionWizardPage(
        ...
        return new AbstractDefinitionSelectionImpementationWizardPage(implWorkingCopy, existingImplementation,
                ((IDefinitionRepositoryStore) defStore).getDefinitions(), getSelectionPageTitle(), getSelectionPageDescription(), messageProvider) {
        ...
        try {
            getContainer().run(false, false, new IRunnableWithProgress() {
                ...
                public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
                    ...
                    String implId = NamingUtils.toConnectorImplementationFilename(implWorkingCopy.getImplementationId(),
                            implWorkingCopy.getImplementationVersion(), false);
                    ...
                    if (editMode) {
                        ...
                        if (!originalImpl.getImplementationClassname().equals(implWorkingCopy.getImplementationClassname())) {
                            ...
                            if (sourceFile != null) {
                                ...
                                try {
                                    ClassGenerator.updateConnectorImplementationAbstractClassName(implWorkingCopy,
                                            ClassGenerator.getAbstractClassName(originalImpl.getImplementationClassname()), sourceFile, monitor);
                                } catch (Exception e) {
                    ...
                    try {
                        ConnectorDefinition definition = ((IDefinitionRepositoryStore) defStore).getDefinition(implWorkingCopy.getDefinitionId(),
                                implWorkingCopy.getDefinitionVersion());
