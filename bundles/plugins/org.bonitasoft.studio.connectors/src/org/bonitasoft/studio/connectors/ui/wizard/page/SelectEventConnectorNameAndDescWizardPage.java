...
public class SelectEventConnectorNameAndDescWizardPage extends SelectNameAndDescWizardPage {
    ...
    public SelectEventConnectorNameAndDescWizardPage(EObject container, Connector connectorWorkingCopy, Connector originalConnector,
    ...
    protected void createConnectorFailsControls(Composite composite, EMFDataBindingContext context) {
        ...
        if (connector.eContainingFeature() == ProcessPackage.Literals.PAGE_FLOW__PAGE_FLOW_CONNECTORS || container instanceof Form
                || container instanceof SubmitFormButton) {
