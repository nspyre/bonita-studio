...
public class DatabaseConnectorOutputWizardPage extends AbstractConnectorOutputWizardPage implements DatabaseConnectorConstants, IValueChangeListener {
    ...
    /*
     * (non-Javadoc)
     * @see org.bonitasoft.studio.connectors.ui.wizard.page.AbstractConnectorOutputWizardPage#doCreateControl(org.eclipse.swt.widgets.Composite,
    ...
    protected Composite createNRowsOneColumOuputControl(Composite parent,
        ...
        final ReadOnlyExpressionViewer targetDataExpressionViewer = new ReadOnlyExpressionViewer(mainComposite, SWT.BORDER, null, null,
    ...
    protected void buildListOfOutputForOneRowNCols(ScrolledComposite scrolledComposite, EMFDataBindingContext context) {
        ...
        for (Operation op : operations) {
            final ReadOnlyExpressionViewer targetDataExpressionViewer = new ReadOnlyExpressionViewer(oneRowNColsComposite, SWT.BORDER, null, null,
                    ExpressionPackage.Literals.OPERATION__LEFT_OPERAND);
