...
public class TestConnectorOutputWizardPage extends
    ...
    protected Control doCreateControl(final Composite parent,
        ...
        for (final Operation output : outputOperations) {
            ...
            context.bindValue(ViewersObservables.observeSingleSelection(outputExpressionViewer),
                    EMFObservables.observeValue(output, ExpressionPackage.Literals.OPERATION__RIGHT_OPERAND));
