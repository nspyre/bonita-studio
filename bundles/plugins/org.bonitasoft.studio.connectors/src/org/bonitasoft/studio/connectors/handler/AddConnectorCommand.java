...
// */
// public AddConnectorCommand(TransactionalEditingDomain editingDomain, String elementName,String label, String elementDesc, ConnectableElement eObject,
// ConnectorDescription connector, Configuration config, Map<String, Object> parameters, List<OutputParameterMapping> outputMappings) {
// this(editingDomain, elementName, label, elementDesc, eObject, ProcessPackage.Literals.CONNECTABLE_ELEMENT__CONNECTORS, connector, config, parameters,
// outputMappings);
// }
//
// public AddConnectorCommand(TransactionalEditingDomain editingDomain, String elementName,String label, String elementDesc, Element eObject, EStructuralFeature
// feature, ConnectorDescription connector, Configuration config, Map<String, Object> parameters, List<OutputParameterMapping> outputMappings) {
