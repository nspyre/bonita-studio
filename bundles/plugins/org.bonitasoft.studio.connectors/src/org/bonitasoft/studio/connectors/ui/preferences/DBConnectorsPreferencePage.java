...
public class DBConnectorsPreferencePage extends AbstractBonitaPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected Control createContents(Composite parent) {
        ...
        BooleanFieldEditor editor = new CheckBoxFieldEditor(BonitaPreferenceConstants.ALWAYS_USE_SCRIPTING_MODE, Messages.alwaysUseScriptingModeOutputPref,
                booleanEditorComposite);
        addField(editor);
