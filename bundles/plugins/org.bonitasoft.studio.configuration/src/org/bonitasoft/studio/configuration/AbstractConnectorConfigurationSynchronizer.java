...
public abstract class AbstractConnectorConfigurationSynchronizer implements IConfigurationSynchronizer {
    ...
    public void updateConnectorDependencies(Configuration configuration, DefinitionMapping association, ConnectorImplementation implementation,
            CompoundCommand cc, EditingDomain editingDomain, boolean forceDriver) {
    ...
    protected void updateJarDependencies(FragmentContainer connectorContainer, ConnectorImplementation implementation, EditingDomain editingDomain,
            CompoundCommand cc, boolean forceDriver) {
