    ...
    public CustomDrawerFigure(final Control control) {
        ...
        Figure title = new Figure() {
            ...
            protected void paintFigure(Graphics graphics) {
                ...
                graphics.drawLine(3, drawerLabel.getTextBounds().getLeft().y, drawerLabel.getTextBounds().getLeft().x - 2, drawerLabel.getTextBounds()
                        .getLeft().y);
                graphics.drawLine(drawerLabel.getTextBounds().getRight().x + 2, drawerLabel.getTextBounds().getRight().y, bounds.width - 3, drawerLabel
                        .getTextBounds().getRight().y);
