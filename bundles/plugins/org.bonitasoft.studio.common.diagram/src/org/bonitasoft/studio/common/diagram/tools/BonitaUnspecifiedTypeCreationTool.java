...
public class BonitaUnspecifiedTypeCreationTool extends UnspecifiedTypeCreationTool {
    ...
    protected boolean applies() {
        if (eClass != null) {
            return (ProcessPackage.Literals.FLOW_ELEMENT.isSuperTypeOf(eClass) || ProcessPackage.Literals.BOUNDARY_EVENT.isSuperTypeOf(eClass) || ProcessPackage.Literals.SUB_PROCESS_EVENT
                    .equals(eClass))
