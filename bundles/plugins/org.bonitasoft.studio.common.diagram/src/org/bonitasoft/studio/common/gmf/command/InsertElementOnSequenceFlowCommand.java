        ...
        if (targetEditPart instanceof ConnectionEditPart) {
            ...
            for (Iterator i = objects.iterator(); i.hasNext();) {
                ...
                if (object instanceof ViewAndElementDescriptor) {
                    ...
                    CreateConnectionViewAndElementRequest connectionRequest = new CreateConnectionViewAndElementRequest(
                    ...
                    if (connectionRequest != null) {
                        ...
                        org.eclipse.gmf.runtime.diagram.ui.editparts.ConnectionEditPart connectionEP = (org.eclipse.gmf.runtime.diagram.ui.editparts.ConnectionEditPart) editPart
    ...
    protected void correctBoundsToAvoidCollisions(IProgressMonitor monitor,
        ...
        for (Object ep : editparts) {
            if (ep instanceof IGraphicalEditPart) {
                ...
                Point newLoc = FiguresHelper.handleCompartmentMargin((IGraphicalEditPart) ep, loc.getX(), loc.getY(),
