...
public class EmptySearchIndexViewFilter extends ViewerFilter {
    ...
    public boolean select(Viewer viewer, Object parentElement, Object element) {
        if (element instanceof SearchIndex) {
            ...
            if ((index.getName() == null || index.getName().getContent() == null || index.getName().getContent().isEmpty())
                    && (index.getValue() == null || index.getValue().getContent() == null || index.getValue().getContent().isEmpty())) {
                return false;
            }
        }
        return true;
