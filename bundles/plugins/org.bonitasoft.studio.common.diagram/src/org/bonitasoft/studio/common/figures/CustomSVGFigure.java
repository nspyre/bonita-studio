    ...
    protected void paintFigure(Graphics graphics) {
        ...
        if (foregroundColor != null && backgroundColor != null) {
            ...
            if (document.getElementById("SVGID_1_") != null) {
                document.getElementById("SVGID_1_").getElementsByTagName("stop").item(0).getAttributes().getNamedItem("style")
                        .setNodeValue("stop-color:" + backgroundColor);
                document.getElementById("SVGID_1_").getElementsByTagName("stop").item(1).getAttributes().getNamedItem("style")
                        .setNodeValue("stop-color:#FFFFFF");
            }
        }
        Image image = null;
        try {
