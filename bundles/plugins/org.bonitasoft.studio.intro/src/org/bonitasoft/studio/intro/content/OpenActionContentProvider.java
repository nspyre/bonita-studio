            ...
            if (activeWorkbenchWindow != null) {
                ...
                if (activePage != null) {
                    if (PlatformUI.getWorkbench().getService(ICommandService.class) != null) {
                        ...
                        Command open = ((ICommandService) PlatformUI.getWorkbench().getService(ICommandService.class))
                                .getCommand("org.bonitasoft.studio.diagram.command.openDiagram");//$NON-NLS-1$
                        ...
                        if (liList.getLength() == 2) {
                            ...
                            if (open.isEnabled()) {
                                link.setAttribute("href",
                                        "http://org.eclipse.ui.intro/runAction?pluginId=org.bonitasoft.studio.intro&class=org.bonitasoft.studio.intro.actions.OpenProcess");
                            }
